...
/**
 * This class stands for User-Based_Security_GroupObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class User_Based_Security_GroupObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for User-Based_Security_GroupObjectIDType
     * @uses User_Based_Security_GroupObjectIDType::setType()
     * @uses User_Based_Security_GroupObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
