...
class Worker_Request_CriteriaType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Eligibility_Criteria_DataType[]
     */
     ...
     * @param \WorkdayWsdl\\StructType\Transaction_LogObjectType $event_Reference
    ...
    public static function validateTransaction_Log_Criteria_DataForArrayConstraintsFromSetTransaction_Log_Criteria_Data(array $values = array())
    {
        ...
        foreach ($values as $worker_Request_CriteriaTypeTransaction_Log_Criteria_DataItem) {
            ...
            if (!$worker_Request_CriteriaTypeTransaction_Log_Criteria_DataItem instanceof \WorkdayWsdl\\StructType\Transaction_Log_CriteriaType) {
     ...
     * @param \WorkdayWsdl\\StructType\Transaction_Log_CriteriaType[] $transaction_Log_Criteria_Data
     * @return \WorkdayWsdl\\StructType\Worker_Request_CriteriaType
     */
    ...
    public static function validateOrganization_ReferenceForArrayConstraintsFromSetOrganization_Reference(array $values = array())
    {
        ...
        foreach ($values as $worker_Request_CriteriaTypeOrganization_ReferenceItem) {
            // validation for constraint: itemType
            if (!$worker_Request_CriteriaTypeOrganization_ReferenceItem instanceof \WorkdayWsdl\\StructType\OrganizationObjectType) {
    ...
    public static function validateCountry_ReferenceForArrayConstraintsFromSetCountry_Reference(array $values = array())
    {
        ...
        foreach ($values as $worker_Request_CriteriaTypeCountry_ReferenceItem) {
            // validation for constraint: itemType
            if (!$worker_Request_CriteriaTypeCountry_ReferenceItem instanceof \WorkdayWsdl\\StructType\CountryObjectType) {
    ...
    public static function validatePosition_ReferenceForArrayConstraintsFromSetPosition_Reference(array $values = array())
    {
        ...
        foreach ($values as $worker_Request_CriteriaTypePosition_ReferenceItem) {
            // validation for constraint: itemType
            if (!$worker_Request_CriteriaTypePosition_ReferenceItem instanceof \WorkdayWsdl\\StructType\Position_ElementObjectType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Position_Reference property can only contain items of type \WorkdayWsdl\\StructType\Position_ElementObjectType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @return \WorkdayWsdl\\StructType\Worker_Request_CriteriaType
     */
    public function addToPosition_Reference(\WorkdayWsdl\\StructType\Position_ElementObjectType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Position_ElementObjectType) {
            throw new \InvalidArgumentException(sprintf('The Position_Reference property can only contain items of type \WorkdayWsdl\\StructType\Position_ElementObjectType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \WorkdayWsdl\\StructType\Worker_Request_CriteriaType
     */
    public function setEvent_Reference(\WorkdayWsdl\\StructType\Transaction_LogObjectType $event_Reference = null)
    {
    ...
    public static function validateBenefit_Plan_ReferenceForArrayConstraintsFromSetBenefit_Plan_Reference(array $values = array())
    {
        ...
        foreach ($values as $worker_Request_CriteriaTypeBenefit_Plan_ReferenceItem) {
            // validation for constraint: itemType
            if (!$worker_Request_CriteriaTypeBenefit_Plan_ReferenceItem instanceof \WorkdayWsdl\\StructType\Benefit_PlanObjectType) {
    ...
    public static function validateNational_ID_Criteria_DataForArrayConstraintsFromSetNational_ID_Criteria_Data(array $values = array())
    {
        ...
        foreach ($values as $worker_Request_CriteriaTypeNational_ID_Criteria_DataItem) {
            // validation for constraint: itemType
            if (!$worker_Request_CriteriaTypeNational_ID_Criteria_DataItem instanceof \WorkdayWsdl\\StructType\Worker_by_National_ID_Request_CriteriaType) {
     ...
     * @return \WorkdayWsdl\\StructType\Eligibility_Criteria_DataType[]|null
     */
    ...
    public static function validateEligibility_Criteria_DataForArrayConstraintsFromSetEligibility_Criteria_Data(array $values = array())
    {
        ...
        foreach ($values as $worker_Request_CriteriaTypeEligibility_Criteria_DataItem) {
            // validation for constraint: itemType
            if (!$worker_Request_CriteriaTypeEligibility_Criteria_DataItem instanceof \WorkdayWsdl\\StructType\Eligibility_Criteria_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Eligibility_Criteria_Data property can only contain items of type \WorkdayWsdl\\StructType\Eligibility_Criteria_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Eligibility_Criteria_DataType $item
     * @return \WorkdayWsdl\\StructType\Worker_Request_CriteriaType
     */
    public function addToEligibility_Criteria_Data(\WorkdayWsdl\\StructType\Eligibility_Criteria_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Eligibility_Criteria_DataType) {
            throw new \InvalidArgumentException(sprintf('The Eligibility_Criteria_Data property can only contain items of type \WorkdayWsdl\\StructType\Eligibility_Criteria_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateUniversal_ID_ReferenceForArrayConstraintsFromSetUniversal_ID_Reference(array $values = array())
    {
        ...
        foreach ($values as $worker_Request_CriteriaTypeUniversal_ID_ReferenceItem) {
            // validation for constraint: itemType
            if (!$worker_Request_CriteriaTypeUniversal_ID_ReferenceItem instanceof \WorkdayWsdl\\StructType\Universal_IdentifierObjectType) {
