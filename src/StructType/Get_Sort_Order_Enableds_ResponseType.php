...
/**
 * This class stands for Get_Sort_Order_Enableds_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Get Sort Order Enableds Web Service response.
 * @subpackage Structs
 */
class Get_Sort_Order_Enableds_ResponseType extends AbstractStructBase
{
    /**
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Sort_Order_Enabled_Response_DataType
     */
    ...
    public $version;
    /**
     * Constructor method for Get_Sort_Order_Enableds_ResponseType
     * @uses Get_Sort_Order_Enableds_ResponseType::setRequest_References()
     * @uses Get_Sort_Order_Enableds_ResponseType::setResponse_Filter()
     * @uses Get_Sort_Order_Enableds_ResponseType::setResponse_Results()
     * @uses Get_Sort_Order_Enableds_ResponseType::setResponse_Data()
     * @uses Get_Sort_Order_Enableds_ResponseType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Sort_Order_Enabled_Response_DataType $response_Data
     * @param string $version
     */
    public function __construct(\WorkdayWsdl\\StructType\Sort_Order_Enabled_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, \WorkdayWsdl\\StructType\Response_ResultsType $response_Results = null, \WorkdayWsdl\\StructType\Sort_Order_Enabled_Response_DataType $response_Data = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Sort_Order_Enabled_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Sort_Order_Enableds_ResponseType
     */
     ...
     * @return \WorkdayWsdl\\StructType\Sort_Order_Enabled_Response_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Get_Sort_Order_Enableds_ResponseType
     */
    public function setResponse_Data(\WorkdayWsdl\\StructType\Sort_Order_Enabled_Response_DataType $response_Data = null)
    {
