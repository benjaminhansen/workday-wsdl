...
class Manage_Union_Membership_ResponseType extends AbstractStructBase
{
     ...
     * @param \StructType\Unique_IdentifierObjectType $union_Member_Event_Reference
     * @param string $version
     */
    public function __construct(\StructType\Unique_IdentifierObjectType $union_Member_Event_Reference = null, $version = null)
    {
        $this
     ...
     * @param \StructType\Unique_IdentifierObjectType $union_Member_Event_Reference
     * @return \StructType\Manage_Union_Membership_ResponseType
     */
    public function setUnion_Member_Event_Reference(\StructType\Unique_IdentifierObjectType $union_Member_Event_Reference = null)
    {
