...
/**
 * This class stands for External_EEO-1_Data_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: External EEO-1 Data Response Group
 * @subpackage Structs
 */
class External_EEO_1_Data_Response_GroupType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for External_EEO-1_Data_Response_GroupType
     * @uses External_EEO_1_Data_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\External_EEO_1_Data_Response_GroupType
     */
