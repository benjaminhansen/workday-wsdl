...
/**
 * This class stands for Get_Worker_Photos_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains Worker Request References and filter for getting Worker Photo Image data
 * @subpackage Structs
 */
class Get_Worker_Photos_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Worker_Photos_RequestType
     * @uses Get_Worker_Photos_RequestType::setRequest_References()
     * @uses Get_Worker_Photos_RequestType::setResponse_Filter()
     * @uses Get_Worker_Photos_RequestType::setVersion()
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\Worker_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Worker_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Worker_Photos_RequestType
     */
