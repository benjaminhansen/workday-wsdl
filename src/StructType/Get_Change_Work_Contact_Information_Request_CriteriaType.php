...
/**
 * This class stands for Get_Change_Work_Contact_Information_Request_CriteriaType
 * StructType
 * Meta information extracted from the WSDL
 * - documentation: Invalid request filter provided. Include at least one person type in the request | Allows retrieving work contact information based on request criteria. Request Criteria is only used when Request References is not provided.
 * @subpackage Structs
 */
class Get_Change_Work_Contact_Information_Request_CriteriaType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Get_Change_Work_Contact_Information_Request_CriteriaType
     * @uses Get_Change_Work_Contact_Information_Request_CriteriaType::setPerson_Type_Criteria_Data()
     ...
     * @param \WorkdayWsdl\\StructType\Person_Type_CriteriaType $person_Type_Criteria_Data
     * @return \WorkdayWsdl\\StructType\Get_Change_Work_Contact_Information_Request_CriteriaType
     */
