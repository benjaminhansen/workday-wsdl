...
/**
 * This class stands for Get_Work_Status_Rule_Sets_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request Element for Get Work Status Rule Sets
 * @subpackage Structs
 */
class Get_Work_Status_Rule_Sets_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Work_Status_Rule_Sets_RequestType
     * @uses Get_Work_Status_Rule_Sets_RequestType::setRequest_References()
     * @uses Get_Work_Status_Rule_Sets_RequestType::setRequest_Criteria()
     * @uses Get_Work_Status_Rule_Sets_RequestType::setResponse_Filter()
     * @uses Get_Work_Status_Rule_Sets_RequestType::setResponse_Group()
     * @uses Get_Work_Status_Rule_Sets_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Work_Status_Rule_Set_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Work_Status_Rule_Sets_RequestType
     */
