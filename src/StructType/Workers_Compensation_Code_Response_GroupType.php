...
/**
 * This class stands for Workers_Compensation_Code_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Element containing Worker Compensation Code response group options
 * @subpackage Structs
 */
class Workers_Compensation_Code_Response_GroupType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Workers_Compensation_Code_Response_GroupType
     * @uses Workers_Compensation_Code_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\Workers_Compensation_Code_Response_GroupType
     */
