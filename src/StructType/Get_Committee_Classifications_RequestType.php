...
/**
 * This class stands for Get_Committee_Classifications_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: This operation retrieves Committee Classifications
 * @subpackage Structs
 */
class Get_Committee_Classifications_RequestType extends AbstractStructBase
{
    /**
     ...
     * Meta information extracted from the WSDL
     * - documentation: Committee Classification Request Criteria
     * - choice: Request_References | Request_Criteria
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * - minOccurs: 0
    ...
    public $version;
    /**
     * Constructor method for Get_Committee_Classifications_RequestType
     * @uses Get_Committee_Classifications_RequestType::setRequest_References()
     * @uses Get_Committee_Classifications_RequestType::setRequest_Criteria()
     * @uses Get_Committee_Classifications_RequestType::setResponse_Filter()
     * @uses Get_Committee_Classifications_RequestType::setResponse_Group()
     * @uses Get_Committee_Classifications_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Committee_Classification_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Committee_Classifications_RequestType
     */
