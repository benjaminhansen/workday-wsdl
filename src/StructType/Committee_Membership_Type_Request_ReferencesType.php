...
class Committee_Membership_Type_Request_ReferencesType extends AbstractStructBase
{
    ...
    public static function validateCommittee_Membership_Type_ReferenceForArrayConstraintsFromSetCommittee_Membership_Type_Reference(array $values = array())
    {
        ...
        foreach ($values as $committee_Membership_Type_Request_ReferencesTypeCommittee_Membership_Type_ReferenceItem) {
            ...
            if (!$committee_Membership_Type_Request_ReferencesTypeCommittee_Membership_Type_ReferenceItem instanceof \StructType\Committee_Membership_TypeObjectType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Committee_Membership_Type_Reference property can only contain items of type \StructType\Committee_Membership_TypeObjectType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @param \StructType\Committee_Membership_TypeObjectType[] $committee_Membership_Type_Reference
     * @return \StructType\Committee_Membership_Type_Request_ReferencesType
     */
     ...
     * @throws \InvalidArgumentException
     * @param \StructType\Committee_Membership_TypeObjectType $item
     * @return \StructType\Committee_Membership_Type_Request_ReferencesType
     */
    public function addToCommittee_Membership_Type_Reference(\StructType\Committee_Membership_TypeObjectType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \StructType\Committee_Membership_TypeObjectType) {
            throw new \InvalidArgumentException(sprintf('The Committee_Membership_Type_Reference property can only contain items of type \StructType\Committee_Membership_TypeObjectType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
