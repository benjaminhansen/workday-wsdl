...
/**
 * This class stands for Put_Provisioning_Group_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Reference to the provisioning group created or updated.
 * @subpackage Structs
 */
class Put_Provisioning_Group_ResponseType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Put_Provisioning_Group_ResponseType
