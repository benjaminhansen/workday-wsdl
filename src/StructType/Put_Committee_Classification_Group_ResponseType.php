...
/**
 * This class stands for Put_Committee_Classification_Group_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Committee Member Type
 * @subpackage Structs
 */
class Put_Committee_Classification_Group_ResponseType extends AbstractStructBase
{
    /**
