...
/**
 * This class stands for Compensatable_Summary_Amount_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: Data element containing summary compensation information for the worker.
 * @subpackage Structs
 */
class Compensatable_Summary_Amount_DataType extends AbstractStructBase
{
    /**
     * The Total_Base_Pay
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for Compensatable_Summary_Amount_DataType
     * @uses Compensatable_Summary_Amount_DataType::setTotal_Base_Pay()
     * @uses Compensatable_Summary_Amount_DataType::setTotal_Salary_and_Allowances()
     * @uses Compensatable_Summary_Amount_DataType::setPrimary_Compensation_Basis()
     * @uses Compensatable_Summary_Amount_DataType::setCurrency_Reference()
     * @uses Compensatable_Summary_Amount_DataType::setFrequency_Reference()
