...
/**
 * This class stands for CurrencyEnumeration EnumType
 * @subpackage Enumerations
 */
class CurrencyEnumeration
{
    /**
     * Constant for value 'ADF'
     * @return string 'ADF'
     */
    const VALUE_ADF = 'ADF';
    /**
