...
/**
 * This class stands for Professional_Affiliation_ReferenceObjectType StructType
 * @subpackage Structs
 */
class Professional_Affiliation_ReferenceObjectType extends AbstractStructBase
{
    /**
     * The ID
