...
/**
 * This class stands for Job_Family_Group_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Get Job Family Group Response Group
 * @subpackage Structs
 */
class Job_Family_Group_Response_GroupType extends AbstractStructBase
{
    /**
     * The Include_Reference
     * Meta information extracted from the WSDL
     * - documentation: Flag indicating if the reference to the Job Family Group should be included. If omitted, the default is to return the references.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var bool
     */
    ...
    /**
     * Constructor method for Job_Family_Group_Response_GroupType
     * @uses Job_Family_Group_Response_GroupType::setInclude_Reference()
     * @uses Job_Family_Group_Response_GroupType::setInclude_Job_Profile_Info_Data()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\Job_Family_Group_Response_GroupType
     */
