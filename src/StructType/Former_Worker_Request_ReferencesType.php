...
/**
 * This class stands for Former_Worker_Request_ReferencesType StructType
 * Meta information extracted from the WSDL
 * - documentation: Utilize the Request References element to retrieve a specific instance(s) of a Former Worker and its associated data.
 * @subpackage Structs
 */
class Former_Worker_Request_ReferencesType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Former_Worker_Request_ReferencesType
     * @uses Former_Worker_Request_ReferencesType::setFormer_Worker_Reference()
    ...
    public static function validateFormer_Worker_ReferenceForArrayConstraintsFromSetFormer_Worker_Reference(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $former_Worker_Request_ReferencesTypeFormer_Worker_ReferenceItem) {
            // validation for constraint: itemType
            if (!$former_Worker_Request_ReferencesTypeFormer_Worker_ReferenceItem instanceof \WorkdayWsdl\\StructType\Former_WorkerObjectType) {
                $invalidValues[] = is_object($former_Worker_Request_ReferencesTypeFormer_Worker_ReferenceItem) ? get_class($former_Worker_Request_ReferencesTypeFormer_Worker_ReferenceItem) : sprintf('%s(%s)', gettype($former_Worker_Request_ReferencesTypeFormer_Worker_ReferenceItem), var_export($former_Worker_Request_ReferencesTypeFormer_Worker_ReferenceItem, true));
            }
        }
     ...
     * @param \WorkdayWsdl\\StructType\Former_WorkerObjectType[] $former_Worker_Reference
     * @return \WorkdayWsdl\\StructType\Former_Worker_Request_ReferencesType
     */
