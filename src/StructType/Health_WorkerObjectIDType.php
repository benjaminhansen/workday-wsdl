...
/**
 * This class stands for Health_WorkerObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Health_WorkerObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Health_WorkerObjectIDType
     * @uses Health_WorkerObjectIDType::setType()
     * @uses Health_WorkerObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
