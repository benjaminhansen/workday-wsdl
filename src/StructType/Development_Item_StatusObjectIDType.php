...
class Development_Item_StatusObjectIDType extends AbstractStructBase
{
    ...
    /**
     * Set type value
     * @uses \EnumType\Development_Item_StatusReferenceEnumeration::valueIsValid()
     * @uses \EnumType\Development_Item_StatusReferenceEnumeration::getValidValues()
     * @throws \InvalidArgumentException
     * @param string $type
     * @return \StructType\Development_Item_StatusObjectIDType
     */
    public function setType($type = null)
    {
        // validation for constraint: enumeration
        if (!\EnumType\Development_Item_StatusReferenceEnumeration::valueIsValid($type)) {
            throw new \InvalidArgumentException(sprintf('Invalid value(s) %s, please use one of: %s from enumeration class \EnumType\Development_Item_StatusReferenceEnumeration', is_array($type) ? implode(', ', $type) : var_export($type, true), implode(', ', \EnumType\Development_Item_StatusReferenceEnumeration::getValidValues())), __LINE__);
        }
        $this->type = $type;
        return $this;
    }
