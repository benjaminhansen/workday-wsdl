...
/**
 * This class stands for Employee_Employment_Info_GetType StructType
 * Meta information extracted from the WSDL
 * - documentation: Utilize the following Reference element (and other optional attributes) to retrieve an instance of Employee and his/her Employment Information.
 * @subpackage Structs
 */
class Employee_Employment_Info_GetType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Employee_Employment_Info_GetType
     * @uses Employee_Employment_Info_GetType::setEmployee_Reference()
