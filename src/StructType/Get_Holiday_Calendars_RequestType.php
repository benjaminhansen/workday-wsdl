...
/**
 * This class stands for Get_Holiday_Calendars_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request to get Holiday Calendars.
 * @subpackage Structs
 */
class Get_Holiday_Calendars_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Holiday_Calendars_RequestType
     * @uses Get_Holiday_Calendars_RequestType::setRequest_References()
     * @uses Get_Holiday_Calendars_RequestType::setRequest_Criteria()
     * @uses Get_Holiday_Calendars_RequestType::setResponse_Filter()
     * @uses Get_Holiday_Calendars_RequestType::setResponse_Group()
     * @uses Get_Holiday_Calendars_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Holiday_Calendar_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Holiday_Calendars_RequestType
     */
