...
/**
 * This class stands for Generic_Disability_Status_Sub_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: Container for disability status data.
 * @subpackage Structs
 */
class Generic_Disability_Status_Sub_DataType extends AbstractStructBase
{
    /**
     * The Disability_Reference
     * Meta information extracted from the WSDL
     * - documentation: The provided Disability is not valid for the person's location context. The location context is derived from the country of the location specified for the position. | The person's Disability.
     ...
     * Meta information extracted from the WSDL
     * - documentation: The Disability Status Date cannot be before the Date of Birth | The person's Disability Status Date.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
     ...
     * Meta information extracted from the WSDL
     * - documentation: The Disability Date Known cannot be before the Date of Birth. | The date the Employer first learned about the Disability.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
     ...
     * Meta information extracted from the WSDL
     * - documentation: The provided Disability Grade is not valid for the person's location context or is inactive. | The person's location context is not enabled for Disability Grade. | A code or number that identifies the level of Disability.
     * - minOccurs: 0
     ...
     * Meta information extracted from the WSDL
     * - documentation: The provided Disability Authority Reference is not valid or inactive for the person's location context. Or the person's location context is not enabled for Disability Authority. | The provided Disability Authority is not valid for
     * the person's location context or is inactive. | The name of the person or agency that certified the Disability.
     * - choice: Disability_Certification_Authority_Reference | Disability_Authority
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * - minOccurs: 0
    ...
    /**
     * The Disability_Authority
     * Meta information extracted from the WSDL
     * - documentation: The person's location context is not enabled for Disability Authority. | The person's location context is configured to use Disability Authority Reference. | The name of the person or agency that certified the Disability.
     * - choice: Disability_Certification_Authority_Reference | Disability_Authority
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * - maxOccurs: 1
     ...
     * @var string
     */
    public $Disability_Authority;
    /**
     * The Disability_Certified_At
     * Meta information extracted from the WSDL
     * - documentation: The persons's location is not enabled for Disability Certification Location. | The place where the person or agency certified the Disability.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
     ...
     * Meta information extracted from the WSDL
     * - documentation: The person's location context is not enabled for Disability Certification ID. | The ID provided to the ~person~, if any.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
     ...
     * Meta information extracted from the WSDL
     * - documentation: The person's location context is not enabled for Disability Certification Basis. | The provided Disability Certification Basis is not valid for the person's location context or is inactive. | How the ~person~ qualified for the
     * certification.
     * - minOccurs: 0
     ...
     * Meta information extracted from the WSDL
     * - documentation: The Disability Severity Recognition Date cannot be before the Date of Birth. | The date the Disability was recognized as severe by the recognizing Authority.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
     ...
     * Meta information extracted from the WSDL
     * - documentation: List any work restrictions that apply to the ~person~.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
     ...
     * Meta information extracted from the WSDL
     * - documentation: Describe any recommendation requested by the ~person~ or their care provider.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
     ...
     * Meta information extracted from the WSDL
     * - documentation: Describe any rehabilitation measures requested by the ~person~ or their care provider.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
    ...
    /**
     * Constructor method for Generic_Disability_Status_Sub_DataType
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Reference()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Status_Date()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Date_Known()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_End_Date()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Grade_Reference()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Degree()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Remaining_Capacity()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Certification_Authority_Reference()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Authority()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Certified_At()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Certification_ID()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Certification_Basis_Reference()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Severity_Recognition_Date()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_FTE_Toward_Quota()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Work_Restrictions()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Accommodations_Requested()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Accommodations_Provided()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Rehabilitation_Requested()
     * @uses Generic_Disability_Status_Sub_DataType::setDisability_Rehabilitation_Provided()
     * @uses Generic_Disability_Status_Sub_DataType::setNote()
     * @uses Generic_Disability_Status_Sub_DataType::setWorker_Document_Reference()
     ...
     * @param string $disability_Authority
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\DisabilityObjectType $disability_Reference = null, $disability_Status_Date = null, $disability_Date_Known = null, $disability_End_Date = null, \WorkdayWsdl\\StructType\Disability_GradeObjectType $disability_Grade_Reference = null, $disability_Degree = null, $disability_Remaining_Capacity = null, \WorkdayWsdl\\StructType\Disability_Certification_AuthorityObjectType $disability_Certification_Authority_Reference = null, $disability_Authority = null, $disability_Certified_At = null, $disability_Certification_ID = null, \WorkdayWsdl\\StructType\Disability_Certification_BasisObjectType $disability_Certification_Basis_Reference = null, $disability_Severity_Recognition_Date = null, $disability_FTE_Toward_Quota = null, $disability_Work_Restrictions = null, $disability_Accommodations_Requested = null, $disability_Accommodations_Provided = null, $disability_Rehabilitation_Requested = null, $disability_Rehabilitation_Provided = null, $note = null, array $worker_Document_Reference = array())
    {
        $this
            ...
            ->setDisability_Authority($disability_Authority)
     ...
     * @param \WorkdayWsdl\\StructType\DisabilityObjectType $disability_Reference
     * @return \WorkdayWsdl\\StructType\Generic_Disability_Status_Sub_DataType
     */
    ...
    {
        // validation for constraint: choice(Disability_Certification_Authority_Reference, Disability_Authority)
    ...
    /**
     * Get Disability_Authority value
     * @return string|null
     */
    public function getDisability_Authority()
    {
        return isset($this->Disability_Authority) ? $this->Disability_Authority : null;
    }
    /**
     * This method is responsible for validating the value passed to the setDisability_Authority method
     * This method is willingly generated in order to preserve the one-line inline validation within the setDisability_Authority method
     * This has to validate that the property which is being set is the only one among the given choices
     * @param mixed $value
     * @return string A non-empty message if the values does not match the validation rules
     */
    public function validateDisability_AuthorityForChoiceConstraintsFromSetDisability_Authority($value)
    {
        $message = '';
        if (is_null($value)) {
            return $message;
        ...
        try {
            foreach ($properties as $property) {
                if (isset($this->{$property})) {
                    throw new \InvalidArgumentException(sprintf('The property Disability_Authority can\'t be set as the property %s is already set. Only one property must be set among these properties: Disability_Authority, %s.', $property, implode(', ', $properties)), __LINE__);
                }
            }
        } catch (\InvalidArgumentException $e) {
            $message = $e->getMessage();
    ...
    /**
     * Set Disability_Authority value
     * This property belongs to a choice that allows only one property to exist. It is
     * therefore removable from the request, consequently if the value assigned to this
     * property is null, the property is removed from this object
     * @throws \InvalidArgumentException
     ...
     * @return \WorkdayWsdl\\StructType\Generic_Disability_Status_Sub_DataType
     */
    public function setDisability_Authority($disability_Authority = null)
    {
        // validation for constraint: string
        if (!is_null($disability_Authority) && !is_string($disability_Authority)) {
            throw new \InvalidArgumentException(sprintf('Invalid value %s, please provide a string, %s given', var_export($disability_Authority, true), gettype($disability_Authority)), __LINE__);
        }
        // validation for constraint: choice(Disability_Certification_Authority_Reference, Disability_Authority)
        if ('' !== ($disability_AuthorityChoiceErrorMessage = self::validateDisability_AuthorityForChoiceConstraintsFromSetDisability_Authority($disability_Authority))) {
            throw new \InvalidArgumentException($disability_AuthorityChoiceErrorMessage, __LINE__);
        }
        if (is_null($disability_Authority) || (is_array($disability_Authority) && empty($disability_Authority))) {
            unset($this->Disability_Authority);
        } else {
            $this->Disability_Authority = $disability_Authority;
        }
        return $this;
    }
    /**
    ...
    public static function validateWorker_Document_ReferenceForArrayConstraintsFromSetWorker_Document_Reference(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $generic_Disability_Status_Sub_DataTypeWorker_Document_ReferenceItem) {
            // validation for constraint: itemType
            if (!$generic_Disability_Status_Sub_DataTypeWorker_Document_ReferenceItem instanceof \WorkdayWsdl\\StructType\Worker_DocumentObjectType) {
                $invalidValues[] = is_object($generic_Disability_Status_Sub_DataTypeWorker_Document_ReferenceItem) ? get_class($generic_Disability_Status_Sub_DataTypeWorker_Document_ReferenceItem) : sprintf('%s(%s)', gettype($generic_Disability_Status_Sub_DataTypeWorker_Document_ReferenceItem), var_export($generic_Disability_Status_Sub_DataTypeWorker_Document_ReferenceItem, true));
            }
        }
