...
/**
 * This class stands for Service_Center_Representative_Response_GroupType
 * StructType
 * Meta information extracted from the WSDL
 * - documentation: Response Group
 * @subpackage Structs
 */
class Service_Center_Representative_Response_GroupType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Service_Center_Representative_Response_GroupType
     * @uses Service_Center_Representative_Response_GroupType::setInclude_Reference()
