...
/**
 * This class stands for Provisioning_Group_Assignments_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Response element containing the requested instances of provisioning group assignments and their associated data.
 * @subpackage Structs
 */
class Provisioning_Group_Assignments_ResponseType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Provisioning_Group_Assignments_ResponseType
     * @uses Provisioning_Group_Assignments_ResponseType::setRequest_References()
     * @uses Provisioning_Group_Assignments_ResponseType::setRequest_Criteria()
     * @uses Provisioning_Group_Assignments_ResponseType::setResponse_Filter()
     * @uses Provisioning_Group_Assignments_ResponseType::setResponse_Group()
