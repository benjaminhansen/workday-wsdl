...
class Dissolve extends AbstractSoapClientBase
{
     ...
     * @param \StructType\Organization_Structure_DissolveType $body
     * @return void|bool
     */
    public function Dissolve_Organization_Structure(\StructType\Organization_Structure_DissolveType $body)
    {
        try {
