...
/**
 * This class stands for Compensatable_Summary_Amount_Annualized_DataType
 * StructType
 * Meta information extracted from the WSDL
 * - documentation: Data element containing annualized summary compensation information for a worker.
 * @subpackage Structs
 */
class Compensatable_Summary_Amount_Annualized_DataType extends AbstractStructBase
{
    /**
     * The Total_Base_Pay
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for Compensatable_Summary_Amount_Annualized_DataType
     * @uses Compensatable_Summary_Amount_Annualized_DataType::setTotal_Base_Pay()
     * @uses Compensatable_Summary_Amount_Annualized_DataType::setTotal_Salary_and_Allowances()
     * @uses Compensatable_Summary_Amount_Annualized_DataType::setPrimary_Compensation_Basis()
     * @uses Compensatable_Summary_Amount_Annualized_DataType::setCurrency_Reference()
     * @uses Compensatable_Summary_Amount_Annualized_DataType::setFrequency_Reference()
     ...
     * @param float $total_Base_Pay
     * @return \WorkdayWsdl\\StructType\Compensatable_Summary_Amount_Annualized_DataType
     */
