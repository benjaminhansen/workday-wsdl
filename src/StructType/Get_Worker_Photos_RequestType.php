...
class Get_Worker_Photos_RequestType extends AbstractStructBase
{
     ...
     */
    public function __construct(\StructType\Worker_Request_ReferencesType $request_References = null, \StructType\Response_FilterType $response_Filter = null, $version = null)
    {
        $this
     ...
     * @param \StructType\Worker_Request_ReferencesType $request_References
     * @return \StructType\Get_Worker_Photos_RequestType
     */
