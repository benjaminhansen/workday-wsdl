...
/**
 * This class stands for Employee_GetType StructType
 * Meta information extracted from the WSDL
 * - documentation: Utilize the following Reference element (and other optional attributes) to retrieve an instance of Employee and its associated data.
 * @subpackage Structs
 */
class Employee_GetType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Employee_GetType
     * @uses Employee_GetType::setEmployee_Reference()
     * @uses Employee_GetType::setAs_Of_Date()
     * @uses Employee_GetType::setAs_Of_Moment()
     * @uses Employee_GetType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Employee_ReferenceType $employee_Reference
     * @return \WorkdayWsdl\\StructType\Employee_GetType
     */
