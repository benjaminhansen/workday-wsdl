...
/**
 * This class stands for Period_Salary_PlanObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Period_Salary_PlanObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Period_Salary_PlanObjectIDType
     * @uses Period_Salary_PlanObjectIDType::setType()
     * @uses Period_Salary_PlanObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
