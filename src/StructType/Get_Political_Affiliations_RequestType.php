...
/**
 * This class stands for Get_Political_Affiliations_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request element for Get Political Affiliations service task.
 * @subpackage Structs
 */
class Get_Political_Affiliations_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Political_Affiliations_RequestType
     * @uses Get_Political_Affiliations_RequestType::setRequest_References()
     * @uses Get_Political_Affiliations_RequestType::setResponse_Filter()
     * @uses Get_Political_Affiliations_RequestType::setVersion()
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\Political_Affiliation_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Political_Affiliation_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Political_Affiliations_RequestType
     */
