...
/**
 * This class stands for Week_of_the_MonthObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Week_of_the_MonthObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Week_of_the_MonthObjectIDType
     * @uses Week_of_the_MonthObjectIDType::setType()
     * @uses Week_of_the_MonthObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
