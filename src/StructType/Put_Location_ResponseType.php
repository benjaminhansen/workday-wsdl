...
class Put_Location_ResponseType extends AbstractStructBase
{
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\LocationObjectType $location_Reference = null, array $exceptions_Response_Data = array(), $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\LocationObjectType $location_Reference
     * @return \WorkdayWsdl\\StructType\Put_Location_ResponseType
     */
    ...
    public static function validateExceptions_Response_DataForArrayConstraintsFromSetExceptions_Response_Data(array $values = array())
    {
        ...
        foreach ($values as $put_Location_ResponseTypeExceptions_Response_DataItem) {
            ...
            if (!$put_Location_ResponseTypeExceptions_Response_DataItem instanceof \WorkdayWsdl\\StructType\Application_Instance_Related_Exceptions_DataType) {
