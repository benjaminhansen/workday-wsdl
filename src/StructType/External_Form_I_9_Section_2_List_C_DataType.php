...
/**
 * This class stands for External_Form_I-9_Section_2_List_C_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: The request element containing all necessary information for Form I-9 Section 2 List C to assign to the worker.
 * @subpackage Structs
 */
class External_Form_I_9_Section_2_List_C_DataType extends AbstractStructBase
{
    /**
     * The Document_Title_Reference
     * Meta information extracted from the WSDL
     * - documentation: The Section 2 List C Document Title to be assigned to the Worker's Form I-9.
     * - minOccurs: 0
     ...
     * The Expiration_Date
     * Meta information extracted from the WSDL
     * - documentation: The Section 2 List C Expiration Date to be assigned to the Worker's Form I-9.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
    ...
    /**
     * Constructor method for External_Form_I-9_Section_2_List_C_DataType
     * @uses External_Form_I_9_Section_2_List_C_DataType::setDocument_Title_Reference()
     * @uses External_Form_I_9_Section_2_List_C_DataType::setDHS_Document_Title()
     * @uses External_Form_I_9_Section_2_List_C_DataType::setExpiration_Date()
     ...
     * @param \WorkdayWsdl\\StructType\Form_I_9_Identifier_Type__Workday_Owned_ObjectType $document_Title_Reference
     * @return \WorkdayWsdl\\StructType\External_Form_I_9_Section_2_List_C_DataType
     */
