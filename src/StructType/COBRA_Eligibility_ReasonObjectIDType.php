...
/**
 * This class stands for COBRA_Eligibility_ReasonObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class COBRA_Eligibility_ReasonObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for COBRA_Eligibility_ReasonObjectIDType
     * @uses COBRA_Eligibility_ReasonObjectIDType::setType()
     * @uses COBRA_Eligibility_ReasonObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
