...
class Put extends AbstractSoapClientBase
{
     ...
     * @param \WorkdayWsdl\\StructType\Put_Location_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Location_ResponseType|bool
     */
    public function Put_Location(\WorkdayWsdl\\StructType\Put_Location_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Previous_System_Job_History_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Previous_System_Job_History_ResponseType|bool
     */
    public function Put_Previous_System_Job_History(\WorkdayWsdl\\StructType\Put_Previous_System_Job_History_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Company_Insider_Type_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Company_Insider_Type_ResponseType|bool
     */
    public function Put_Company_Insider_Type(\WorkdayWsdl\\StructType\Put_Company_Insider_Type_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Work_Shift_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Work_Shift_ResponseType|bool
     */
    public function Put_Work_Shift(\WorkdayWsdl\\StructType\Put_Work_Shift_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Job_Category_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Job_Category_ResponseType|bool
     */
    public function Put_Job_Category(\WorkdayWsdl\\StructType\Put_Job_Category_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Dependent_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Dependent_ResponseType|bool
     */
    public function Put_Dependent(\WorkdayWsdl\\StructType\Put_Dependent_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Workers_Compensation_Code_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Workers_Compensation_Code_ResponseType|bool
     */
    public function Put_Workers_Compensation_Code(\WorkdayWsdl\\StructType\Put_Workers_Compensation_Code_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Holiday_Calendar_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Holiday_Calendar_ResponseType|bool
     */
    public function Put_Holiday_Calendar(\WorkdayWsdl\\StructType\Put_Holiday_Calendar_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Work_Schedule_Calendar_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Work_Schedule_Calendar_ResponseType|bool
     */
    public function Put_Work_Schedule_Calendar(\WorkdayWsdl\\StructType\Put_Work_Schedule_Calendar_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_External_URL_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_External_URL_ResponseType|bool
     */
    public function Put_External_URL(\WorkdayWsdl\\StructType\Put_External_URL_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Organization_Assignment_Restrictions_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Organization_Assignment_Restrictions_ResponseType|bool
     */
    public function Put_Supervisory_Organization_Assignment_Restrictions(\WorkdayWsdl\\StructType\Put_Organization_Assignment_Restrictions_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Frequency_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Frequency_ResponseType|bool
     */
    public function Put_Frequency(\WorkdayWsdl\\StructType\Put_Frequency_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Disability_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Disability_ResponseType|bool
     */
    public function Put_Disability(\WorkdayWsdl\\StructType\Put_Disability_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Job_Profile_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Job_Profile_ResponseType|bool
     */
    public function Put_Job_Profile(\WorkdayWsdl\\StructType\Put_Job_Profile_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Ethnicity_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Ethnicity_ResponseType|bool
     */
    public function Put_Ethnicity(\WorkdayWsdl\\StructType\Put_Ethnicity_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Training_Type_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Training_Type_ResponseType|bool
     */
    public function Put_Training_Type(\WorkdayWsdl\\StructType\Put_Training_Type_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Job_Classification_Group_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Job_Classification_Group_ResponseType|bool
     */
    public function Put_Job_Classification_Group(\WorkdayWsdl\\StructType\Put_Job_Classification_Group_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Job_Family_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Job_Family_ResponseType|bool
     */
    public function Put_Job_Family(\WorkdayWsdl\\StructType\Put_Job_Family_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Job_Family_Group_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Job_Family_Group_ResponseType|bool
     */
    public function Put_Job_Family_Group(\WorkdayWsdl\\StructType\Put_Job_Family_Group_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Assign_User_Based_Security_Groups_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Assign_User_Based_Security_Groups_ResponseType|bool
     */
    public function Put_User_Based_Security_Group_Assignments(\WorkdayWsdl\\StructType\Put_Assign_User_Based_Security_Groups_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Difficulty_to_Fill_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Difficulty_to_Fill_ResponseType|bool
     */
    public function Put_Difficulty_to_Fill(\WorkdayWsdl\\StructType\Put_Difficulty_to_Fill_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Worker_Photo_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Worker_Photo_ResponseType|bool
     */
    public function Put_Worker_Photo(\WorkdayWsdl\\StructType\Put_Worker_Photo_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Academic_Rank_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Academic_Rank_ResponseType|bool
     */
    public function Put_Academic_Rank(\WorkdayWsdl\\StructType\Put_Academic_Rank_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Provisioning_Group_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Provisioning_Group_ResponseType|bool
     */
    public function Put_Provisioning_Group(\WorkdayWsdl\\StructType\Put_Provisioning_Group_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Provisioning_Group_Assignment_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Provisioning_Group_Assignment_ResponseType|bool
     */
    public function Put_Provisioning_Group_Assignment(\WorkdayWsdl\\StructType\Put_Provisioning_Group_Assignment_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Search_Settings_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Search_Settings_ResponseType|bool
     */
    public function Put_Search_Settings(\WorkdayWsdl\\StructType\Put_Search_Settings_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Addresses_for_Country_Format_Extension_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Addresses_for_Country_Format_Extension_ResponseType|bool
     */
    public function Put_Addresses_for_Country_Format_Extension(\WorkdayWsdl\\StructType\Put_Addresses_for_Country_Format_Extension_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Service_Center_Representative_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Service_Center_Representative_ResponseType|bool
     */
    public function Put_Service_Center_Representative(\WorkdayWsdl\\StructType\Put_Service_Center_Representative_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Service_Center_Representative_Workday_Account_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Service_Center_Representative_Workday_Account_ResponseType|bool
     */
    public function Put_Service_Center_Representative_Workday_Account(\WorkdayWsdl\\StructType\Put_Service_Center_Representative_Workday_Account_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Academic_Unit_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Academic_Unit_ResponseType|bool
     */
    public function Put_Academic_Unit(\WorkdayWsdl\\StructType\Put_Academic_Unit_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Academic_Unit_Hierarchy_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Academic_Unit_Hierarchy_ResponseType|bool
     */
    public function Put_Academic_Unit_Hierarchy(\WorkdayWsdl\\StructType\Put_Academic_Unit_Hierarchy_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Political_Affiliation_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Political_Affiliation_ResponseType|bool
     */
    public function Put_Political_Affiliation(\WorkdayWsdl\\StructType\Put_Political_Affiliation_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Former_Worker_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Former_Worker_ResponseType|bool
     */
    public function Put_Former_Worker(\WorkdayWsdl\\StructType\Put_Former_Worker_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Social_Benefits_Locality_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Social_Benefits_Locality_ResponseType|bool
     */
    public function Put_Social_Benefits_Locality(\WorkdayWsdl\\StructType\Put_Social_Benefits_Locality_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Former_Worker_Document_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Former_Worker_Document_ResponseType|bool
     */
    public function Put_Former_Worker_Document(\WorkdayWsdl\\StructType\Put_Former_Worker_Document_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Assign_User_Based_Security_Group_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Assign_User_Based_Security_Group_ResponseType|bool
     */
    public function Put_Assign_User_Based_Security_Group(\WorkdayWsdl\\StructType\Put_Assign_User_Based_Security_Group_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Location_Hierarchy_Organization_Assignments_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Location_Hierarchy_Organization_Assignments_ResponseType|bool
     */
    public function Put_Location_Hierarchy_Organization_Assignments(\WorkdayWsdl\\StructType\Put_Location_Hierarchy_Organization_Assignments_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Organization_Reference_ID_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Organization_Reference_ID_ResponseType|bool
     */
    public function Put_Organization_Reference_ID(\WorkdayWsdl\\StructType\Put_Organization_Reference_ID_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Committee_Type_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Committee_Type_ResponseType|bool
     */
    public function Put_Committee_Type(\WorkdayWsdl\\StructType\Put_Committee_Type_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Committee_Classification_Group_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Committee_Classification_Group_ResponseType|bool
     */
    public function Put_Committee_Classification_Group(\WorkdayWsdl\\StructType\Put_Committee_Classification_Group_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Committee_Classification_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Committee_Classification_ResponseType|bool
     */
    public function Put_Committee_Classification(\WorkdayWsdl\\StructType\Put_Committee_Classification_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Committee_Membership_Type_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Committee_Membership_Type_ResponseType|bool
     */
    public function Put_Committee_Membership_Type(\WorkdayWsdl\\StructType\Put_Committee_Membership_Type_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_LGBT_Identification_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_LGBT_Identification_ResponseType|bool
     */
    public function Put_LGBT_Identification(\WorkdayWsdl\\StructType\Put_LGBT_Identification_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Appointment_Specialty_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Appointment_Specialty_ResponseType|bool
     */
    public function Put_Appointment_Specialty(\WorkdayWsdl\\StructType\Put_Appointment_Specialty_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Committee_Meeting_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Committee_Meeting_ResponseType|bool
     */
    public function Put_Committee_Meeting(\WorkdayWsdl\\StructType\Put_Committee_Meeting_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Establishment_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Establishment_ResponseType|bool
     */
    public function Put_Establishment(\WorkdayWsdl\\StructType\Put_Establishment_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Work_Status_Rule_Set_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Work_Status_Rule_Set_ResponseType|bool
     */
    public function Put_Work_Status_Rule_Set(\WorkdayWsdl\\StructType\Put_Work_Status_Rule_Set_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Period_Reporting_Calendar_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Period_Reporting_Calendar_ResponseType|bool
     */
    public function Put_Period_Reporting_Calendar(\WorkdayWsdl\\StructType\Put_Period_Reporting_Calendar_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Location_Attribute_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Location_Attribute_ResponseType|bool
     */
    public function Put_Location_Attribute(\WorkdayWsdl\\StructType\Put_Location_Attribute_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Safety_Incident_Location_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Safety_Incident_Location_ResponseType|bool
     */
    public function Put_Safety_Incident_Location(\WorkdayWsdl\\StructType\Put_Safety_Incident_Location_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_External_Disability_Self_Identification_Record_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_External_Disability_Self_Identification_Record_ResponseType|bool
     */
    public function Put_External_Disability_Self_Identification_Record(\WorkdayWsdl\\StructType\Put_External_Disability_Self_Identification_Record_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Gender_Identity_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Gender_Identity_ResponseType|bool
     */
    public function Put_Gender_Identity(\WorkdayWsdl\\StructType\Put_Gender_Identity_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Sexual_Orientation_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Sexual_Orientation_ResponseType|bool
     */
    public function Put_Sexual_Orientation(\WorkdayWsdl\\StructType\Put_Sexual_Orientation_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Pronoun_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Pronoun_ResponseType|bool
     */
    public function Put_Pronoun(\WorkdayWsdl\\StructType\Put_Pronoun_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Organization_Name_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Organization_Name_ResponseType|bool
     */
    public function Put_Organization_Name(\WorkdayWsdl\\StructType\Put_Organization_Name_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Universal_Identifier_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Universal_Identifier_ResponseType|bool
     */
    public function Put_Universal_Identifier(\WorkdayWsdl\\StructType\Put_Universal_Identifier_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Sort_Order_Enabled_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Sort_Order_Enabled_ResponseType|bool
     */
    public function Put_Sort_Order_Enabled(\WorkdayWsdl\\StructType\Put_Sort_Order_Enabled_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Preferred_Communication_Language_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Preferred_Communication_Language_ResponseType|bool
     */
    public function Put_Preferred_Communication_Language(\WorkdayWsdl\\StructType\Put_Preferred_Communication_Language_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_EEO_Data_Record_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_EEO_Data_Record_ResponseType|bool
     */
    public function Put_EEO_Data_Record(\WorkdayWsdl\\StructType\Put_EEO_Data_Record_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Workteam_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Workteam_ResponseType|bool
     */
    public function Put_Workteam(\WorkdayWsdl\\StructType\Put_Workteam_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_External_Form_I_9_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_External_Form_I_9_ResponseType|bool
     */
    public function Put_External_Form_I_9(\WorkdayWsdl\\StructType\Put_External_Form_I_9_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_External_Form_I_9_Source_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_External_Form_I_9_Source_ResponseType|bool
     */
    public function Put_External_Form_I_9_Source(\WorkdayWsdl\\StructType\Put_External_Form_I_9_Source_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_External_Form_I_9_Section_3_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_External_Form_I_9_Section_3_ResponseType|bool
     */
    public function Put_External_Form_I_9_Section_3(\WorkdayWsdl\\StructType\Put_External_Form_I_9_Section_3_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Workteam_Membership_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Workteam_Membership_ResponseType|bool
     */
    public function Put_Workteam_Membership(\WorkdayWsdl\\StructType\Put_Workteam_Membership_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Put_Work_Schedule_Calendar_Group_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Work_Schedule_Calendar_Group_ResponseType|bool
     */
    public function Put_Work_Schedule_Calendar_Group(\WorkdayWsdl\\StructType\Put_Work_Schedule_Calendar_Group_RequestType $body)
    {
        try {
     ...
     * @return \WorkdayWsdl\\StructType\Put_Academic_Rank_ResponseType|\WorkdayWsdl\\StructType\Put_Academic_Unit_Hierarchy_ResponseType|\WorkdayWsdl\\StructType\Put_Academic_Unit_ResponseType|\WorkdayWsdl\\StructType\Put_Addresses_for_Country_Format_Extension_ResponseType|\WorkdayWsdl\\StructType\Put_Appointment_Specialty_ResponseType|\WorkdayWsdl\\StructType\Put_Assign_User_Based_Security_Groups_ResponseType|\WorkdayWsdl\\StructType\Put_Assign_User_Based_Security_Group_ResponseType|\WorkdayWsdl\\StructType\Put_Committee_Classification_Group_ResponseType|\WorkdayWsdl\\StructType\Put_Committee_Classification_ResponseType|\WorkdayWsdl\\StructType\Put_Committee_Meeting_ResponseType|\WorkdayWsdl\\StructType\Put_Committee_Membership_Type_ResponseType|\WorkdayWsdl\\StructType\Put_Committee_Type_ResponseType|\WorkdayWsdl\\StructType\Put_Company_Insider_Type_ResponseType|\WorkdayWsdl\\StructType\Put_Dependent_ResponseType|\WorkdayWsdl\\StructType\Put_Difficulty_to_Fill_ResponseType|\WorkdayWsdl\\StructType\Put_Disability_ResponseType|\WorkdayWsdl\\StructType\Put_EEO_Data_Record_ResponseType|\WorkdayWsdl\\StructType\Put_Establishment_ResponseType|\WorkdayWsdl\\StructType\Put_Ethnicity_ResponseType|\WorkdayWsdl\\StructType\Put_External_Disability_Self_Identification_Record_ResponseType|\WorkdayWsdl\\StructType\Put_External_Form_I_9_ResponseType|\WorkdayWsdl\\StructType\Put_External_Form_I_9_Section_3_ResponseType|\WorkdayWsdl\\StructType\Put_External_Form_I_9_Source_ResponseType|\WorkdayWsdl\\StructType\Put_External_URL_ResponseType|\WorkdayWsdl\\StructType\Put_Former_Worker_Document_ResponseType|\WorkdayWsdl\\StructType\Put_Former_Worker_ResponseType|\WorkdayWsdl\\StructType\Put_Frequency_ResponseType|\WorkdayWsdl\\StructType\Put_Gender_Identity_ResponseType|\WorkdayWsdl\\StructType\Put_Holiday_Calendar_ResponseType|\WorkdayWsdl\\StructType\Put_Job_Category_ResponseType|\WorkdayWsdl\\StructType\Put_Job_Classification_Group_ResponseType|\WorkdayWsdl\\StructType\Put_Job_Family_Group_ResponseType|\WorkdayWsdl\\StructType\Put_Job_Family_ResponseType|\WorkdayWsdl\\StructType\Put_Job_Profile_ResponseType|\WorkdayWsdl\\StructType\Put_LGBT_Identification_ResponseType|\WorkdayWsdl\\StructType\Put_Location_Attribute_ResponseType|\WorkdayWsdl\\StructType\Put_Location_Hierarchy_Organization_Assignments_ResponseType|\WorkdayWsdl\\StructType\Put_Location_ResponseType|\WorkdayWsdl\\StructType\Put_Organization_Assignment_Restrictions_ResponseType|\WorkdayWsdl\\StructType\Put_Organization_Name_ResponseType|\WorkdayWsdl\\StructType\Put_Organization_Reference_ID_ResponseType|\WorkdayWsdl\\StructType\Put_Period_Reporting_Calendar_ResponseType|\WorkdayWsdl\\StructType\Put_Political_Affiliation_ResponseType|\WorkdayWsdl\\StructType\Put_Preferred_Communication_Language_ResponseType|\WorkdayWsdl\\StructType\Put_Previous_System_Job_History_ResponseType|\WorkdayWsdl\\StructType\Put_Pronoun_ResponseType|\WorkdayWsdl\\StructType\Put_Provisioning_Group_Assignment_ResponseType|\WorkdayWsdl\\StructType\Put_Provisioning_Group_ResponseType|\WorkdayWsdl\\StructType\Put_Safety_Incident_Location_ResponseType|\WorkdayWsdl\\StructType\Put_Search_Settings_ResponseType|\WorkdayWsdl\\StructType\Put_Service_Center_Representative_ResponseType|\WorkdayWsdl\\StructType\Put_Service_Center_Representative_Workday_Account_ResponseType|\WorkdayWsdl\\StructType\Put_Sexual_Orientation_ResponseType|\WorkdayWsdl\\StructType\Put_Social_Benefits_Locality_ResponseType|\WorkdayWsdl\\StructType\Put_Sort_Order_Enabled_ResponseType|\WorkdayWsdl\\StructType\Put_Training_Type_ResponseType|\WorkdayWsdl\\StructType\Put_Universal_Identifier_ResponseType|\WorkdayWsdl\\StructType\Put_Workers_Compensation_Code_ResponseType|\WorkdayWsdl\\StructType\Put_Worker_Photo_ResponseType|\WorkdayWsdl\\StructType\Put_Workteam_Membership_ResponseType|\WorkdayWsdl\\StructType\Put_Workteam_ResponseType|\WorkdayWsdl\\StructType\Put_Work_Schedule_Calendar_Group_ResponseType|\WorkdayWsdl\\StructType\Put_Work_Schedule_Calendar_ResponseType|\WorkdayWsdl\\StructType\Put_Work_Shift_ResponseType|\WorkdayWsdl\\StructType\Put_Work_Status_Rule_Set_ResponseType
     */
