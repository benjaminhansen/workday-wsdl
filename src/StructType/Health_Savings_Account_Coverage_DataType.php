...
class Health_Savings_Account_Coverage_DataType extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * @var \StructType\Health_Savings_Account_Election_Info_DataType
     */
     ...
     * @param \StructType\Health_Savings_Account_Election_Info_DataType $health_Savings_Account_Election_Info_Data
     ...
     */
    public function __construct(\StructType\Worker_Benefit_Election_DataType $benefit_Election_Data = null, \StructType\Health_Savings_Account_Election_Info_DataType $health_Savings_Account_Election_Info_Data = null, \StructType\Employee_Contribution_DataType $employee_Contribution_Data = null, \StructType\Employer_Contribution_DataType $employer_Contribution_Data = null)
    {
        $this
     ...
     * @param \StructType\Worker_Benefit_Election_DataType $benefit_Election_Data
     * @return \StructType\Health_Savings_Account_Coverage_DataType
     */
     ...
     * @return \StructType\Health_Savings_Account_Election_Info_DataType|null
     */
     ...
     * @return \StructType\Health_Savings_Account_Coverage_DataType
     */
    public function setHealth_Savings_Account_Election_Info_Data(\StructType\Health_Savings_Account_Election_Info_DataType $health_Savings_Account_Election_Info_Data = null)
    {
