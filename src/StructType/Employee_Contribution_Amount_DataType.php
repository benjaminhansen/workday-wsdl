...
class Employee_Contribution_Amount_DataType extends AbstractStructBase
{
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\Contribution_Amount_DataType $contribution_Amount_Data = null, \WorkdayWsdl\\StructType\Payroll_Interface_Contribution_Amount_DataType $payroll_Interface_Contribution_Amount_Data = null, $contribution_Amount_Maximum = null, \WorkdayWsdl\\StructType\CurrencyObjectType $currency_Reference = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Contribution_Amount_DataType $contribution_Amount_Data
     * @return \WorkdayWsdl\\StructType\Employee_Contribution_Amount_DataType
     */
