...
/**
 * This class stands for Get_EEO_Data_Record_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Get EEO Data Record Request
 * @subpackage Structs
 */
class Get_EEO_Data_Record_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_EEO_Data_Record_RequestType
     * @uses Get_EEO_Data_Record_RequestType::setRequest_References()
     * @uses Get_EEO_Data_Record_RequestType::setRequest_Criteria()
     * @uses Get_EEO_Data_Record_RequestType::setResponse_Filter()
     * @uses Get_EEO_Data_Record_RequestType::setResponse_Group()
     * @uses Get_EEO_Data_Record_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\External_EEO_1_Data_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_EEO_Data_Record_RequestType
     */
