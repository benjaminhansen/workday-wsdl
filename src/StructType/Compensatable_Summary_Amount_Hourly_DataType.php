...
class Compensatable_Summary_Amount_Hourly_DataType extends AbstractStructBase
{
     ...
     */
    public function __construct($total_Base_Pay = null, \StructType\CurrencyObjectType $currency_Reference = null, \StructType\FrequencyObjectType $frequency_Reference = null)
    {
        $this
     ...
     * @param float $total_Base_Pay
     * @return \StructType\Compensatable_Summary_Amount_Hourly_DataType
     */
