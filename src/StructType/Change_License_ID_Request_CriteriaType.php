...
/**
 * This class stands for Change_License_ID_Request_CriteriaType StructType
 * Meta information extracted from the WSDL
 * - documentation: Invalid request filter provided. Include at least one person type in the request | Allows retrieving License IDs based on request criteria.
 * @subpackage Structs
 */
class Change_License_ID_Request_CriteriaType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Change_License_ID_Request_CriteriaType
     * @uses Change_License_ID_Request_CriteriaType::setPerson_Type_Criteria_Data()
     ...
     * @param \WorkdayWsdl\\StructType\Person_Type_CriteriaType $person_Type_Criteria_Data
     * @return \WorkdayWsdl\\StructType\Change_License_ID_Request_CriteriaType
     */
