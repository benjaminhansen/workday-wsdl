...
/**
 * This class stands for Get_Appointment_Specialties_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Get Appointment Specialties Request
 * @subpackage Structs
 */
class Get_Appointment_Specialties_RequestType extends AbstractStructBase
{
    /**
     ...
     * Meta information extracted from the WSDL
     * - documentation: Appointment Specialty Request Criteria
     * - choice: Request_References | Request_Criteria
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * - minOccurs: 0
    ...
    public $version;
    /**
     * Constructor method for Get_Appointment_Specialties_RequestType
     * @uses Get_Appointment_Specialties_RequestType::setRequest_References()
     * @uses Get_Appointment_Specialties_RequestType::setRequest_Criteria()
