...
/**
 * This class stands for Worker_DocumentObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Worker_DocumentObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Worker_DocumentObjectIDType
     * @uses Worker_DocumentObjectIDType::setType()
     * @uses Worker_DocumentObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
