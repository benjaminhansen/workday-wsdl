...
class Responsibility_Qualification_ReplacementType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Responsibility_Qualification_Profile_Replacement_DataType[]
     */
     ...
     * @param \WorkdayWsdl\\StructType\Responsibility_Qualification_Profile_Replacement_DataType[] $responsibility_Qualification_Replacement_Data
     * @param bool $delete
     */
     ...
     * @return \WorkdayWsdl\\StructType\Responsibility_Qualification_Profile_Replacement_DataType[]|null
     */
    ...
    public static function validateResponsibility_Qualification_Replacement_DataForArrayConstraintsFromSetResponsibility_Qualification_Replacement_Data(array $values = array())
    {
        ...
        foreach ($values as $responsibility_Qualification_ReplacementTypeResponsibility_Qualification_Replacement_DataItem) {
            ...
            if (!$responsibility_Qualification_ReplacementTypeResponsibility_Qualification_Replacement_DataItem instanceof \WorkdayWsdl\\StructType\Responsibility_Qualification_Profile_Replacement_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Responsibility_Qualification_Replacement_Data property can only contain items of type \WorkdayWsdl\\StructType\Responsibility_Qualification_Profile_Replacement_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @param \WorkdayWsdl\\StructType\Responsibility_Qualification_Profile_Replacement_DataType[] $responsibility_Qualification_Replacement_Data
     * @return \WorkdayWsdl\\StructType\Responsibility_Qualification_ReplacementType
     */
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Responsibility_Qualification_Profile_Replacement_DataType $item
     * @return \WorkdayWsdl\\StructType\Responsibility_Qualification_ReplacementType
     */
    public function addToResponsibility_Qualification_Replacement_Data(\WorkdayWsdl\\StructType\Responsibility_Qualification_Profile_Replacement_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Responsibility_Qualification_Profile_Replacement_DataType) {
            throw new \InvalidArgumentException(sprintf('The Responsibility_Qualification_Replacement_Data property can only contain items of type \WorkdayWsdl\\StructType\Responsibility_Qualification_Profile_Replacement_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
