 ...
 * Get_External_Disability_Self_Identification_Records_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains the response elements for the Get External Disability Self-Identification Record
 * @subpackage Structs
 */
class Get_External_Disability_Self_Identification_Records_ResponseType extends AbstractStructBase
{
    /**
     ...
     * Get_External_Disability_Self_Identification_Records_ResponseType
     * @uses Get_External_Disability_Self_Identification_Records_ResponseType::setRequest_References()
     * @uses Get_External_Disability_Self_Identification_Records_ResponseType::setRequest_Criteria()
     * @uses Get_External_Disability_Self_Identification_Records_ResponseType::setResponse_Filter()
