...
/**
 * This class stands for Generic_Disability_Information_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: Wrapper element for all Disability Status data for the person.
 * @subpackage Structs
 */
class Generic_Disability_Information_DataType extends AbstractStructBase
{
    /**
     ...
     * The Replace_All
     * Meta information extracted from the WSDL
     * - documentation: When this flag is set to false, existing disability data will be preserved. When true, it causes the web service to replace all disability data with the information in the request (this is the default behavior when the entire tag is
     * omitted).
     * @var bool
     */
    public $Replace_All;
