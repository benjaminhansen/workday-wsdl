...
/**
 * This class stands for Work_Status_Rule_Set_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Response Group for Work Status Rule Set
 * @subpackage Structs
 */
class Work_Status_Rule_Set_Response_GroupType extends AbstractStructBase
{
    /**
     * The Include_Reference
     * Meta information extracted from the WSDL
     * - documentation: Boolean that checks on whether or not to include the reference ID
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var bool
     */
    ...
    /**
     * Constructor method for Work_Status_Rule_Set_Response_GroupType
     * @uses Work_Status_Rule_Set_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\Work_Status_Rule_Set_Response_GroupType
     */
