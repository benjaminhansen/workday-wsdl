...
/**
 * This class stands for Get_Job_Family_Groups_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Response element for the Get Job Family Group request
 * @subpackage Structs
 */
class Get_Job_Family_Groups_ResponseType extends AbstractStructBase
{
    /**
     ...
     * The Response_Group
     * Meta information extracted from the WSDL
     * - documentation: Contains settings to control the type and amount of data returned by the request.
     * - minOccurs: 0
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Job_Family_Group_Response_DataType
     */
    ...
    public $version;
    /**
     * Constructor method for Get_Job_Family_Groups_ResponseType
     * @uses Get_Job_Family_Groups_ResponseType::setRequest_References()
     * @uses Get_Job_Family_Groups_ResponseType::setResponse_Filter()
     * @uses Get_Job_Family_Groups_ResponseType::setResponse_Group()
     * @uses Get_Job_Family_Groups_ResponseType::setResponse_Results()
     * @uses Get_Job_Family_Groups_ResponseType::setResponse_Data()
     * @uses Get_Job_Family_Groups_ResponseType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Job_Family_Group_Response_DataType $response_Data
     * @param string $version
     */
    public function __construct(\WorkdayWsdl\\StructType\Job_Family_Group_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, \WorkdayWsdl\\StructType\Job_Family_Group_Response_GroupType $response_Group = null, \WorkdayWsdl\\StructType\Response_ResultsType $response_Results = null, \WorkdayWsdl\\StructType\Job_Family_Group_Response_DataType $response_Data = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Job_Family_Group_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Job_Family_Groups_ResponseType
     */
     ...
     * @return \WorkdayWsdl\\StructType\Job_Family_Group_Response_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Get_Job_Family_Groups_ResponseType
     */
    public function setResponse_Data(\WorkdayWsdl\\StructType\Job_Family_Group_Response_DataType $response_Data = null)
    {
