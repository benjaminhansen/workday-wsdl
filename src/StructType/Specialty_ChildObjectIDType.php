...
/**
 * This class stands for Specialty_ChildObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Specialty_ChildObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Specialty_ChildObjectIDType
     * @uses Specialty_ChildObjectIDType::setType()
     * @uses Specialty_ChildObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
