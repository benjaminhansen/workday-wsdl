...
class Dependent_Data_WWSType extends AbstractStructBase
{
     ...
     */
    public function __construct(\StructType\External_Integration_ID_DataType $integration_ID_Data = null, $dependent_Educational_Institution = null, $full_time_Student = null, $student_Status_Start_Date = null, $student_Status_End_Date = null, $dependent_Date_of_Death = null, $disabled = null, array $court_Order_Replacement_Data = array())
    {
        $this
     ...
     * @param \StructType\External_Integration_ID_DataType $integration_ID_Data
     * @return \StructType\Dependent_Data_WWSType
     */
    ...
    public static function validateCourt_Order_Replacement_DataForArrayConstraintsFromSetCourt_Order_Replacement_Data(array $values = array())
    {
        ...
        foreach ($values as $dependent_Data_WWSTypeCourt_Order_Replacement_DataItem) {
            ...
            if (!$dependent_Data_WWSTypeCourt_Order_Replacement_DataItem instanceof \StructType\Qualified_Domestic_Relations_Order_Replacement_DataType) {
