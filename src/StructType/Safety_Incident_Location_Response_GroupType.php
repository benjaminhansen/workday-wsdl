...
/**
 * This class stands for Safety_Incident_Location_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Safety Incident Location Response Group
 * @subpackage Structs
 */
class Safety_Incident_Location_Response_GroupType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Safety_Incident_Location_Response_GroupType
     * @uses Safety_Incident_Location_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\Safety_Incident_Location_Response_GroupType
     */
