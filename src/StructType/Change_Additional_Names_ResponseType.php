...
class Change_Additional_Names_ResponseType extends AbstractStructBase
{
     ...
     * @param \StructType\Unique_IdentifierObjectType $person_Additional_Name_Change_Reference
     * @param \StructType\WorkerObjectType $worker_Reference
     * @param \StructType\Additional_Name_DataType[] $additional_Name_Data
     * @param string $version
     */
    public function __construct(\StructType\Unique_IdentifierObjectType $person_Additional_Name_Change_Reference = null, \StructType\WorkerObjectType $worker_Reference = null, array $additional_Name_Data = array(), $version = null)
    {
        $this
     ...
     */
    public function setPerson_Additional_Name_Change_Reference(\StructType\Unique_IdentifierObjectType $person_Additional_Name_Change_Reference = null)
    {
    ...
    public static function validateAdditional_Name_DataForArrayConstraintsFromSetAdditional_Name_Data(array $values = array())
    {
        ...
        foreach ($values as $change_Additional_Names_ResponseTypeAdditional_Name_DataItem) {
            ...
            if (!$change_Additional_Names_ResponseTypeAdditional_Name_DataItem instanceof \StructType\Additional_Name_DataType) {
