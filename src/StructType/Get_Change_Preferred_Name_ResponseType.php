...
/**
 * This class stands for Get_Change_Preferred_Name_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Element containing the Get Change Preferred Name response elements including echoed request data and request references.
 * @subpackage Structs
 */
class Get_Change_Preferred_Name_ResponseType extends AbstractStructBase
{
    /**
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Change_Preferred_Name_Response_DataType
     */
    ...
    public $version;
    /**
     * Constructor method for Get_Change_Preferred_Name_ResponseType
     * @uses Get_Change_Preferred_Name_ResponseType::setRequest_References()
     * @uses Get_Change_Preferred_Name_ResponseType::setResponse_Filter()
     * @uses Get_Change_Preferred_Name_ResponseType::setResponse_Results()
     * @uses Get_Change_Preferred_Name_ResponseType::setResponse_Data()
     * @uses Get_Change_Preferred_Name_ResponseType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Change_Preferred_Name_Response_DataType $response_Data
     * @param string $version
     */
    public function __construct(\WorkdayWsdl\\StructType\Get_Change_Preferred_Name_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, \WorkdayWsdl\\StructType\Response_ResultsType $response_Results = null, \WorkdayWsdl\\StructType\Change_Preferred_Name_Response_DataType $response_Data = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Get_Change_Preferred_Name_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Change_Preferred_Name_ResponseType
     */
     ...
     * @return \WorkdayWsdl\\StructType\Change_Preferred_Name_Response_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Get_Change_Preferred_Name_ResponseType
     */
    public function setResponse_Data(\WorkdayWsdl\\StructType\Change_Preferred_Name_Response_DataType $response_Data = null)
    {
