...
/**
 * This class stands for Payroll_Interface_Contribution_Amount_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains the payroll interface contribution amount for the retirement savings election.
 * @subpackage Structs
 */
class Payroll_Interface_Contribution_Amount_DataType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Payroll_Interface_Contribution_Amount_DataType
