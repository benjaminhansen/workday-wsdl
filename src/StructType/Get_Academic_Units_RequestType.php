...
/**
 * This class stands for Get_Academic_Units_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: A container for a request for one or more Academic Units
 * @subpackage Structs
 */
class Get_Academic_Units_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Academic_Units_RequestType
     * @uses Get_Academic_Units_RequestType::setRequest_References()
     * @uses Get_Academic_Units_RequestType::setRequest_Criteria()
     * @uses Get_Academic_Units_RequestType::setResponse_Filter()
     * @uses Get_Academic_Units_RequestType::setResponse_Group()
     * @uses Get_Academic_Units_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Academic_Unit_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Academic_Units_RequestType
     */
