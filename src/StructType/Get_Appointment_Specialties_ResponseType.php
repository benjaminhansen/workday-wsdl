...
/**
 * This class stands for Get_Appointment_Specialties_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Get Appointment Specialties Response
 * @subpackage Structs
 */
class Get_Appointment_Specialties_ResponseType extends AbstractStructBase
{
    /**
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Appointment_Specialty_Response_DataType
     */
    ...
    public $version;
    /**
     * Constructor method for Get_Appointment_Specialties_ResponseType
     * @uses Get_Appointment_Specialties_ResponseType::setRequest_References()
     * @uses Get_Appointment_Specialties_ResponseType::setRequest_Criteria()
     * @uses Get_Appointment_Specialties_ResponseType::setResponse_Filter()
     * @uses Get_Appointment_Specialties_ResponseType::setResponse_Group()
     * @uses Get_Appointment_Specialties_ResponseType::setResponse_Results()
     * @uses Get_Appointment_Specialties_ResponseType::setResponse_Data()
     * @uses Get_Appointment_Specialties_ResponseType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Appointment_Specialty_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Appointment_Specialties_ResponseType
     */
     ...
     * @return \WorkdayWsdl\\StructType\Appointment_Specialty_Response_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Get_Appointment_Specialties_ResponseType
     */
    public function setResponse_Data(\WorkdayWsdl\\StructType\Appointment_Specialty_Response_DataType $response_Data = null)
    {
