...
/**
 * This class stands for Communication_Usage_Behavior_TenantedObjectIDType
 * StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Communication_Usage_Behavior_TenantedObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Communication_Usage_Behavior_TenantedObjectIDType
     * @uses Communication_Usage_Behavior_TenantedObjectIDType::setType()
     * @uses Communication_Usage_Behavior_TenantedObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
