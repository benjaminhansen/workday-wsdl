 ...
 * External_Field_and_Parameter_Initialization_ProviderObjectType StructType
 * @subpackage Structs
 */
class External_Field_and_Parameter_Initialization_ProviderObjectType extends AbstractStructBase
{
    /**
     * The ID
