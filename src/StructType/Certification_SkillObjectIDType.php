...
/**
 * This class stands for Certification_SkillObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Certification_SkillObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Certification_SkillObjectIDType
     * @uses Certification_SkillObjectIDType::setType()
     * @uses Certification_SkillObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
