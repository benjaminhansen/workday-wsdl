...
/**
 * This class stands for Disability_Status_Sub_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: The entered Certification Basis is not valid for the entered Disability Type | The entered Certification Authority is not valid for the entered Disability Type | The entered Disability Grade is not valid for the entered Disability
 * Type | The provided Disability is not valid for the worker's location context. The location context is derived from the country of the location specified for the position. | The worker's location context is not enabled for Disability FTE Toward
 * Quota. | The worker's location context is not enabled for Disability Severity Recognition Date. | The provided Disability Certification Basis is not valid for the worker's location context or is inactive. | The worker's location context is not
 * enabled for Disability Certification Basis. | The worker's location context is not enabled for Disability Certification ID. | The worker's location is not enabled for Disability Certification Location. | The provided Disability Authority Reference is
 * not valid or inactive for the worker's location context. Or the worker's location context is not enabled for Disability Authority. | The worker's location context is not enabled for Disability Authority. | The provided Disability Authority is not
 * valid for the worker's location context or is inactive. | The worker's location context is configured to use Disability Authority Reference. | The worker's location context is not enabled for Disability Remaining Capacity. | The worker's location
 * context is not enabled for Disability Degree. | The provided Disability Grade is not valid for the worker's location context or is inactive. | The worker's location context is not enabled for Disability Grade. | Container for disability status data
 * for the Personal Information Change business process.
 * @subpackage Structs
 */
class Disability_Status_Sub_DataType extends AbstractStructBase
{
    /**
     ...
     * Meta information extracted from the WSDL
     * - documentation: The Disability End Date cannot be before the Date of Birth. | The date through which the worker is considered disabled. In some countries, this is the date through which the certification for the current level of Disability is
     * effective.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
    ...
    /**
     * Constructor method for Disability_Status_Sub_DataType
     * @uses Disability_Status_Sub_DataType::setDisability_Reference()
     * @uses Disability_Status_Sub_DataType::setDisability_Status_Date()
     * @uses Disability_Status_Sub_DataType::setDisability_Date_Known()
     * @uses Disability_Status_Sub_DataType::setDisability_End_Date()
     * @uses Disability_Status_Sub_DataType::setDisability_Grade_Reference()
     * @uses Disability_Status_Sub_DataType::setDisability_Degree()
     * @uses Disability_Status_Sub_DataType::setDisability_Remaining_Capacity()
     * @uses Disability_Status_Sub_DataType::setDisability_Certification_Authority_Reference()
     * @uses Disability_Status_Sub_DataType::setDisability_Certification_Authority()
     * @uses Disability_Status_Sub_DataType::setDisability_Certified_At()
     * @uses Disability_Status_Sub_DataType::setDisability_Certification_ID()
     * @uses Disability_Status_Sub_DataType::setDisability_Certification_Basis_Reference()
     * @uses Disability_Status_Sub_DataType::setDisability_Severity_Recognition_Date()
     * @uses Disability_Status_Sub_DataType::setDisability_FTE_Toward_Quota()
     * @uses Disability_Status_Sub_DataType::setDisability_Work_Restrictions()
     * @uses Disability_Status_Sub_DataType::setDisability_Accommodations_Requested()
     * @uses Disability_Status_Sub_DataType::setDisability_Accommodations_Provided()
     * @uses Disability_Status_Sub_DataType::setDisability_Rehabilitation_Requested()
