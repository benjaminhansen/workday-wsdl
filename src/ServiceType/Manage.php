...
class Manage extends AbstractSoapClientBase
{
     ...
     * @param \WorkdayWsdl\\StructType\Manage_Union_Membership_RequestType $body
     * @return \WorkdayWsdl\\StructType\Manage_Union_Membership_ResponseType|bool
     */
    public function Manage_Union_Membership(\WorkdayWsdl\\StructType\Manage_Union_Membership_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Manage_Committee_Membership_RequestType $body
     * @return \WorkdayWsdl\\StructType\Manage_Committee_Membership_ResponseType|bool
     */
    public function Manage_Committee_Membership(\WorkdayWsdl\\StructType\Manage_Committee_Membership_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Manage_Employee_Probation_Periods_Event_RequestType $body
     * @return \WorkdayWsdl\\StructType\Manage_Employee_Probation_Periods_Event_ResponseType|bool
     */
    public function Manage_Employee_Probation_Periods_Event(\WorkdayWsdl\\StructType\Manage_Employee_Probation_Periods_Event_RequestType $body)
    {
        try {
     ...
     * @return \WorkdayWsdl\\StructType\Manage_Committee_Membership_ResponseType|\WorkdayWsdl\\StructType\Manage_Employee_Probation_Periods_Event_ResponseType|\WorkdayWsdl\\StructType\Manage_Union_Membership_ResponseType
     */
