...
class Change_Preferred_Name_ResponseType extends AbstractStructBase
{
     ...
     * @param \StructType\Unique_IdentifierObjectType $preferred_Name_Change_Event_Reference
     * @param string $version
     */
    public function __construct(\StructType\Unique_IdentifierObjectType $preferred_Name_Change_Event_Reference = null, $version = null)
    {
        $this
     ...
     * @param \StructType\Unique_IdentifierObjectType $preferred_Name_Change_Event_Reference
     * @return \StructType\Change_Preferred_Name_ResponseType
     */
    public function setPreferred_Name_Change_Event_Reference(\StructType\Unique_IdentifierObjectType $preferred_Name_Change_Event_Reference = null)
    {
