...
/**
 * This class stands for Leave_Request_EventObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Leave_Request_EventObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Leave_Request_EventObjectIDType
     * @uses Leave_Request_EventObjectIDType::setType()
     * @uses Leave_Request_EventObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
