...
/**
 * This class stands for Workteam_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Workteam Response Group
 * @subpackage Structs
 */
class Workteam_Response_GroupType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Workteam_Response_GroupType
     * @uses Workteam_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\Workteam_Response_GroupType
     */
