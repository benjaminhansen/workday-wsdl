...
/**
 * This class stands for Get_Work_Schedule_Calendars_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request to get Work Schedule Calendar.
 * @subpackage Structs
 */
class Get_Work_Schedule_Calendars_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Work_Schedule_Calendars_RequestType
     * @uses Get_Work_Schedule_Calendars_RequestType::setRequest_References()
     * @uses Get_Work_Schedule_Calendars_RequestType::setRequest_Criteria()
     * @uses Get_Work_Schedule_Calendars_RequestType::setResponse_Filter()
     * @uses Get_Work_Schedule_Calendars_RequestType::setResponse_Group()
     * @uses Get_Work_Schedule_Calendars_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Work_Schedule_Calendar_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Work_Schedule_Calendars_RequestType
     */
