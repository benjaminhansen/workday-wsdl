...
/**
 * This class stands for External_Disability_Self-Identification_RecordObjectType
 * StructType
 * @subpackage Structs
 */
class External_Disability_Self_Identification_RecordObjectType extends AbstractStructBase
{
    /**
     * The ID
