...
/**
 * This class stands for Background_Check_Event_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: Wrapper element for Change Background Check Status business process web service
 * @subpackage Structs
 */
class Background_Check_Event_DataType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Background_Check_Event_DataType
     * @uses Background_Check_Event_DataType::setEmployee_Reference()
