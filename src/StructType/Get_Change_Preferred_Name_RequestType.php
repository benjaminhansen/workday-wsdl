...
/**
 * This class stands for Get_Change_Preferred_Name_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request element used to get preferred name for a worker. The response is formatted to be usable as input to the Change Preferred Name web service request.
 * @subpackage Structs
 */
class Get_Change_Preferred_Name_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Change_Preferred_Name_RequestType
     * @uses Get_Change_Preferred_Name_RequestType::setRequest_References()
