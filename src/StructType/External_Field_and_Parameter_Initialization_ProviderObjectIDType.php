 ...
 * External_Field_and_Parameter_Initialization_ProviderObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class External_Field_and_Parameter_Initialization_ProviderObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
     ...
     * External_Field_and_Parameter_Initialization_ProviderObjectIDType
     * @uses External_Field_and_Parameter_Initialization_ProviderObjectIDType::setType()
     * @uses External_Field_and_Parameter_Initialization_ProviderObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
