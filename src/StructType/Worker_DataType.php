...
class Worker_DataType extends AbstractStructBase
{
     ...
     * Information
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Worker_Employment_Information_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Worker_Compensation_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Worker_Organization_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Worker_Role_DataType
     */
    public $Role_Data;
    /**
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Worker_Management_Chain_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Worker_Benefit_Enrollment_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Worker_Benefit_Eligibility_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Worker_Related_Persons_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Person_Qualification_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Employee_Review_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Entry_DataType
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Rescind_And_Correct_DataType[]
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Succession_Profile_DataType
     */
     ...
     * Talent.
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Talent_Assessment_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Worker_Goal_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Worker_Development_Item_DataType
     */
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Worker_Skill_Item_DataType
     */
    public $Skill_Data;
    /**
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Employee_Contracts_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Extended_Employee_Contracts_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Feedback_Received_DataType
     */
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\System_User_for_Worker_DataType
     */
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Worker_Career_DataType
     */
    public $Career_Data;
    /**
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Person_Account_Provisioning_DataType
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Background_Check_Overall_Status_DataType[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Contingent_Worker_Tax_Authority_Form_Information_DataType[]
     */
     ...
     * @param \WorkdayWsdl\\StructType\Worker_Employment_Information_DataType $employment_Data
     * @param \WorkdayWsdl\\StructType\Worker_Compensation_DataType $compensation_Data
     * @param \WorkdayWsdl\\StructType\Worker_Organization_DataType $organization_Data
     * @param \WorkdayWsdl\\StructType\Worker_Role_DataType $role_Data
     * @param \WorkdayWsdl\\StructType\Worker_Management_Chain_DataType $management_Chain_Data
     * @param \WorkdayWsdl\\StructType\Worker_Benefit_Enrollment_DataType $benefit_Enrollment_Data
     * @param \WorkdayWsdl\\StructType\Worker_Benefit_Eligibility_DataType $benefit_Eligibility_Data
     * @param \WorkdayWsdl\\StructType\Worker_Related_Persons_DataType $related_Person_Data
     * @param \WorkdayWsdl\\StructType\Person_Qualification_DataType $qualification_Data
     * @param \WorkdayWsdl\\StructType\Employee_Review_DataType $employee_Review_Data
     * @param \WorkdayWsdl\\StructType\Employee_Image_DataType $photo_Data
     ...
     * @param \WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Entry_DataType $transaction_Log_Entry_Data
     * @param \WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Rescind_And_Correct_DataType[] $transaction_Log_Corrected_And_Rescinded_Data
     * @param \WorkdayWsdl\\StructType\Succession_Profile_DataType $succession_Profile_Data
     * @param \WorkdayWsdl\\StructType\Talent_Assessment_DataType $talent_Assessment_Data
     * @param \WorkdayWsdl\\StructType\Worker_Goal_DataType $worker_Goal_Data
     * @param \WorkdayWsdl\\StructType\Worker_Development_Item_DataType $development_Item_Data
     * @param \WorkdayWsdl\\StructType\Worker_Skill_Item_DataType $skill_Data
     * @param \WorkdayWsdl\\StructType\Employee_Contracts_DataType $employee_Contracts_Data
     * @param \WorkdayWsdl\\StructType\Extended_Employee_Contracts_DataType $extended_Employee_Contracts_Data
     * @param \WorkdayWsdl\\StructType\Feedback_Received_DataType $feedback_Received_Data
     * @param \WorkdayWsdl\\StructType\System_User_for_Worker_DataType $user_Account_Data
     * @param \WorkdayWsdl\\StructType\Worker_Career_DataType $career_Data
     * @param \WorkdayWsdl\\StructType\Person_Account_Provisioning_DataType $account_Provisioning_Data
     * @param \WorkdayWsdl\\StructType\Background_Check_Overall_Status_DataType[] $background_Check_Data
     * @param \WorkdayWsdl\\StructType\Contingent_Worker_Tax_Authority_Form_Information_DataType[] $contingent_Worker_Tax_Authority_Form_Type_Data
     */
    public function __construct($worker_ID = null, $user_ID = null, $universal_ID = null, \WorkdayWsdl\\StructType\Personal_Information_DataType $personal_Data = null, \WorkdayWsdl\\StructType\Worker_Employment_Information_DataType $employment_Data = null, \WorkdayWsdl\\StructType\Worker_Compensation_DataType $compensation_Data = null, \WorkdayWsdl\\StructType\Worker_Organization_DataType $organization_Data = null, \WorkdayWsdl\\StructType\Worker_Role_DataType $role_Data = null, \WorkdayWsdl\\StructType\Worker_Management_Chain_DataType $management_Chain_Data = null, \WorkdayWsdl\\StructType\Worker_Benefit_Enrollment_DataType $benefit_Enrollment_Data = null, \WorkdayWsdl\\StructType\Worker_Benefit_Eligibility_DataType $benefit_Eligibility_Data = null, \WorkdayWsdl\\StructType\Worker_Related_Persons_DataType $related_Person_Data = null, \WorkdayWsdl\\StructType\Person_Qualification_DataType $qualification_Data = null, \WorkdayWsdl\\StructType\Employee_Review_DataType $employee_Review_Data = null, \WorkdayWsdl\\StructType\Employee_Image_DataType $photo_Data = null, \WorkdayWsdl\\StructType\Worker_Document_Data_WWSType $worker_Document_Data = null, array $integration_Field_Override_Data = array(), \WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Entry_DataType $transaction_Log_Entry_Data = null, array $transaction_Log_Corrected_And_Rescinded_Data = array(), \WorkdayWsdl\\StructType\Succession_Profile_DataType $succession_Profile_Data = null, \WorkdayWsdl\\StructType\Talent_Assessment_DataType $talent_Assessment_Data = null, \WorkdayWsdl\\StructType\Worker_Goal_DataType $worker_Goal_Data = null, \WorkdayWsdl\\StructType\Worker_Development_Item_DataType $development_Item_Data = null, \WorkdayWsdl\\StructType\Worker_Skill_Item_DataType $skill_Data = null, \WorkdayWsdl\\StructType\Employee_Contracts_DataType $employee_Contracts_Data = null, \WorkdayWsdl\\StructType\Extended_Employee_Contracts_DataType $extended_Employee_Contracts_Data = null, \WorkdayWsdl\\StructType\Feedback_Received_DataType $feedback_Received_Data = null, \WorkdayWsdl\\StructType\System_User_for_Worker_DataType $user_Account_Data = null, \WorkdayWsdl\\StructType\Worker_Career_DataType $career_Data = null, \WorkdayWsdl\\StructType\Person_Account_Provisioning_DataType $account_Provisioning_Data = null, array $background_Check_Data = array(), array $contingent_Worker_Tax_Authority_Form_Type_Data = array())
    {
        $this
     ...
     * Set Worker_ID value
     * @param string $worker_ID
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_Employment_Information_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setEmployment_Data(\WorkdayWsdl\\StructType\Worker_Employment_Information_DataType $employment_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Worker_Compensation_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setCompensation_Data(\WorkdayWsdl\\StructType\Worker_Compensation_DataType $compensation_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Worker_Organization_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setOrganization_Data(\WorkdayWsdl\\StructType\Worker_Organization_DataType $organization_Data = null)
    {
    ...
    /**
     * Get Role_Data value
     * @return \WorkdayWsdl\\StructType\Worker_Role_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setRole_Data(\WorkdayWsdl\\StructType\Worker_Role_DataType $role_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Worker_Management_Chain_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setManagement_Chain_Data(\WorkdayWsdl\\StructType\Worker_Management_Chain_DataType $management_Chain_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Worker_Benefit_Enrollment_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setBenefit_Enrollment_Data(\WorkdayWsdl\\StructType\Worker_Benefit_Enrollment_DataType $benefit_Enrollment_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Worker_Benefit_Eligibility_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setBenefit_Eligibility_Data(\WorkdayWsdl\\StructType\Worker_Benefit_Eligibility_DataType $benefit_Eligibility_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Worker_Related_Persons_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setRelated_Person_Data(\WorkdayWsdl\\StructType\Worker_Related_Persons_DataType $related_Person_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Person_Qualification_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setQualification_Data(\WorkdayWsdl\\StructType\Person_Qualification_DataType $qualification_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Employee_Review_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setEmployee_Review_Data(\WorkdayWsdl\\StructType\Employee_Review_DataType $employee_Review_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setPhoto_Data(\WorkdayWsdl\\StructType\Employee_Image_DataType $photo_Data = null)
    {
    ...
    public static function validateIntegration_Field_Override_DataForArrayConstraintsFromSetIntegration_Field_Override_Data(array $values = array())
    {
        ...
        foreach ($values as $worker_DataTypeIntegration_Field_Override_DataItem) {
            ...
            if (!$worker_DataTypeIntegration_Field_Override_DataItem instanceof \WorkdayWsdl\\StructType\Document_Field_Result_DataType) {
     ...
     * @return \WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Entry_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setTransaction_Log_Entry_Data(\WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Entry_DataType $transaction_Log_Entry_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Rescind_And_Correct_DataType[]|null
     */
    ...
    public static function validateTransaction_Log_Corrected_And_Rescinded_DataForArrayConstraintsFromSetTransaction_Log_Corrected_And_Rescinded_Data(array $values = array())
    {
        ...
        foreach ($values as $worker_DataTypeTransaction_Log_Corrected_And_Rescinded_DataItem) {
            // validation for constraint: itemType
            if (!$worker_DataTypeTransaction_Log_Corrected_And_Rescinded_DataItem instanceof \WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Rescind_And_Correct_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Transaction_Log_Corrected_And_Rescinded_Data property can only contain items of type \WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Rescind_And_Correct_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Rescind_And_Correct_DataType $item
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function addToTransaction_Log_Corrected_And_Rescinded_Data(\WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Rescind_And_Correct_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Rescind_And_Correct_DataType) {
            throw new \InvalidArgumentException(sprintf('The Transaction_Log_Corrected_And_Rescinded_Data property can only contain items of type \WorkdayWsdl\\StructType\Event_Target_Transaction_Log_Rescind_And_Correct_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \WorkdayWsdl\\StructType\Succession_Profile_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setSuccession_Profile_Data(\WorkdayWsdl\\StructType\Succession_Profile_DataType $succession_Profile_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Talent_Assessment_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setTalent_Assessment_Data(\WorkdayWsdl\\StructType\Talent_Assessment_DataType $talent_Assessment_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Worker_Goal_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setWorker_Goal_Data(\WorkdayWsdl\\StructType\Worker_Goal_DataType $worker_Goal_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Worker_Development_Item_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setDevelopment_Item_Data(\WorkdayWsdl\\StructType\Worker_Development_Item_DataType $development_Item_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Worker_Skill_Item_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setSkill_Data(\WorkdayWsdl\\StructType\Worker_Skill_Item_DataType $skill_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Employee_Contracts_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setEmployee_Contracts_Data(\WorkdayWsdl\\StructType\Employee_Contracts_DataType $employee_Contracts_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Extended_Employee_Contracts_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setExtended_Employee_Contracts_Data(\WorkdayWsdl\\StructType\Extended_Employee_Contracts_DataType $extended_Employee_Contracts_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Feedback_Received_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setFeedback_Received_Data(\WorkdayWsdl\\StructType\Feedback_Received_DataType $feedback_Received_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\System_User_for_Worker_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setUser_Account_Data(\WorkdayWsdl\\StructType\System_User_for_Worker_DataType $user_Account_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Worker_Career_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setCareer_Data(\WorkdayWsdl\\StructType\Worker_Career_DataType $career_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Person_Account_Provisioning_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function setAccount_Provisioning_Data(\WorkdayWsdl\\StructType\Person_Account_Provisioning_DataType $account_Provisioning_Data = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Background_Check_Overall_Status_DataType[]|null
     */
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Background_Check_Overall_Status_DataType $item
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function addToBackground_Check_Data(\WorkdayWsdl\\StructType\Background_Check_Overall_Status_DataType $item)
    {
        // validation for constraint: itemType
     ...
     * @return \WorkdayWsdl\\StructType\Contingent_Worker_Tax_Authority_Form_Information_DataType[]|null
     */
    ...
    public static function validateContingent_Worker_Tax_Authority_Form_Type_DataForArrayConstraintsFromSetContingent_Worker_Tax_Authority_Form_Type_Data(array $values = array())
    {
        ...
        foreach ($values as $worker_DataTypeContingent_Worker_Tax_Authority_Form_Type_DataItem) {
            // validation for constraint: itemType
            if (!$worker_DataTypeContingent_Worker_Tax_Authority_Form_Type_DataItem instanceof \WorkdayWsdl\\StructType\Contingent_Worker_Tax_Authority_Form_Information_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Contingent_Worker_Tax_Authority_Form_Type_Data property can only contain items of type \WorkdayWsdl\\StructType\Contingent_Worker_Tax_Authority_Form_Information_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Contingent_Worker_Tax_Authority_Form_Information_DataType $item
     * @return \WorkdayWsdl\\StructType\Worker_DataType
     */
    public function addToContingent_Worker_Tax_Authority_Form_Type_Data(\WorkdayWsdl\\StructType\Contingent_Worker_Tax_Authority_Form_Information_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Contingent_Worker_Tax_Authority_Form_Information_DataType) {
            throw new \InvalidArgumentException(sprintf('The Contingent_Worker_Tax_Authority_Form_Type_Data property can only contain items of type \WorkdayWsdl\\StructType\Contingent_Worker_Tax_Authority_Form_Information_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
