...
/**
 * This class stands for Get_Gender_Identities_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: The request to get gender identity data for a worker.
 * @subpackage Structs
 */
class Get_Gender_Identities_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Gender_Identities_RequestType
     * @uses Get_Gender_Identities_RequestType::setRequest_References()
