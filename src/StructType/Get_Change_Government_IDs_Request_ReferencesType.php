...
/**
 * This class stands for Get_Change_Government_IDs_Request_ReferencesType
 * StructType
 ...
 * @subpackage Structs
 */
class Get_Change_Government_IDs_Request_ReferencesType extends AbstractStructBase
{
    /**
