...
/**
 * This class stands for Change_Other_IDs_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: This web service allows the updating of other identifiers for a worker.
 * @subpackage Structs
 */
class Change_Other_IDs_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Change_Other_IDs_RequestType
     * @uses Change_Other_IDs_RequestType::setBusiness_Process_Parameters()
     * @uses Change_Other_IDs_RequestType::setChange_Other_IDs_Data()
     * @uses Change_Other_IDs_RequestType::setVersion()
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\Business_Process_ParametersType $business_Process_Parameters = null, \WorkdayWsdl\\StructType\Change_Other_IDs_Business_Process_DataType $change_Other_IDs_Data = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Business_Process_ParametersType $business_Process_Parameters
     * @return \WorkdayWsdl\\StructType\Change_Other_IDs_RequestType
     */
     ...
     * @return \WorkdayWsdl\\StructType\Change_Other_IDs_RequestType
     */
    public function setChange_Other_IDs_Data(\WorkdayWsdl\\StructType\Change_Other_IDs_Business_Process_DataType $change_Other_IDs_Data = null)
    {
