...
class Change_Preferred_Name_Response_WrapperType extends AbstractStructBase
{
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\RoleObjectType $person_Reference = null, \WorkdayWsdl\\StructType\Change_Preferred_Name_Business_Process_DataType $change_Preferred_Name_Data = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\RoleObjectType $person_Reference
     * @return \WorkdayWsdl\\StructType\Change_Preferred_Name_Response_WrapperType
     */
