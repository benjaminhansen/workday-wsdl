...
/**
 * This class stands for Get_Former_Worker_Documents_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Response Element for Get Former Worker Document
 * @subpackage Structs
 */
class Get_Former_Worker_Documents_ResponseType extends AbstractStructBase
{
    /**
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Former_Worker_Attachment_Response_DataType
     */
    ...
    public $version;
    /**
     * Constructor method for Get_Former_Worker_Documents_ResponseType
     * @uses Get_Former_Worker_Documents_ResponseType::setRequest_References()
     * @uses Get_Former_Worker_Documents_ResponseType::setRequest_Criteria()
     * @uses Get_Former_Worker_Documents_ResponseType::setResponse_Filter()
     * @uses Get_Former_Worker_Documents_ResponseType::setResponse_Group()
     * @uses Get_Former_Worker_Documents_ResponseType::setResponse_Results()
     * @uses Get_Former_Worker_Documents_ResponseType::setResponse_Data()
     * @uses Get_Former_Worker_Documents_ResponseType::setVersion()
     * @param \WorkdayWsdl\\StructType\Former_Worker_Attachment_Request_ReferencesType $request_References
     * @param \WorkdayWsdl\\StructType\Former_Worker_Attachment_Request_Criteria__EL_Type $request_Criteria
     ...
     * @param \WorkdayWsdl\\StructType\Former_Worker_Attachment_Response_DataType $response_Data
     * @param string $version
     */
    public function __construct(\WorkdayWsdl\\StructType\Former_Worker_Attachment_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Former_Worker_Attachment_Request_Criteria__EL_Type $request_Criteria = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, \WorkdayWsdl\\StructType\Former_Worker_Attachment_Response_GroupType $response_Group = null, \WorkdayWsdl\\StructType\Response_ResultsType $response_Results = null, \WorkdayWsdl\\StructType\Former_Worker_Attachment_Response_DataType $response_Data = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Former_Worker_Attachment_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Former_Worker_Documents_ResponseType
     */
     ...
     * @return \WorkdayWsdl\\StructType\Get_Former_Worker_Documents_ResponseType
     */
    public function setRequest_Criteria(\WorkdayWsdl\\StructType\Former_Worker_Attachment_Request_Criteria__EL_Type $request_Criteria = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Former_Worker_Attachment_Response_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Get_Former_Worker_Documents_ResponseType
     */
    public function setResponse_Data(\WorkdayWsdl\\StructType\Former_Worker_Attachment_Response_DataType $response_Data = null)
    {
