...
class Employee_Compensation_Salary_Plan_Assignment_DataType extends AbstractStructBase
{
     ...
     */
    public function __construct($salary_Plan_Name = null, \StructType\Employee_Compensation_Salary_Plan_Assignment_Detail_DataType $compensation_Element_Values_for_Base_Pay_Data = null)
    {
        $this
     ...
     * @param string $salary_Plan_Name
     * @return \StructType\Employee_Compensation_Salary_Plan_Assignment_DataType
     */
