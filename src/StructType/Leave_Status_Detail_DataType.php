...
/**
 * This class stands for Leave_Status_Detail_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: Encapsulating element containg all Leave Status data.
 * @subpackage Structs
 */
class Leave_Status_Detail_DataType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Leave_Status_Detail_DataType
     * @uses Leave_Status_Detail_DataType::setLeave_Request_Event_Reference()
     * @uses Leave_Status_Detail_DataType::setLeave_Request_Description()
     * @uses Leave_Status_Detail_DataType::setLeave_Return_Event_Reference()
     * @uses Leave_Status_Detail_DataType::setOn_Leave()
     * @uses Leave_Status_Detail_DataType::setLeave_Start_Date()
     * @uses Leave_Status_Detail_DataType::setEstimated_Leave_End_Date()
     * @uses Leave_Status_Detail_DataType::setLeave_End_Date()
     * @uses Leave_Status_Detail_DataType::setFirst_Day_Of_Work()
     * @uses Leave_Status_Detail_DataType::setLeave_Last_Day_of_Work()
     * @uses Leave_Status_Detail_DataType::setLeave_of_Absence_Type_Reference()
     * @uses Leave_Status_Detail_DataType::setBenefits_Effect()
     * @uses Leave_Status_Detail_DataType::setPayroll_Effect()
     * @uses Leave_Status_Detail_DataType::setPaid_Time_Off_Accrual_Effect()
     * @uses Leave_Status_Detail_DataType::setContinuous_Service_Accrual_Effect()
