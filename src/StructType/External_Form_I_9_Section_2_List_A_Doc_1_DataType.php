...
/**
 * This class stands for External_Form_I-9_Section_2_List_A_Doc_1_DataType
 * StructType
 * Meta information extracted from the WSDL
 * - documentation: The request element containing all necessary information for Form I-9 Section 2 List A Doc 1 to assign to the worker.
 * @subpackage Structs
 */
class External_Form_I_9_Section_2_List_A_Doc_1_DataType extends AbstractStructBase
{
    /**
     * The Document_Title_Reference
     * Meta information extracted from the WSDL
     * - documentation: The Section 2 List A Doc 1 Document Title to assign to the Worker's Form I-9.
     * - minOccurs: 0
     ...
     * The Expiration_Date
     * Meta information extracted from the WSDL
     * - documentation: The Section 2 List A Doc 1 Expiration Date to assign to the Worker's Form I-9.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
    ...
    /**
     * Constructor method for External_Form_I-9_Section_2_List_A_Doc_1_DataType
     * @uses External_Form_I_9_Section_2_List_A_Doc_1_DataType::setDocument_Title_Reference()
     * @uses External_Form_I_9_Section_2_List_A_Doc_1_DataType::setDHS_Document_Title()
     * @uses External_Form_I_9_Section_2_List_A_Doc_1_DataType::setExpiration_Date()
     ...
     * @param \WorkdayWsdl\\StructType\Form_I_9_Identifier_Type__Workday_Owned_ObjectType $document_Title_Reference
     * @return \WorkdayWsdl\\StructType\External_Form_I_9_Section_2_List_A_Doc_1_DataType
     */
