...
/**
 * This class stands for Get_Organizations_Names_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains request reference, criteria, filter and response group for getting Organization Names
 * @subpackage Structs
 */
class Get_Organizations_Names_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Organizations_Names_RequestType
     * @uses Get_Organizations_Names_RequestType::setRequest_References()
     * @uses Get_Organizations_Names_RequestType::setRequest_Criteria()
     * @uses Get_Organizations_Names_RequestType::setResponse_Filter()
     * @uses Get_Organizations_Names_RequestType::setResponse_Group()
     * @uses Get_Organizations_Names_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Organization_Name_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Organizations_Names_RequestType
     */
