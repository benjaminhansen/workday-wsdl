...
/**
 * This class stands for Employee_Related_Persons_GetType StructType
 * Meta information extracted from the WSDL
 * - documentation: Utilize the following Reference element (and other optional attributes) to retrieve an instance of Employee, all of his/her Related Persons and personal information for each.
 * @subpackage Structs
 */
class Employee_Related_Persons_GetType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Employee_Related_Persons_GetType
     * @uses Employee_Related_Persons_GetType::setEmployee_Reference()
     * @uses Employee_Related_Persons_GetType::setAs_Of_Date()
     * @uses Employee_Related_Persons_GetType::setAs_Of_Moment()
     * @uses Employee_Related_Persons_GetType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Employee_ReferenceType $employee_Reference
     * @return \WorkdayWsdl\\StructType\Employee_Related_Persons_GetType
     */
