...
class Collective_Agreement_Factor_3_DataType extends AbstractStructBase
{
     ...
     * @param \StructType\Collective_Agreement_FactorObjectType $collective_Agreement_Factor_3_Reference
     * @param \StructType\Collective_Agreement_Factor_OptionObjectType $collective_Agreement_Factor_Option_3_Reference
     */
    public function __construct(\StructType\Collective_Agreement_FactorObjectType $collective_Agreement_Factor_3_Reference = null, \StructType\Collective_Agreement_Factor_OptionObjectType $collective_Agreement_Factor_Option_3_Reference = null)
    {
        $this
     ...
     * @return \StructType\Collective_Agreement_Factor_3_DataType
     */
    public function setCollective_Agreement_Factor_3_Reference(\StructType\Collective_Agreement_FactorObjectType $collective_Agreement_Factor_3_Reference = null)
    {
     ...
     * @return \StructType\Collective_Agreement_Factor_3_DataType
     */
    public function setCollective_Agreement_Factor_Option_3_Reference(\StructType\Collective_Agreement_Factor_OptionObjectType $collective_Agreement_Factor_Option_3_Reference = null)
    {
