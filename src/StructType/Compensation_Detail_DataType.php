...
class Compensation_Detail_DataType extends AbstractStructBase
{
     ...
     * @var \WorkdayWsdl\\StructType\Compensation_Package_ReferenceType
     */
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Compensation_Grade_Profile_ReferenceType
     */
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Compensation_Step_Reference_DataType
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Plan_Assignment_DataType[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Employee_Compensation_Hourly_Plan_Assignment_DataType[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Unit_Plan_Assignment_DataType[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Plan_Assignment_DataType[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Unit_Plan_Assignment_DataType[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Employee_Compensation_Bonus_Plan_Assignment_DataType[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Employee_Compensation_Merit_Plan_Assignment_DataType[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Employee_Compensation_Commission_Plan_Assignment_DataType[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Employee_Compensation_Period_Salary_Plan_Assignment_DataType[]
     */
     ...
     * @param \WorkdayWsdl\\StructType\Compensation_Package_ReferenceType $compensation_Package_Reference
     * @param \WorkdayWsdl\\StructType\Compensation_Grade_ReferenceType $compensation_Grade_Reference
     * @param \WorkdayWsdl\\StructType\Compensation_Grade_Profile_ReferenceType $compensation_Grade_Profile_Reference
     * @param \WorkdayWsdl\\StructType\Compensation_Step_Reference_DataType $compensation_Step_Reference
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Plan_Assignment_DataType[] $salary_Plan_for_Compensation_Data
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Hourly_Plan_Assignment_DataType[] $hourly_Plan_for_Compensation_Data
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Unit_Plan_Assignment_DataType[] $unit_Salary_Plan_for_Compensation_Data
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Plan_Assignment_DataType[] $allowance_Plan_for_Compensation_Data
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Unit_Plan_Assignment_DataType[] $unit_Allowance_Plan_for_Compensation_Data
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Bonus_Plan_Assignment_DataType[] $bonus_Plan_for_Compensation_Data
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Merit_Plan_Assignment_DataType[] $merit_Plan_for_Compensation_Data
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Commission_Plan_Assignment_DataType[] $commission_Plan_for_Compensation_Data
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Period_Salary_Plan_Assignment_DataType[] $period_Salary_Plan_for_Compensation_Data
     */
    public function __construct(\WorkdayWsdl\\StructType\Compensation_Package_ReferenceType $compensation_Package_Reference = null, \WorkdayWsdl\\StructType\Compensation_Grade_ReferenceType $compensation_Grade_Reference = null, \WorkdayWsdl\\StructType\Compensation_Grade_Profile_ReferenceType $compensation_Grade_Profile_Reference = null, \WorkdayWsdl\\StructType\Compensation_Step_Reference_DataType $compensation_Step_Reference = null, array $salary_Plan_for_Compensation_Data = array(), array $hourly_Plan_for_Compensation_Data = array(), array $unit_Salary_Plan_for_Compensation_Data = array(), array $allowance_Plan_for_Compensation_Data = array(), array $unit_Allowance_Plan_for_Compensation_Data = array(), array $bonus_Plan_for_Compensation_Data = array(), array $merit_Plan_for_Compensation_Data = array(), array $commission_Plan_for_Compensation_Data = array(), array $period_Salary_Plan_for_Compensation_Data = array())
    {
        $this
     ...
     * @return \WorkdayWsdl\\StructType\Compensation_Package_ReferenceType|null
     */
     ...
     * @param \WorkdayWsdl\\StructType\Compensation_Package_ReferenceType $compensation_Package_Reference
     * @return \WorkdayWsdl\\StructType\Compensation_Detail_DataType
     */
    public function setCompensation_Package_Reference(\WorkdayWsdl\\StructType\Compensation_Package_ReferenceType $compensation_Package_Reference = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Compensation_Grade_Profile_ReferenceType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Compensation_Detail_DataType
     */
    public function setCompensation_Grade_Profile_Reference(\WorkdayWsdl\\StructType\Compensation_Grade_Profile_ReferenceType $compensation_Grade_Profile_Reference = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Compensation_Step_Reference_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Compensation_Detail_DataType
     */
    public function setCompensation_Step_Reference(\WorkdayWsdl\\StructType\Compensation_Step_Reference_DataType $compensation_Step_Reference = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Plan_Assignment_DataType[]|null
     */
    ...
    public static function validateSalary_Plan_for_Compensation_DataForArrayConstraintsFromSetSalary_Plan_for_Compensation_Data(array $values = array())
    {
        ...
        foreach ($values as $compensation_Detail_DataTypeSalary_Plan_for_Compensation_DataItem) {
            ...
            if (!$compensation_Detail_DataTypeSalary_Plan_for_Compensation_DataItem instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Plan_Assignment_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Salary_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Plan_Assignment_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Plan_Assignment_DataType $item
     * @return \WorkdayWsdl\\StructType\Compensation_Detail_DataType
     */
    public function addToSalary_Plan_for_Compensation_Data(\WorkdayWsdl\\StructType\Employee_Compensation_Salary_Plan_Assignment_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Plan_Assignment_DataType) {
            throw new \InvalidArgumentException(sprintf('The Salary_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Plan_Assignment_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \WorkdayWsdl\\StructType\Employee_Compensation_Hourly_Plan_Assignment_DataType[]|null
     */
    ...
    public static function validateHourly_Plan_for_Compensation_DataForArrayConstraintsFromSetHourly_Plan_for_Compensation_Data(array $values = array())
    {
        ...
        foreach ($values as $compensation_Detail_DataTypeHourly_Plan_for_Compensation_DataItem) {
            // validation for constraint: itemType
            if (!$compensation_Detail_DataTypeHourly_Plan_for_Compensation_DataItem instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Hourly_Plan_Assignment_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Hourly_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Hourly_Plan_Assignment_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Hourly_Plan_Assignment_DataType $item
     * @return \WorkdayWsdl\\StructType\Compensation_Detail_DataType
     */
    public function addToHourly_Plan_for_Compensation_Data(\WorkdayWsdl\\StructType\Employee_Compensation_Hourly_Plan_Assignment_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Hourly_Plan_Assignment_DataType) {
            throw new \InvalidArgumentException(sprintf('The Hourly_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Hourly_Plan_Assignment_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Unit_Plan_Assignment_DataType[]|null
     */
    ...
    public static function validateUnit_Salary_Plan_for_Compensation_DataForArrayConstraintsFromSetUnit_Salary_Plan_for_Compensation_Data(array $values = array())
    {
        ...
        foreach ($values as $compensation_Detail_DataTypeUnit_Salary_Plan_for_Compensation_DataItem) {
            // validation for constraint: itemType
            if (!$compensation_Detail_DataTypeUnit_Salary_Plan_for_Compensation_DataItem instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Unit_Plan_Assignment_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Unit_Salary_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Unit_Plan_Assignment_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Unit_Plan_Assignment_DataType $item
     * @return \WorkdayWsdl\\StructType\Compensation_Detail_DataType
     */
    public function addToUnit_Salary_Plan_for_Compensation_Data(\WorkdayWsdl\\StructType\Employee_Compensation_Salary_Unit_Plan_Assignment_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Unit_Plan_Assignment_DataType) {
            throw new \InvalidArgumentException(sprintf('The Unit_Salary_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Unit_Plan_Assignment_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Plan_Assignment_DataType[]|null
     */
    ...
    public static function validateAllowance_Plan_for_Compensation_DataForArrayConstraintsFromSetAllowance_Plan_for_Compensation_Data(array $values = array())
    {
        ...
        foreach ($values as $compensation_Detail_DataTypeAllowance_Plan_for_Compensation_DataItem) {
            // validation for constraint: itemType
            if (!$compensation_Detail_DataTypeAllowance_Plan_for_Compensation_DataItem instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Plan_Assignment_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Allowance_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Plan_Assignment_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Plan_Assignment_DataType $item
     * @return \WorkdayWsdl\\StructType\Compensation_Detail_DataType
     */
    public function addToAllowance_Plan_for_Compensation_Data(\WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Plan_Assignment_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Plan_Assignment_DataType) {
            throw new \InvalidArgumentException(sprintf('The Allowance_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Plan_Assignment_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Unit_Plan_Assignment_DataType[]|null
     */
    ...
    public static function validateUnit_Allowance_Plan_for_Compensation_DataForArrayConstraintsFromSetUnit_Allowance_Plan_for_Compensation_Data(array $values = array())
    {
        ...
        foreach ($values as $compensation_Detail_DataTypeUnit_Allowance_Plan_for_Compensation_DataItem) {
            // validation for constraint: itemType
            if (!$compensation_Detail_DataTypeUnit_Allowance_Plan_for_Compensation_DataItem instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Unit_Plan_Assignment_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Unit_Allowance_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Unit_Plan_Assignment_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Unit_Plan_Assignment_DataType $item
     * @return \WorkdayWsdl\\StructType\Compensation_Detail_DataType
     */
    public function addToUnit_Allowance_Plan_for_Compensation_Data(\WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Unit_Plan_Assignment_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Unit_Plan_Assignment_DataType) {
            throw new \InvalidArgumentException(sprintf('The Unit_Allowance_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Allowance_Unit_Plan_Assignment_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \WorkdayWsdl\\StructType\Employee_Compensation_Bonus_Plan_Assignment_DataType[]|null
     */
    ...
    public static function validateBonus_Plan_for_Compensation_DataForArrayConstraintsFromSetBonus_Plan_for_Compensation_Data(array $values = array())
    {
        ...
        foreach ($values as $compensation_Detail_DataTypeBonus_Plan_for_Compensation_DataItem) {
            // validation for constraint: itemType
            if (!$compensation_Detail_DataTypeBonus_Plan_for_Compensation_DataItem instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Bonus_Plan_Assignment_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Bonus_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Bonus_Plan_Assignment_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Bonus_Plan_Assignment_DataType $item
     * @return \WorkdayWsdl\\StructType\Compensation_Detail_DataType
     */
    public function addToBonus_Plan_for_Compensation_Data(\WorkdayWsdl\\StructType\Employee_Compensation_Bonus_Plan_Assignment_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Bonus_Plan_Assignment_DataType) {
            throw new \InvalidArgumentException(sprintf('The Bonus_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Bonus_Plan_Assignment_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \WorkdayWsdl\\StructType\Employee_Compensation_Merit_Plan_Assignment_DataType[]|null
     */
    ...
    public static function validateMerit_Plan_for_Compensation_DataForArrayConstraintsFromSetMerit_Plan_for_Compensation_Data(array $values = array())
    {
        ...
        foreach ($values as $compensation_Detail_DataTypeMerit_Plan_for_Compensation_DataItem) {
            // validation for constraint: itemType
            if (!$compensation_Detail_DataTypeMerit_Plan_for_Compensation_DataItem instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Merit_Plan_Assignment_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Merit_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Merit_Plan_Assignment_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Merit_Plan_Assignment_DataType $item
     * @return \WorkdayWsdl\\StructType\Compensation_Detail_DataType
     */
    public function addToMerit_Plan_for_Compensation_Data(\WorkdayWsdl\\StructType\Employee_Compensation_Merit_Plan_Assignment_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Merit_Plan_Assignment_DataType) {
            throw new \InvalidArgumentException(sprintf('The Merit_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Merit_Plan_Assignment_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \WorkdayWsdl\\StructType\Employee_Compensation_Commission_Plan_Assignment_DataType[]|null
     */
    ...
    public static function validateCommission_Plan_for_Compensation_DataForArrayConstraintsFromSetCommission_Plan_for_Compensation_Data(array $values = array())
    {
        ...
        foreach ($values as $compensation_Detail_DataTypeCommission_Plan_for_Compensation_DataItem) {
            // validation for constraint: itemType
            if (!$compensation_Detail_DataTypeCommission_Plan_for_Compensation_DataItem instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Commission_Plan_Assignment_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Commission_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Commission_Plan_Assignment_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Commission_Plan_Assignment_DataType $item
     * @return \WorkdayWsdl\\StructType\Compensation_Detail_DataType
     */
    public function addToCommission_Plan_for_Compensation_Data(\WorkdayWsdl\\StructType\Employee_Compensation_Commission_Plan_Assignment_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Commission_Plan_Assignment_DataType) {
            throw new \InvalidArgumentException(sprintf('The Commission_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Commission_Plan_Assignment_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \WorkdayWsdl\\StructType\Employee_Compensation_Period_Salary_Plan_Assignment_DataType[]|null
     */
    ...
    public static function validatePeriod_Salary_Plan_for_Compensation_DataForArrayConstraintsFromSetPeriod_Salary_Plan_for_Compensation_Data(array $values = array())
    {
        ...
        foreach ($values as $compensation_Detail_DataTypePeriod_Salary_Plan_for_Compensation_DataItem) {
            // validation for constraint: itemType
            if (!$compensation_Detail_DataTypePeriod_Salary_Plan_for_Compensation_DataItem instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Period_Salary_Plan_Assignment_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Period_Salary_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Period_Salary_Plan_Assignment_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Employee_Compensation_Period_Salary_Plan_Assignment_DataType $item
     * @return \WorkdayWsdl\\StructType\Compensation_Detail_DataType
     */
    public function addToPeriod_Salary_Plan_for_Compensation_Data(\WorkdayWsdl\\StructType\Employee_Compensation_Period_Salary_Plan_Assignment_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Employee_Compensation_Period_Salary_Plan_Assignment_DataType) {
            throw new \InvalidArgumentException(sprintf('The Period_Salary_Plan_for_Compensation_Data property can only contain items of type \WorkdayWsdl\\StructType\Employee_Compensation_Period_Salary_Plan_Assignment_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
