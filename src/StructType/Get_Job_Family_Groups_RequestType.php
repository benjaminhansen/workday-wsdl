...
/**
 * This class stands for Get_Job_Family_Groups_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request element for Get Job Family Groups
 * @subpackage Structs
 */
class Get_Job_Family_Groups_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Job_Family_Groups_RequestType
     * @uses Get_Job_Family_Groups_RequestType::setRequest_References()
