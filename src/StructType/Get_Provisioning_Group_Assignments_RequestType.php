...
/**
 * This class stands for Get_Provisioning_Group_Assignments_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request element to retrieve assignments of persons and workers to provisioning groups.
 * @subpackage Structs
 */
class Get_Provisioning_Group_Assignments_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Provisioning_Group_Assignments_RequestType
     * @uses Get_Provisioning_Group_Assignments_RequestType::setRequest_References()
     * @uses Get_Provisioning_Group_Assignments_RequestType::setRequest_Criteria()
     * @uses Get_Provisioning_Group_Assignments_RequestType::setResponse_Filter()
     * @uses Get_Provisioning_Group_Assignments_RequestType::setResponse_Group()
     * @uses Get_Provisioning_Group_Assignments_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Provsioning_Group_Assignment_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Provisioning_Group_Assignments_RequestType
     */
