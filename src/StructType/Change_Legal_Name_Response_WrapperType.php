...
class Change_Legal_Name_Response_WrapperType extends AbstractStructBase
{
     ...
     */
    public function __construct(\StructType\RoleObjectType $person_Reference = null, \StructType\Change_Legal_Name_Business_Process_DataType $change_Legal_Name_Data = null)
    {
        $this
     ...
     * @param \StructType\RoleObjectType $person_Reference
     * @return \StructType\Change_Legal_Name_Response_WrapperType
     */
