...
/**
 * This class stands for Workday_Account_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Response Group
 * @subpackage Structs
 */
class Workday_Account_Response_GroupType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Workday_Account_Response_GroupType
     * @uses Workday_Account_Response_GroupType::setInclude_Reference()
