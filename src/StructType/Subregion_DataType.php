...
/**
 * This class stands for Subregion_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: Encapsulating element for all Subregion data.
 * @subpackage Structs
 */
class Subregion_DataType extends AbstractStructBase
{
    /**
     * The _
     * @var string
    ...
    public $Type;
    /**
     * Constructor method for Subregion_DataType
     * @uses Subregion_DataType::set_()
     * @uses Subregion_DataType::setDescriptor()
     * @uses Subregion_DataType::setType()
     * @param string $_
     ...
     * Set _ value
     * @param string $_
     * @return \WorkdayWsdl\\StructType\Subregion_DataType
     */
