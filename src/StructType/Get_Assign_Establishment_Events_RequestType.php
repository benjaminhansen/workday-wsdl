...
/**
 * This class stands for Get_Assign_Establishment_Events_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Get Assign Establishment Events Request
 * @subpackage Structs
 */
class Get_Assign_Establishment_Events_RequestType extends AbstractStructBase
{
    /**
     ...
     * Meta information extracted from the WSDL
     * - documentation: Assign Establishment Event Request Criteria
     * - choice: Request_References | Request_Criteria
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * - minOccurs: 0
     ...
     * The Response_Group
     * Meta information extracted from the WSDL
     * - documentation: Assign Establishment Event Response Group
     * - minOccurs: 0
    ...
    public $version;
    /**
     * Constructor method for Get_Assign_Establishment_Events_RequestType
     * @uses Get_Assign_Establishment_Events_RequestType::setRequest_References()
     * @uses Get_Assign_Establishment_Events_RequestType::setRequest_Criteria()
     * @uses Get_Assign_Establishment_Events_RequestType::setResponse_Filter()
     * @uses Get_Assign_Establishment_Events_RequestType::setResponse_Group()
     * @uses Get_Assign_Establishment_Events_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Assign_Establishment_Event_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Assign_Establishment_Events_RequestType
     */
