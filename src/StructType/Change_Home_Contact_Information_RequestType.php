...
/**
 * This class stands for Change_Home_Contact_Information_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Operation allowing the addition of contact information for a person
 * @subpackage Structs
 */
class Change_Home_Contact_Information_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Change_Home_Contact_Information_RequestType
     * @uses Change_Home_Contact_Information_RequestType::setBusiness_Process_Parameters()
     * @uses Change_Home_Contact_Information_RequestType::setChange_Home_Contact_Information_Data()
     * @uses Change_Home_Contact_Information_RequestType::setVersion()
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\Business_Process_ParametersType $business_Process_Parameters = null, \WorkdayWsdl\\StructType\Change_Home_Contact_Information_Business_Process_DataType $change_Home_Contact_Information_Data = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Business_Process_ParametersType $business_Process_Parameters
     * @return \WorkdayWsdl\\StructType\Change_Home_Contact_Information_RequestType
     */
