...
/**
 * This class stands for External_Form_I-9_Source_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: External Form I-9 Source Response Group
 * @subpackage Structs
 */
class External_Form_I_9_Source_Response_GroupType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for External_Form_I-9_Source_Response_GroupType
     * @uses External_Form_I_9_Source_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\External_Form_I_9_Source_Response_GroupType
     */
