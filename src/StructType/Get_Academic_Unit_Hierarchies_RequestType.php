...
/**
 * This class stands for Get_Academic_Unit_Hierarchies_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Top-level request element.
 * @subpackage Structs
 */
class Get_Academic_Unit_Hierarchies_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Academic_Unit_Hierarchies_RequestType
