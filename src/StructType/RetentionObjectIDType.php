...
/**
 * This class stands for RetentionObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class RetentionObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for RetentionObjectIDType
     * @uses RetentionObjectIDType::setType()
     * @uses RetentionObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
