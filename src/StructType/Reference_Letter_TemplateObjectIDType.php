...
/**
 * This class stands for Reference_Letter_TemplateObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Reference_Letter_TemplateObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Reference_Letter_TemplateObjectIDType
     * @uses Reference_Letter_TemplateObjectIDType::setType()
     * @uses Reference_Letter_TemplateObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
