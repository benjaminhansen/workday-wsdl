...
/**
 * This class stands for Additional_Benefits_Coverage_TargetObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Additional_Benefits_Coverage_TargetObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Additional_Benefits_Coverage_TargetObjectIDType
     * @uses Additional_Benefits_Coverage_TargetObjectIDType::setType()
     * @uses Additional_Benefits_Coverage_TargetObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
