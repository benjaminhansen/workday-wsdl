...
class Add extends AbstractSoapClientBase
{
     ...
     * @param \StructType\Organization_Add_UpdateType $body
     * @return \StructType\Organization_ReferenceRootType|bool
     */
    public function Add_Update_Organization(\StructType\Organization_Add_UpdateType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \StructType\Workday_Account_for_Worker_AddType $body
     * @return void|bool
     */
    public function Add_Workday_Account(\StructType\Workday_Account_for_Worker_AddType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \StructType\Add_Academic_Appointment_RequestType $body
     * @return \StructType\Academic_Appointment_ResponseType|bool
     */
    public function Add_Academic_Appointment(\StructType\Add_Academic_Appointment_RequestType $body)
    {
        try {
     ...
     * @return void|\StructType\Academic_Appointment_ResponseType|\StructType\Organization_ReferenceRootType
     */
