...
/**
 * This class stands for Committee_Meeting_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Response Group for committee meeting
 * @subpackage Structs
 */
class Committee_Meeting_Response_GroupType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Committee_Meeting_Response_GroupType
     * @uses Committee_Meeting_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\Committee_Meeting_Response_GroupType
     */
