...
class Military_Status_ReferenceType extends AbstractStructBase
{
     ...
     */
    public function __construct($military_Status_Name = null, \WorkdayWsdl\\StructType\Country_ReferenceType $country_Reference = null)
    {
        $this
     ...
     * @param string $military_Status_Name
     * @return \WorkdayWsdl\\StructType\Military_Status_ReferenceType
     */
