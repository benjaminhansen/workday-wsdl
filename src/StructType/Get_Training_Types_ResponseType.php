...
/**
 * This class stands for Get_Training_Types_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Response element for Get Training Types
 * @subpackage Structs
 */
class Get_Training_Types_ResponseType extends AbstractStructBase
{
    /**
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Training_Type_Response_DataType
     */
    ...
    public $version;
    /**
     * Constructor method for Get_Training_Types_ResponseType
     * @uses Get_Training_Types_ResponseType::setRequest_References()
     * @uses Get_Training_Types_ResponseType::setResponse_Filter()
     * @uses Get_Training_Types_ResponseType::setResponse_Results()
     * @uses Get_Training_Types_ResponseType::setResponse_Data()
     * @uses Get_Training_Types_ResponseType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Training_Type_Response_DataType $response_Data
     * @param string $version
     */
    public function __construct(\WorkdayWsdl\\StructType\Training_Type_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, \WorkdayWsdl\\StructType\Response_ResultsType $response_Results = null, \WorkdayWsdl\\StructType\Training_Type_Response_DataType $response_Data = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Training_Type_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Training_Types_ResponseType
     */
     ...
     * @return \WorkdayWsdl\\StructType\Training_Type_Response_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Get_Training_Types_ResponseType
     */
    public function setResponse_Data(\WorkdayWsdl\\StructType\Training_Type_Response_DataType $response_Data = null)
    {
