...
/**
 * This class stands for Location_ContextObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Location_ContextObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $parent_type;
    /**
     * Constructor method for Location_ContextObjectIDType
     * @uses Location_ContextObjectIDType::setType()
     * @uses Location_ContextObjectIDType::set_()
     * @uses Location_ContextObjectIDType::setParent_id()
     * @uses Location_ContextObjectIDType::setParent_type()
     * @param string $type
     * @param string $_
