...
/**
 * This class stands for Contribution_Amount_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains the contribution amount for the retirement savings election.
 * @subpackage Structs
 */
class Contribution_Amount_DataType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Contribution_Amount_DataType
     * @uses Contribution_Amount_DataType::setContribution_Amount()
     * @uses Contribution_Amount_DataType::setFrequency_Reference()
     ...
     * @param float $contribution_Amount
     * @return \WorkdayWsdl\\StructType\Contribution_Amount_DataType
     */
