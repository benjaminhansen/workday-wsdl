...
/**
 * This class stands for Get_Workers_Compensation_Codes_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Element containing Worker Compensation Codes response elements including received criteria, references, data based on criteria and grouping, results filter and result summary
 * @subpackage Structs
 */
class Get_Workers_Compensation_Codes_ResponseType extends AbstractStructBase
{
    /**
     ...
     * The Response_Data
     * Meta information extracted from the WSDL
     * - documentation: Wrapper Element that includes the Workers' Compensation Code Data
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Workers_Compensation_Code_Response_DataType
     */
    ...
    public $version;
    /**
     * Constructor method for Get_Workers_Compensation_Codes_ResponseType
     * @uses Get_Workers_Compensation_Codes_ResponseType::setRequest_References()
     * @uses Get_Workers_Compensation_Codes_ResponseType::setRequest_Criteria()
     * @uses Get_Workers_Compensation_Codes_ResponseType::setResponse_Filter()
     * @uses Get_Workers_Compensation_Codes_ResponseType::setResponse_Group()
     * @uses Get_Workers_Compensation_Codes_ResponseType::setResponse_Results()
     * @uses Get_Workers_Compensation_Codes_ResponseType::setResponse_Data()
     * @uses Get_Workers_Compensation_Codes_ResponseType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Workers_Compensation_Code_Response_DataType $response_Data
     * @param string $version
     */
    public function __construct(\WorkdayWsdl\\StructType\Workers_Compensation_Code_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Workers_Compensation_Code_Request_CriteriaType $request_Criteria = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, \WorkdayWsdl\\StructType\Workers_Compensation_Code_Response_GroupType $response_Group = null, \WorkdayWsdl\\StructType\Response_ResultsType $response_Results = null, \WorkdayWsdl\\StructType\Workers_Compensation_Code_Response_DataType $response_Data = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Workers_Compensation_Code_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Workers_Compensation_Codes_ResponseType
     */
     ...
     * @return \WorkdayWsdl\\StructType\Get_Workers_Compensation_Codes_ResponseType
     */
    public function setResponse_Group(\WorkdayWsdl\\StructType\Workers_Compensation_Code_Response_GroupType $response_Group = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Workers_Compensation_Code_Response_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Get_Workers_Compensation_Codes_ResponseType
     */
    public function setResponse_Data(\WorkdayWsdl\\StructType\Workers_Compensation_Code_Response_DataType $response_Data = null)
    {
