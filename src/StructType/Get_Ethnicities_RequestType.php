...
/**
 * This class stands for Get_Ethnicities_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request element for Get Ethnicities
 * @subpackage Structs
 */
class Get_Ethnicities_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Ethnicities_RequestType
     * @uses Get_Ethnicities_RequestType::setRequest_References()
     * @uses Get_Ethnicities_RequestType::setResponse_Filter()
     * @uses Get_Ethnicities_RequestType::setVersion()
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\Ethnicity_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Ethnicity_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Ethnicities_RequestType
     */
