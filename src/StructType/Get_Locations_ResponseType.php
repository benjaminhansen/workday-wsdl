...
/**
 * This class stands for Get_Locations_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Response element containing instances of locations and their associated data.
 * @subpackage Structs
 */
class Get_Locations_ResponseType extends AbstractStructBase
{
    /**
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \StructType\Location_Response_DataType
     */
    ...
    public $version;
    /**
     * Constructor method for Get_Locations_ResponseType
     * @uses Get_Locations_ResponseType::setRequest_References()
     * @uses Get_Locations_ResponseType::setRequest_Criteria()
     * @uses Get_Locations_ResponseType::setResponse_Filter()
     * @uses Get_Locations_ResponseType::setResponse_Group()
     * @uses Get_Locations_ResponseType::setResponse_Results()
     * @uses Get_Locations_ResponseType::setResponse_Data()
     * @uses Get_Locations_ResponseType::setVersion()
     ...
     * @param \StructType\Location_Response_DataType $response_Data
     * @param string $version
     */
    public function __construct(\StructType\Location_Request_ReferencesType $request_References = null, \StructType\Location_Request_CriteriaType $request_Criteria = null, \StructType\Response_FilterType $response_Filter = null, \StructType\Location_Response_GroupType $response_Group = null, \StructType\Response_ResultsType $response_Results = null, \StructType\Location_Response_DataType $response_Data = null, $version = null)
    {
        $this
     ...
     * @param \StructType\Location_Request_ReferencesType $request_References
     * @return \StructType\Get_Locations_ResponseType
     */
     ...
     * @return \StructType\Location_Response_DataType|null
     */
     ...
     * @return \StructType\Get_Locations_ResponseType
     */
    public function setResponse_Data(\StructType\Location_Response_DataType $response_Data = null)
    {
