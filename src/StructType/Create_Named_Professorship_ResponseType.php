...
/**
 * This class stands for Create_Named_Professorship_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Top-level response element for Create Named Professorship business process operations.
 * @subpackage Structs
 */
class Create_Named_Professorship_ResponseType extends AbstractStructBase
{
    /**
     * The Event_Reference
     * Meta information extracted from the WSDL
     * - documentation: Reference to the Create Named Professorship business process.
     * - minOccurs: 0
     ...
     * Meta information extracted from the WSDL
     * - documentation: Reference to the Named Professorship created by the Create Named Professorship business process.
     * - minOccurs: 0
    ...
    public $version;
    /**
     * Constructor method for Create_Named_Professorship_ResponseType
     * @uses Create_Named_Professorship_ResponseType::setEvent_Reference()
     * @uses Create_Named_Professorship_ResponseType::setGift_Reference()
     * @uses Create_Named_Professorship_ResponseType::setNamed_Professorship_Reference()
     * @uses Create_Named_Professorship_ResponseType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Unique_IdentifierObjectType $event_Reference
     * @return \WorkdayWsdl\\StructType\Create_Named_Professorship_ResponseType
     */
