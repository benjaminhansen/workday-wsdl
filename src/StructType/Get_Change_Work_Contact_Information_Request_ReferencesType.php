...
class Get_Change_Work_Contact_Information_Request_ReferencesType extends AbstractStructBase
{
    ...
    public static function validatePerson_ReferenceForArrayConstraintsFromSetPerson_Reference(array $values = array())
    {
        ...
        foreach ($values as $get_Change_Work_Contact_Information_Request_ReferencesTypePerson_ReferenceItem) {
            ...
            if (!$get_Change_Work_Contact_Information_Request_ReferencesTypePerson_ReferenceItem instanceof \StructType\RoleObjectType) {
     ...
     * @param \StructType\RoleObjectType[] $person_Reference
     * @return \StructType\Get_Change_Work_Contact_Information_Request_ReferencesType
     */
    ...
    public static function validateUniversal_ID_ReferenceForArrayConstraintsFromSetUniversal_ID_Reference(array $values = array())
    {
        ...
        foreach ($values as $get_Change_Work_Contact_Information_Request_ReferencesTypeUniversal_ID_ReferenceItem) {
            // validation for constraint: itemType
            if (!$get_Change_Work_Contact_Information_Request_ReferencesTypeUniversal_ID_ReferenceItem instanceof \StructType\Universal_IdentifierObjectType) {
