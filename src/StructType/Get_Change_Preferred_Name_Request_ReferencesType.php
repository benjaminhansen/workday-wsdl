...
/**
 * This class stands for Get_Change_Preferred_Name_Request_ReferencesType
 * StructType
 ...
 * @subpackage Structs
 */
class Get_Change_Preferred_Name_Request_ReferencesType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Get_Change_Preferred_Name_Request_ReferencesType
     * @uses Get_Change_Preferred_Name_Request_ReferencesType::setPerson_Reference()
     * @uses Get_Change_Preferred_Name_Request_ReferencesType::setUniversal_ID_Reference()
    ...
    public static function validatePerson_ReferenceForArrayConstraintsFromSetPerson_Reference(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $get_Change_Preferred_Name_Request_ReferencesTypePerson_ReferenceItem) {
            // validation for constraint: itemType
            if (!$get_Change_Preferred_Name_Request_ReferencesTypePerson_ReferenceItem instanceof \WorkdayWsdl\\StructType\RoleObjectType) {
                $invalidValues[] = is_object($get_Change_Preferred_Name_Request_ReferencesTypePerson_ReferenceItem) ? get_class($get_Change_Preferred_Name_Request_ReferencesTypePerson_ReferenceItem) : sprintf('%s(%s)', gettype($get_Change_Preferred_Name_Request_ReferencesTypePerson_ReferenceItem), var_export($get_Change_Preferred_Name_Request_ReferencesTypePerson_ReferenceItem, true));
            }
        }
     ...
     * @param \WorkdayWsdl\\StructType\RoleObjectType[] $person_Reference
     * @return \WorkdayWsdl\\StructType\Get_Change_Preferred_Name_Request_ReferencesType
     */
    ...
    public static function validateUniversal_ID_ReferenceForArrayConstraintsFromSetUniversal_ID_Reference(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $get_Change_Preferred_Name_Request_ReferencesTypeUniversal_ID_ReferenceItem) {
            // validation for constraint: itemType
            if (!$get_Change_Preferred_Name_Request_ReferencesTypeUniversal_ID_ReferenceItem instanceof \WorkdayWsdl\\StructType\Universal_IdentifierObjectType) {
                $invalidValues[] = is_object($get_Change_Preferred_Name_Request_ReferencesTypeUniversal_ID_ReferenceItem) ? get_class($get_Change_Preferred_Name_Request_ReferencesTypeUniversal_ID_ReferenceItem) : sprintf('%s(%s)', gettype($get_Change_Preferred_Name_Request_ReferencesTypeUniversal_ID_ReferenceItem), var_export($get_Change_Preferred_Name_Request_ReferencesTypeUniversal_ID_ReferenceItem, true));
            }
        }
        if (!empty($invalidValues)) {
