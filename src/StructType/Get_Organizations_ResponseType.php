...
/**
 * This class stands for Get_Organizations_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains each Organization based on the Request References or Request Criteria. The data returned is the current information as of the dates in the response filter, and does not include all historical information about the
 * Organization.
 * @subpackage Structs
 */
class Get_Organizations_ResponseType extends AbstractStructBase
{
    /**
     * The Request_References
     * Meta information extracted from the WSDL
     * - documentation: Utilize the Request References element to retrieve a specific instance(s) of Organization and its associated data.
     * - minOccurs: 0
     ...
     * Meta information extracted from the WSDL
     * - documentation: Utilize the Request Criteria element to search the transaction log for specific instance(s) of a Organization based upon an Event type within a date range.
     * - minOccurs: 0
     ...
     * The Response_Group
     * Meta information extracted from the WSDL
     * - documentation: This response group allows for the response data to be tailored to only include elements that the user is looking for. If no response group is provided in the request, only the following elements will be included: Reference,
     * Hierarchy Data, and if a Supervisory Organization, the Supervisory Organization Data.
     * - minOccurs: 0
     ...
     * Organization.
     * - minOccurs: 0
     * @var \StructType\Organization_Response_DataType
     */
    ...
    public $version;
    /**
     * Constructor method for Get_Organizations_ResponseType
     * @uses Get_Organizations_ResponseType::setRequest_References()
     * @uses Get_Organizations_ResponseType::setRequest_Criteria()
     * @uses Get_Organizations_ResponseType::setResponse_Filter()
     * @uses Get_Organizations_ResponseType::setResponse_Group()
     * @uses Get_Organizations_ResponseType::setResponse_Results()
     * @uses Get_Organizations_ResponseType::setResponse_Data()
     * @uses Get_Organizations_ResponseType::setVersion()
     ...
     * @param \StructType\Organization_Response_DataType $response_Data
     * @param string $version
     */
    public function __construct(\StructType\Organization_Request_ReferencesType $request_References = null, \StructType\Organization_Request_CriteriaType $request_Criteria = null, \StructType\Response_FilterType $response_Filter = null, \StructType\Organization_Response_GroupType $response_Group = null, \StructType\Response_ResultsType $response_Results = null, \StructType\Organization_Response_DataType $response_Data = null, $version = null)
    {
        $this
     ...
     * @param \StructType\Organization_Request_ReferencesType $request_References
     * @return \StructType\Get_Organizations_ResponseType
     */
     ...
     * @return \StructType\Organization_Response_DataType|null
     */
     ...
     * @return \StructType\Get_Organizations_ResponseType
     */
    public function setResponse_Data(\StructType\Organization_Response_DataType $response_Data = null)
    {
