...
class EducationType extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Education_SkillObjectType
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Education_Achievement_DataType[]
     */
     ...
     * @param \WorkdayWsdl\\StructType\Education_SkillObjectType $education_Reference
     * @param \WorkdayWsdl\\StructType\Education_Achievement_DataType[] $education_Data
     */
    public function __construct(\WorkdayWsdl\\StructType\Education_SkillObjectType $education_Reference = null, array $education_Data = array())
    {
        $this
     ...
     * @return \WorkdayWsdl\\StructType\Education_SkillObjectType|null
     */
     ...
     * @param \WorkdayWsdl\\StructType\Education_SkillObjectType $education_Reference
     * @return \WorkdayWsdl\\StructType\EducationType
     */
    public function setEducation_Reference(\WorkdayWsdl\\StructType\Education_SkillObjectType $education_Reference = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Education_Achievement_DataType[]|null
     */
    ...
    public static function validateEducation_DataForArrayConstraintsFromSetEducation_Data(array $values = array())
    {
        ...
        foreach ($values as $educationTypeEducation_DataItem) {
            ...
            if (!$educationTypeEducation_DataItem instanceof \WorkdayWsdl\\StructType\Education_Achievement_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Education_Data property can only contain items of type \WorkdayWsdl\\StructType\Education_Achievement_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Education_Achievement_DataType $item
     * @return \WorkdayWsdl\\StructType\EducationType
     */
    public function addToEducation_Data(\WorkdayWsdl\\StructType\Education_Achievement_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Education_Achievement_DataType) {
            throw new \InvalidArgumentException(sprintf('The Education_Data property can only contain items of type \WorkdayWsdl\\StructType\Education_Achievement_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
