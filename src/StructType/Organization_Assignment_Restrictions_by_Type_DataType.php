...
class Organization_Assignment_Restrictions_by_Type_DataType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Staff_Allowed_DataType[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Staff_Default_DataType[]
     */
     ...
     * @param \WorkdayWsdl\\StructType\Staff_Allowed_DataType[] $allowed_Organization_Data
     * @param \WorkdayWsdl\\StructType\Staff_Default_DataType[] $default_Organization_Data
     */
    public function __construct(\WorkdayWsdl\\StructType\Organization_TypeObjectType $organization_Type_Reference = null, array $allowed_Organization_Data = array(), array $default_Organization_Data = array())
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Organization_TypeObjectType $organization_Type_Reference
     * @return \WorkdayWsdl\\StructType\Organization_Assignment_Restrictions_by_Type_DataType
     */
     ...
     * @return \WorkdayWsdl\\StructType\Staff_Allowed_DataType[]|null
     */
    ...
    public static function validateAllowed_Organization_DataForArrayConstraintsFromSetAllowed_Organization_Data(array $values = array())
    {
        ...
        foreach ($values as $organization_Assignment_Restrictions_by_Type_DataTypeAllowed_Organization_DataItem) {
            ...
            if (!$organization_Assignment_Restrictions_by_Type_DataTypeAllowed_Organization_DataItem instanceof \WorkdayWsdl\\StructType\Staff_Allowed_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Allowed_Organization_Data property can only contain items of type \WorkdayWsdl\\StructType\Staff_Allowed_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Staff_Allowed_DataType $item
     * @return \WorkdayWsdl\\StructType\Organization_Assignment_Restrictions_by_Type_DataType
     */
    public function addToAllowed_Organization_Data(\WorkdayWsdl\\StructType\Staff_Allowed_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Staff_Allowed_DataType) {
            throw new \InvalidArgumentException(sprintf('The Allowed_Organization_Data property can only contain items of type \WorkdayWsdl\\StructType\Staff_Allowed_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \WorkdayWsdl\\StructType\Staff_Default_DataType[]|null
     */
    ...
    public static function validateDefault_Organization_DataForArrayConstraintsFromSetDefault_Organization_Data(array $values = array())
    {
        ...
        foreach ($values as $organization_Assignment_Restrictions_by_Type_DataTypeDefault_Organization_DataItem) {
            // validation for constraint: itemType
            if (!$organization_Assignment_Restrictions_by_Type_DataTypeDefault_Organization_DataItem instanceof \WorkdayWsdl\\StructType\Staff_Default_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Default_Organization_Data property can only contain items of type \WorkdayWsdl\\StructType\Staff_Default_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Staff_Default_DataType $item
     * @return \WorkdayWsdl\\StructType\Organization_Assignment_Restrictions_by_Type_DataType
     */
    public function addToDefault_Organization_Data(\WorkdayWsdl\\StructType\Staff_Default_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Staff_Default_DataType) {
            throw new \InvalidArgumentException(sprintf('The Default_Organization_Data property can only contain items of type \WorkdayWsdl\\StructType\Staff_Default_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
