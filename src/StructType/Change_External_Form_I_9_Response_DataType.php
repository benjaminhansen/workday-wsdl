...
class Change_External_Form_I_9_Response_DataType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \StructType\Change_External_Form_I_9Type[]
     */
     ...
     * @param \StructType\Change_External_Form_I_9Type[] $external_Form_I_9
     */
    ...
    public static function validateExternal_Form_I_9ForArrayConstraintsFromSetExternal_Form_I_9(array $values = array())
    {
        ...
        foreach ($values as $change_External_Form_I_9_Response_DataTypeExternal_Form_I_9Item) {
            ...
            if (!$change_External_Form_I_9_Response_DataTypeExternal_Form_I_9Item instanceof \StructType\Change_External_Form_I_9Type) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The External_Form_I_9 property can only contain items of type \StructType\Change_External_Form_I_9Type, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @return \StructType\Change_External_Form_I_9_Response_DataType
     */
     ...
     * @param \StructType\Change_External_Form_I_9Type $item
     * @return \StructType\Change_External_Form_I_9_Response_DataType
     */
    public function addToExternal_Form_I_9(\StructType\Change_External_Form_I_9Type $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \StructType\Change_External_Form_I_9Type) {
            throw new \InvalidArgumentException(sprintf('The External_Form_I_9 property can only contain items of type \StructType\Change_External_Form_I_9Type, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
