...
/**
 * This class stands for Get_Committee_Meetings_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request to Get Committee Meetings
 * @subpackage Structs
 */
class Get_Committee_Meetings_RequestType extends AbstractStructBase
{
    /**
     * The Request_References
     * Meta information extracted from the WSDL
     * - documentation: References for Committee Meeting
     ...
     * Meta information extracted from the WSDL
     * - documentation: Request Criteria for Committee meeting
     * - choice: Request_References | Request_Criteria
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * - minOccurs: 0
    ...
    public $version;
    /**
     * Constructor method for Get_Committee_Meetings_RequestType
     * @uses Get_Committee_Meetings_RequestType::setRequest_References()
     * @uses Get_Committee_Meetings_RequestType::setRequest_Criteria()
