...
/**
 * This class stands for Get_Training_Types_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request element for Get Training Types
 * @subpackage Structs
 */
class Get_Training_Types_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Training_Types_RequestType
