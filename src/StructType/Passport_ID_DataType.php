...
/**
 * This class stands for Passport_ID_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: Wrapper for Passport Identifier data.
 * @subpackage Structs
 */
class Passport_ID_DataType extends AbstractStructBase
{
    /**
     * The ID
     * Meta information extracted from the WSDL
     * - documentation: Passport Identifier.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
     ...
     * Meta information extracted from the WSDL
     * - documentation: Passport Identifier Type.
     * - minOccurs: 0
     * @var \StructType\Passport_ID_Type__All_ObjectType
     */
    public $ID_Type_Reference;
    /**
     * The Country_Reference
     * Meta information extracted from the WSDL
     * - documentation: Country issuing the Passport Identifier.
     * - minOccurs: 0
     ...
     * The Issued_Date
     * Meta information extracted from the WSDL
     * - documentation: Date the Passport Identifier was issued.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
     ...
     * The Expiration_Date
     * Meta information extracted from the WSDL
     * - documentation: Expiration Date of the Passport Identifier.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
     ...
     * Meta information extracted from the WSDL
     * - documentation: Verification Date of the Passport Identifier.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
    ...
    /**
     * Constructor method for Passport_ID_DataType
     * @uses Passport_ID_DataType::setID()
     * @uses Passport_ID_DataType::setID_Type_Reference()
     * @uses Passport_ID_DataType::setCountry_Reference()
     * @uses Passport_ID_DataType::setIssued_Date()
     * @uses Passport_ID_DataType::setExpiration_Date()
     * @uses Passport_ID_DataType::setVerification_Date()
     * @uses Passport_ID_DataType::setVerified_By_Reference()
     * @param string $iD
     * @param \StructType\Passport_ID_Type__All_ObjectType $iD_Type_Reference
     ...
     */
    public function __construct($iD = null, \StructType\Passport_ID_Type__All_ObjectType $iD_Type_Reference = null, \StructType\CountryObjectType $country_Reference = null, $issued_Date = null, $expiration_Date = null, $verification_Date = null, \StructType\WorkerObjectType $verified_By_Reference = null)
    {
        $this
            ->setID($iD)
     ...
     * Set ID value
     * @param string $iD
     * @return \StructType\Passport_ID_DataType
     */
     ...
     * @return \StructType\Passport_ID_Type__All_ObjectType|null
     */
     ...
     * @return \StructType\Passport_ID_DataType
     */
    public function setID_Type_Reference(\StructType\Passport_ID_Type__All_ObjectType $iD_Type_Reference = null)
    {
