...
class Put_Organization_Name_RequestType extends AbstractStructBase
{
     ...
     */
    public function __construct(\StructType\OrganizationObjectType $organization_Reference = null, array $organization_Name_Data = array(), $version = null)
    {
        $this
     ...
     * @param \StructType\OrganizationObjectType $organization_Reference
     * @return \StructType\Put_Organization_Name_RequestType
     */
    ...
    public static function validateOrganization_Name_DataForArrayConstraintsFromSetOrganization_Name_Data(array $values = array())
    {
        ...
        foreach ($values as $put_Organization_Name_RequestTypeOrganization_Name_DataItem) {
            ...
            if (!$put_Organization_Name_RequestTypeOrganization_Name_DataItem instanceof \StructType\Organization_Name_DataType) {
