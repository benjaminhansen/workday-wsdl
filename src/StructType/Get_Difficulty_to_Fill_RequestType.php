...
/**
 * This class stands for Get_Difficulty_to_Fill_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: The request component of the Get Difficulty to Fill web service task.
 * @subpackage Structs
 */
class Get_Difficulty_to_Fill_RequestType extends AbstractStructBase
{
    /**
     * The Request_References
     * Meta information extracted from the WSDL
     * - documentation: Contains the references to difficulty to fill
    ...
    public $version;
    /**
     * Constructor method for Get_Difficulty_to_Fill_RequestType
