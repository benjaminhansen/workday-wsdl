...
/**
 * This class stands for Get_Committee_Membership_Types_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Get Committee Membership Types Request
 * @subpackage Structs
 */
class Get_Committee_Membership_Types_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Committee_Membership_Types_RequestType
     * @uses Get_Committee_Membership_Types_RequestType::setRequest_References()
     * @uses Get_Committee_Membership_Types_RequestType::setRequest_Criteria()
     * @uses Get_Committee_Membership_Types_RequestType::setResponse_Filter()
     * @uses Get_Committee_Membership_Types_RequestType::setResponse_Group()
     * @uses Get_Committee_Membership_Types_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Committee_Membership_Type_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Committee_Membership_Types_RequestType
     */
