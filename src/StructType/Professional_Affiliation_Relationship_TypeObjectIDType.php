...
/**
 * This class stands for Professional_Affiliation_Relationship_TypeObjectIDType
 * StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Professional_Affiliation_Relationship_TypeObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Professional_Affiliation_Relationship_TypeObjectIDType
     * @uses Professional_Affiliation_Relationship_TypeObjectIDType::setType()
     * @uses Professional_Affiliation_Relationship_TypeObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
