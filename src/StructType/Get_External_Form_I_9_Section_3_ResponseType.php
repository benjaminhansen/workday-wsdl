...
/**
 * This class stands for Get_External_Form_I-9_Section_3_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: The response element that contains all necessary information when getting an External Form I-9 Section 3.
 * @subpackage Structs
 */
class Get_External_Form_I_9_Section_3_ResponseType extends AbstractStructBase
{
    /**
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Change_External_Form_I_9_Section_3_Response_DataType[]
     */
    ...
    public $version;
    /**
     * Constructor method for Get_External_Form_I-9_Section_3_ResponseType
     * @uses Get_External_Form_I_9_Section_3_ResponseType::setRequest_References()
     * @uses Get_External_Form_I_9_Section_3_ResponseType::setResponse_Filter()
     * @uses Get_External_Form_I_9_Section_3_ResponseType::setResponse_Results()
     * @uses Get_External_Form_I_9_Section_3_ResponseType::setResponse_Data()
     * @uses Get_External_Form_I_9_Section_3_ResponseType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Change_External_Form_I_9_Section_3_Response_DataType[] $response_Data
    ...
    public static function validateRequest_ReferencesForArrayConstraintsFromSetRequest_References(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $get_External_Form_I_9_Section_3_ResponseTypeRequest_ReferencesItem) {
            // validation for constraint: itemType
            if (!$get_External_Form_I_9_Section_3_ResponseTypeRequest_ReferencesItem instanceof \WorkdayWsdl\\StructType\Get_Change_External_Form_I_9_Section_3_Request_ReferencesType) {
                $invalidValues[] = is_object($get_External_Form_I_9_Section_3_ResponseTypeRequest_ReferencesItem) ? get_class($get_External_Form_I_9_Section_3_ResponseTypeRequest_ReferencesItem) : sprintf('%s(%s)', gettype($get_External_Form_I_9_Section_3_ResponseTypeRequest_ReferencesItem), var_export($get_External_Form_I_9_Section_3_ResponseTypeRequest_ReferencesItem, true));
            }
        }
        if (!empty($invalidValues)) {
            $message = sprintf('The Request_References property can only contain items of type \WorkdayWsdl\\StructType\Get_Change_External_Form_I_9_Section_3_Request_ReferencesType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @param \WorkdayWsdl\\StructType\Get_Change_External_Form_I_9_Section_3_Request_ReferencesType[] $request_References
     * @return \WorkdayWsdl\\StructType\Get_External_Form_I_9_Section_3_ResponseType
     */
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Get_Change_External_Form_I_9_Section_3_Request_ReferencesType $item
     * @return \WorkdayWsdl\\StructType\Get_External_Form_I_9_Section_3_ResponseType
     */
    public function addToRequest_References(\WorkdayWsdl\\StructType\Get_Change_External_Form_I_9_Section_3_Request_ReferencesType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Get_Change_External_Form_I_9_Section_3_Request_ReferencesType) {
            throw new \InvalidArgumentException(sprintf('The Request_References property can only contain items of type \WorkdayWsdl\\StructType\Get_Change_External_Form_I_9_Section_3_Request_ReferencesType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateResponse_FilterForArrayConstraintsFromSetResponse_Filter(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $get_External_Form_I_9_Section_3_ResponseTypeResponse_FilterItem) {
            // validation for constraint: itemType
            if (!$get_External_Form_I_9_Section_3_ResponseTypeResponse_FilterItem instanceof \WorkdayWsdl\\StructType\Response_FilterType) {
                $invalidValues[] = is_object($get_External_Form_I_9_Section_3_ResponseTypeResponse_FilterItem) ? get_class($get_External_Form_I_9_Section_3_ResponseTypeResponse_FilterItem) : sprintf('%s(%s)', gettype($get_External_Form_I_9_Section_3_ResponseTypeResponse_FilterItem), var_export($get_External_Form_I_9_Section_3_ResponseTypeResponse_FilterItem, true));
            }
        }
        if (!empty($invalidValues)) {
    ...
    public static function validateResponse_ResultsForArrayConstraintsFromSetResponse_Results(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $get_External_Form_I_9_Section_3_ResponseTypeResponse_ResultsItem) {
            // validation for constraint: itemType
            if (!$get_External_Form_I_9_Section_3_ResponseTypeResponse_ResultsItem instanceof \WorkdayWsdl\\StructType\Response_ResultsType) {
                $invalidValues[] = is_object($get_External_Form_I_9_Section_3_ResponseTypeResponse_ResultsItem) ? get_class($get_External_Form_I_9_Section_3_ResponseTypeResponse_ResultsItem) : sprintf('%s(%s)', gettype($get_External_Form_I_9_Section_3_ResponseTypeResponse_ResultsItem), var_export($get_External_Form_I_9_Section_3_ResponseTypeResponse_ResultsItem, true));
            }
        }
        if (!empty($invalidValues)) {
     ...
     * @return \WorkdayWsdl\\StructType\Change_External_Form_I_9_Section_3_Response_DataType[]|null
     */
    ...
    public static function validateResponse_DataForArrayConstraintsFromSetResponse_Data(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $get_External_Form_I_9_Section_3_ResponseTypeResponse_DataItem) {
            // validation for constraint: itemType
            if (!$get_External_Form_I_9_Section_3_ResponseTypeResponse_DataItem instanceof \WorkdayWsdl\\StructType\Change_External_Form_I_9_Section_3_Response_DataType) {
                $invalidValues[] = is_object($get_External_Form_I_9_Section_3_ResponseTypeResponse_DataItem) ? get_class($get_External_Form_I_9_Section_3_ResponseTypeResponse_DataItem) : sprintf('%s(%s)', gettype($get_External_Form_I_9_Section_3_ResponseTypeResponse_DataItem), var_export($get_External_Form_I_9_Section_3_ResponseTypeResponse_DataItem, true));
            }
        }
        if (!empty($invalidValues)) {
            $message = sprintf('The Response_Data property can only contain items of type \WorkdayWsdl\\StructType\Change_External_Form_I_9_Section_3_Response_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Change_External_Form_I_9_Section_3_Response_DataType $item
     * @return \WorkdayWsdl\\StructType\Get_External_Form_I_9_Section_3_ResponseType
     */
    public function addToResponse_Data(\WorkdayWsdl\\StructType\Change_External_Form_I_9_Section_3_Response_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Change_External_Form_I_9_Section_3_Response_DataType) {
            throw new \InvalidArgumentException(sprintf('The Response_Data property can only contain items of type \WorkdayWsdl\\StructType\Change_External_Form_I_9_Section_3_Response_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
