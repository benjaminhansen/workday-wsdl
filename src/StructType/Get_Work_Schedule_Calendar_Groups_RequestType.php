...
/**
 * This class stands for Get_Work_Schedule_Calendar_Groups_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request to get Work Schedule Calendar Group.
 * @subpackage Structs
 */
class Get_Work_Schedule_Calendar_Groups_RequestType extends AbstractStructBase
{
    /**
     ...
     * Meta information extracted from the WSDL
     * - documentation: Request criteria for Work Schedule Calendar Group response.
     * - choice: Request_References | Request_Criteria
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * - minOccurs: 0
    ...
    public $version;
    /**
     * Constructor method for Get_Work_Schedule_Calendar_Groups_RequestType
     * @uses Get_Work_Schedule_Calendar_Groups_RequestType::setRequest_References()
     * @uses Get_Work_Schedule_Calendar_Groups_RequestType::setRequest_Criteria()
     * @uses Get_Work_Schedule_Calendar_Groups_RequestType::setResponse_Filter()
     * @uses Get_Work_Schedule_Calendar_Groups_RequestType::setResponse_Group()
     * @uses Get_Work_Schedule_Calendar_Groups_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Work_Schedule_Calendar_Group_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Work_Schedule_Calendar_Groups_RequestType
     */
