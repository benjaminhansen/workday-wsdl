...
class Employee_Compensation_Hourly_Plan_Assignment_DataType extends AbstractStructBase
{
     ...
     */
    public function __construct($hourly_Plan_Name = null, \WorkdayWsdl\\StructType\Employee_Compensation_Salary_Plan_Assignment_Detail_DataType $compensation_Element_Values_for_Base_Pay_Data = null)
    {
        $this
     ...
     * @param string $hourly_Plan_Name
     * @return \WorkdayWsdl\\StructType\Employee_Compensation_Hourly_Plan_Assignment_DataType
     */
