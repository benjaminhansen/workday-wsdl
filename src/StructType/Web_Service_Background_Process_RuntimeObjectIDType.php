...
/**
 * This class stands for Web_Service_Background_Process_RuntimeObjectIDType
 * StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Web_Service_Background_Process_RuntimeObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Web_Service_Background_Process_RuntimeObjectIDType
     * @uses Web_Service_Background_Process_RuntimeObjectIDType::setType()
     * @uses Web_Service_Background_Process_RuntimeObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
