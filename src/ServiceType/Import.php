...
class Import extends AbstractSoapClientBase
{
     ...
     * @param \WorkdayWsdl\\StructType\Import_Universal_Identifier_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Import_Process_ResponseType|bool
     */
    public function Import_Universal_Identifiers(\WorkdayWsdl\\StructType\Import_Universal_Identifier_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Import_Change_Work_Contact_Information_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Import_Process_ResponseType|bool
     */
    public function Import_Change_Work_Contact_Information(\WorkdayWsdl\\StructType\Import_Change_Work_Contact_Information_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Import_Person_Photo_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Import_Process_ResponseType|bool
     */
    public function Import_Person_Photos(\WorkdayWsdl\\StructType\Import_Person_Photo_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\Import_Change_Home_Contact_Information_RequestType $body
     * @return \WorkdayWsdl\\StructType\Put_Import_Process_ResponseType|bool
     */
    public function Import_Change_Home_Contact_Information(\WorkdayWsdl\\StructType\Import_Change_Home_Contact_Information_RequestType $body)
    {
        try {
