...
/**
 * This class stands for Unit_of_MeasureObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Unit_of_MeasureObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Unit_of_MeasureObjectIDType
     * @uses Unit_of_MeasureObjectIDType::setType()
     * @uses Unit_of_MeasureObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
