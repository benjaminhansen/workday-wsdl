...
/**
 * This class stands for Get_Establishments_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Get Establishments Response
 * @subpackage Structs
 */
class Get_Establishments_ResponseType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Establishments_ResponseType
     * @uses Get_Establishments_ResponseType::setRequest_References()
     * @uses Get_Establishments_ResponseType::setRequest_Criteria()
     * @uses Get_Establishments_ResponseType::setResponse_Filter()
