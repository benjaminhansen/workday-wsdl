...
class Get_Ethnicities_RequestType extends AbstractStructBase
{
     ...
     */
    public function __construct(\StructType\Ethnicity_Request_ReferencesType $request_References = null, \StructType\Response_FilterType $response_Filter = null, $version = null)
    {
        $this
     ...
     * @param \StructType\Ethnicity_Request_ReferencesType $request_References
     * @return \StructType\Get_Ethnicities_RequestType
     */
