 ...
 * Get_Location_Hierarchy_Organization_Assignments_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: References to Location Hierarchies and filter options to request their Organization Assignments
 * @subpackage Structs
 */
class Get_Location_Hierarchy_Organization_Assignments_RequestType extends AbstractStructBase
{
    /**
     ...
     * Get_Location_Hierarchy_Organization_Assignments_RequestType
