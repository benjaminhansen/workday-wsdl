...
/**
 * This class stands for DependentObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class DependentObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for DependentObjectIDType
     * @uses DependentObjectIDType::setType()
     * @uses DependentObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
