...
/**
 * This class stands for Get_Difficulty_to_Fill_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Response element for difficulty to fill.
 * @subpackage Structs
 */
class Get_Difficulty_to_Fill_ResponseType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Difficulty_to_Fill_ResponseType
     * @uses Get_Difficulty_to_Fill_ResponseType::setRequest_References()
     * @uses Get_Difficulty_to_Fill_ResponseType::setResponse_Filter()
