...
/**
 * This class stands for Committee_Meeting_Agenda_Item_AttachmentObjectType
 * StructType
 * @subpackage Structs
 */
class Committee_Meeting_Agenda_Item_AttachmentObjectType extends AbstractStructBase
{
    /**
     * The ID
