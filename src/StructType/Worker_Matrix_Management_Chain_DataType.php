...
/**
 * This class stands for Worker_Matrix_Management_Chain_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains the worker's matrix management chain.
 * @subpackage Structs
 */
class Worker_Matrix_Management_Chain_DataType extends AbstractStructBase
{
    /**
