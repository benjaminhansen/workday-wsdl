...
/**
 * This class stands for Payroll_Interface_Contribution_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains the payroll interface contribution information for the spending account election.
 * @subpackage Structs
 */
class Payroll_Interface_Contribution_DataType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Payroll_Interface_Contribution_DataType
     * @uses Payroll_Interface_Contribution_DataType::setContribution_Amount()
     * @uses Payroll_Interface_Contribution_DataType::setFrequency_Reference()
     ...
     * @param float $contribution_Amount
     * @return \WorkdayWsdl\\StructType\Payroll_Interface_Contribution_DataType
     */
