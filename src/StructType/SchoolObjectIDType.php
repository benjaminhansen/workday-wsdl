...
/**
 * This class stands for SchoolObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class SchoolObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for SchoolObjectIDType
     * @uses SchoolObjectIDType::setType()
     * @uses SchoolObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
