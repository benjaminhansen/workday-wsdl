...
/**
 * This class stands for Get_Universal_Identifiers_RequestType StructType
 ...
 * @subpackage Structs
 */
class Get_Universal_Identifiers_RequestType extends AbstractStructBase
{
    /**
     * The Request_References
     * Meta information extracted from the WSDL
     * - documentation: Request Reference
     * - choice: Request_References | Request_Criteria
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * - minOccurs: 0
     * @var \StructType\Universal_Identifier_Request_ReferencesType
     */
     ...
     * - choiceMinOccurs: 1
     * - minOccurs: 0
     * @var \StructType\Universal_Identifier_Request_CriteriaType
     */
    public $Request_Criteria;
    /**
     * The Response_Filter
     * Meta information extracted from the WSDL
     * - documentation: Request Filter
     * - minOccurs: 0
    ...
    public $version;
    /**
     * Constructor method for Get_Universal_Identifiers_RequestType
     * @uses Get_Universal_Identifiers_RequestType::setRequest_References()
     * @uses Get_Universal_Identifiers_RequestType::setRequest_Criteria()
     * @uses Get_Universal_Identifiers_RequestType::setResponse_Filter()
     * @uses Get_Universal_Identifiers_RequestType::setVersion()
     * @param \StructType\Universal_Identifier_Request_ReferencesType $request_References
     * @param \StructType\Universal_Identifier_Request_CriteriaType $request_Criteria
     * @param \StructType\Response_FilterType $response_Filter
     * @param string $version
     */
    public function __construct(\StructType\Universal_Identifier_Request_ReferencesType $request_References = null, \StructType\Universal_Identifier_Request_CriteriaType $request_Criteria = null, \StructType\Response_FilterType $response_Filter = null, $version = null)
    {
        $this
     ...
     * @return \StructType\Universal_Identifier_Request_ReferencesType|null
     */
     ...
     * @param \StructType\Universal_Identifier_Request_ReferencesType $request_References
     * @return \StructType\Get_Universal_Identifiers_RequestType
     */
    public function setRequest_References(\StructType\Universal_Identifier_Request_ReferencesType $request_References = null)
    {
     ...
     * @return \StructType\Universal_Identifier_Request_CriteriaType|null
     */
     ...
     * @return \StructType\Get_Universal_Identifiers_RequestType
     */
    public function setRequest_Criteria(\StructType\Universal_Identifier_Request_CriteriaType $request_Criteria = null)
    {
        // validation for constraint: choice(Request_References, Request_Criteria)
