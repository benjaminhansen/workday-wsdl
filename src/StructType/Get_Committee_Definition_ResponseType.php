...
/**
 * This class stands for Get_Committee_Definition_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Response element containing an instances of committee definition and their associated data
 * @subpackage Structs
 */
class Get_Committee_Definition_ResponseType extends AbstractStructBase
{
    /**
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Committee_Definition_Response_DataType
     */
    ...
    public $version;
    /**
     * Constructor method for Get_Committee_Definition_ResponseType
     * @uses Get_Committee_Definition_ResponseType::setRequest_References()
     * @uses Get_Committee_Definition_ResponseType::setRequest_Criteria()
     * @uses Get_Committee_Definition_ResponseType::setResponse_Filter()
     * @uses Get_Committee_Definition_ResponseType::setResponse_Group()
     * @uses Get_Committee_Definition_ResponseType::setResponse_Results()
     * @uses Get_Committee_Definition_ResponseType::setResponse_Data()
     * @uses Get_Committee_Definition_ResponseType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Get_Committee_Defintion_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Committee_Definition_ResponseType
     */
     ...
     * @return \WorkdayWsdl\\StructType\Committee_Definition_Response_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Get_Committee_Definition_ResponseType
     */
    public function setResponse_Data(\WorkdayWsdl\\StructType\Committee_Definition_Response_DataType $response_Data = null)
    {
