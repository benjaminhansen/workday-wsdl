...
/**
 * This class stands for Proficiency_RatingObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Proficiency_RatingObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Proficiency_RatingObjectIDType
     * @uses Proficiency_RatingObjectIDType::setType()
     * @uses Proficiency_RatingObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
