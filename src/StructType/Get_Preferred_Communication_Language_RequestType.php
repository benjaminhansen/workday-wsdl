...
/**
 * This class stands for Get_Preferred_Communication_Language_RequestType
 * StructType
 * Meta information extracted from the WSDL
 * - documentation: Get Preferred Communication Language Request
 * @subpackage Structs
 */
class Get_Preferred_Communication_Language_RequestType extends AbstractStructBase
{
    /**
     ...
     * Meta information extracted from the WSDL
     * - documentation: User Language Request Criteria
     * - choice: Request_References | Request_Criteria
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * - minOccurs: 0
     ...
     * The Response_Group
     * Meta information extracted from the WSDL
     * - documentation: User Language Response Group
     * - minOccurs: 0
    ...
    public $version;
    /**
     * Constructor method for Get_Preferred_Communication_Language_RequestType
     * @uses Get_Preferred_Communication_Language_RequestType::setRequest_References()
     * @uses Get_Preferred_Communication_Language_RequestType::setRequest_Criteria()
     * @uses Get_Preferred_Communication_Language_RequestType::setResponse_Filter()
     * @uses Get_Preferred_Communication_Language_RequestType::setResponse_Group()
     * @uses Get_Preferred_Communication_Language_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\User_Preferred_Communication_Language_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Preferred_Communication_Language_RequestType
     */
