...
class Academic_AppointeeType extends AbstractStructBase
{
     ...
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Academic_Appointee_DataType
     */
     ...
     * @param \WorkdayWsdl\\StructType\Academic_Appointee_DataType $academic_Appointee_Data
     */
    public function __construct(array $academic_Appointee_Reference = array(), \WorkdayWsdl\\StructType\Academic_Appointee_DataType $academic_Appointee_Data = null)
    {
        $this
    ...
    public static function validateAcademic_Appointee_ReferenceForArrayConstraintsFromSetAcademic_Appointee_Reference(array $values = array())
    {
        ...
        foreach ($values as $academic_AppointeeTypeAcademic_Appointee_ReferenceItem) {
            ...
            if (!$academic_AppointeeTypeAcademic_Appointee_ReferenceItem instanceof \WorkdayWsdl\\StructType\Academic_Appointee_EnabledObjectType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Academic_Appointee_Reference property can only contain items of type \WorkdayWsdl\\StructType\Academic_Appointee_EnabledObjectType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @param \WorkdayWsdl\\StructType\Academic_Appointee_EnabledObjectType[] $academic_Appointee_Reference
     * @return \WorkdayWsdl\\StructType\Academic_AppointeeType
     */
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Academic_Appointee_EnabledObjectType $item
     * @return \WorkdayWsdl\\StructType\Academic_AppointeeType
     */
    public function addToAcademic_Appointee_Reference(\WorkdayWsdl\\StructType\Academic_Appointee_EnabledObjectType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Academic_Appointee_EnabledObjectType) {
            throw new \InvalidArgumentException(sprintf('The Academic_Appointee_Reference property can only contain items of type \WorkdayWsdl\\StructType\Academic_Appointee_EnabledObjectType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \WorkdayWsdl\\StructType\Academic_Appointee_DataType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Academic_AppointeeType
     */
    public function setAcademic_Appointee_Data(\WorkdayWsdl\\StructType\Academic_Appointee_DataType $academic_Appointee_Data = null)
    {
