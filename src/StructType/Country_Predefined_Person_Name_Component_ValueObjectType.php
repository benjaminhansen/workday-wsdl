...
/**
 * This class stands for Country_Predefined_Person_Name_Component_ValueObjectType
 * StructType
 * @subpackage Structs
 */
class Country_Predefined_Person_Name_Component_ValueObjectType extends AbstractStructBase
{
    /**
     * The ID
