...
/**
 * This class stands for System_UserObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class System_UserObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for System_UserObjectIDType
     * @uses System_UserObjectIDType::setType()
     * @uses System_UserObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
