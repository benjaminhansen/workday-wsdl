...
/**
 * This class stands for Future_Payment_PlanObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Future_Payment_PlanObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Future_Payment_PlanObjectIDType
     * @uses Future_Payment_PlanObjectIDType::setType()
     * @uses Future_Payment_PlanObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
