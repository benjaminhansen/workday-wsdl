...
/**
 * This class stands for Committee_Type_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Committee Type Response Group
 * @subpackage Structs
 */
class Committee_Type_Response_GroupType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Committee_Type_Response_GroupType
     * @uses Committee_Type_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\Committee_Type_Response_GroupType
     */
