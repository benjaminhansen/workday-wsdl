 ...
 * External_Institution_Grading_Scheme_Grade_Point_ValueObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class External_Institution_Grading_Scheme_Grade_Point_ValueObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
     ...
     * External_Institution_Grading_Scheme_Grade_Point_ValueObjectIDType
     * @uses External_Institution_Grading_Scheme_Grade_Point_ValueObjectIDType::setType()
     * @uses External_Institution_Grading_Scheme_Grade_Point_ValueObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
