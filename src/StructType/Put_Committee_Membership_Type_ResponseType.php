...
/**
 * This class stands for Put_Committee_Membership_Type_ResponseType StructType
 * Meta information extracted from the WSDL
 * - documentation: Put Committee Membership Type Response
 * @subpackage Structs
 */
class Put_Committee_Membership_Type_ResponseType extends AbstractStructBase
{
    /**
     * The Committee_Membership_Type_Reference
     * Meta information extracted from the WSDL
     * - documentation: Committee Member Type Reference
     * - minOccurs: 0
    ...
    public $version;
    /**
     * Constructor method for Put_Committee_Membership_Type_ResponseType
     * @uses Put_Committee_Membership_Type_ResponseType::setCommittee_Membership_Type_Reference()
     * @uses Put_Committee_Membership_Type_ResponseType::setVersion()
     * @param \WorkdayWsdl\\StructType\Committee_Membership_TypeObjectType $committee_Membership_Type_Reference
     * @param string $version
     */
    public function __construct(\WorkdayWsdl\\StructType\Committee_Membership_TypeObjectType $committee_Membership_Type_Reference = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Committee_Membership_TypeObjectType $committee_Membership_Type_Reference
     * @return \WorkdayWsdl\\StructType\Put_Committee_Membership_Type_ResponseType
     */
