...
class Personal_Information_DataType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Person_Disability_Status_DataType[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Person_Military_Service_DataType[]
     */
     ...
     * @param \WorkdayWsdl\\StructType\Person_Disability_Status_DataType[] $disability_Status_Data
     ...
     * @param \WorkdayWsdl\\StructType\Person_Military_Service_DataType[] $military_Service_Data
     * @param \WorkdayWsdl\\StructType\Person_Identification_DataType $identification_Data
     ...
     */
    public function __construct($universal_ID = null, \WorkdayWsdl\\StructType\Person_Name_DataType $name_Data = null, \WorkdayWsdl\\StructType\GenderObjectType $gender_Reference = null, $birth_Date = null, $date_of_Death = null, \WorkdayWsdl\\StructType\CountryObjectType $country_of_Birth_Reference = null, \WorkdayWsdl\\StructType\Country_RegionObjectType $region_of_Birth_Reference = null, $region_of_Birth_Descriptor = null, $city_of_Birth = null, \WorkdayWsdl\\StructType\Country_CityObjectType $city_of_Birth_Reference = null, \WorkdayWsdl\\StructType\Marital_StatusObjectType $marital_Status_Reference = null, $marital_Status_Date = null, \WorkdayWsdl\\StructType\ReligionObjectType $religion_Reference = null, array $disability_Status_Data = array(), array $ethnicity_Reference = array(), $hispanic_or_Latino = null, array $citizenship_Status_Reference = array(), \WorkdayWsdl\\StructType\CountryObjectType $primary_Nationality_Reference = null, array $additional_Nationality_Reference = array(), \WorkdayWsdl\\StructType\Country_RegionObjectType $hukou_Region_Reference = null, \WorkdayWsdl\\StructType\Country_SubregionObjectType $hukou_Subregion_Reference = null, $hukou_Locality = null, $hukou_Postal_Code = null, \WorkdayWsdl\\StructType\Hukou_TypeObjectType $hukou_Type_Reference = null, $local_Hukou = null, \WorkdayWsdl\\StructType\Country_RegionObjectType $native_Region_Reference = null, $native_Region_Descriptor = null, $personnel_File_Agency_for_Person = null, $last_Medical_Exam_Date = null, $last_Medical_Exam_Valid_To = null, $medical_Exam_Notes = null, \WorkdayWsdl\\StructType\Blood_TypeObjectType $blood_Type_Reference = null, array $military_Service_Data = array(), \WorkdayWsdl\\StructType\Person_Identification_DataType $identification_Data = null, \WorkdayWsdl\\StructType\Contact_Information_DataType $contact_Data = null, $tobacco_Use = null, \WorkdayWsdl\\StructType\Political_AffiliationObjectType $political_Affiliation_Reference = null, \WorkdayWsdl\\StructType\Social_Benefits_LocalityObjectType $social_Benefits_Locality_Reference = null, \WorkdayWsdl\\StructType\Relative_Name_Information_DataType $relative_Name_Information_Data = null)
    {
        $this
     ...
     * @param string $universal_ID
     * @return \WorkdayWsdl\\StructType\Personal_Information_DataType
     */
     ...
     * @return \WorkdayWsdl\\StructType\Person_Disability_Status_DataType[]|null
     */
    ...
    public static function validateDisability_Status_DataForArrayConstraintsFromSetDisability_Status_Data(array $values = array())
    {
        ...
        foreach ($values as $personal_Information_DataTypeDisability_Status_DataItem) {
            ...
            if (!$personal_Information_DataTypeDisability_Status_DataItem instanceof \WorkdayWsdl\\StructType\Person_Disability_Status_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Disability_Status_Data property can only contain items of type \WorkdayWsdl\\StructType\Person_Disability_Status_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Person_Disability_Status_DataType $item
     * @return \WorkdayWsdl\\StructType\Personal_Information_DataType
     */
    public function addToDisability_Status_Data(\WorkdayWsdl\\StructType\Person_Disability_Status_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Person_Disability_Status_DataType) {
            throw new \InvalidArgumentException(sprintf('The Disability_Status_Data property can only contain items of type \WorkdayWsdl\\StructType\Person_Disability_Status_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateEthnicity_ReferenceForArrayConstraintsFromSetEthnicity_Reference(array $values = array())
    {
        ...
        foreach ($values as $personal_Information_DataTypeEthnicity_ReferenceItem) {
            // validation for constraint: itemType
            if (!$personal_Information_DataTypeEthnicity_ReferenceItem instanceof \WorkdayWsdl\\StructType\EthnicityObjectType) {
    ...
    public static function validateCitizenship_Status_ReferenceForArrayConstraintsFromSetCitizenship_Status_Reference(array $values = array())
    {
        ...
        foreach ($values as $personal_Information_DataTypeCitizenship_Status_ReferenceItem) {
            // validation for constraint: itemType
            if (!$personal_Information_DataTypeCitizenship_Status_ReferenceItem instanceof \WorkdayWsdl\\StructType\Citizenship_StatusObjectType) {
    ...
    public static function validateAdditional_Nationality_ReferenceForArrayConstraintsFromSetAdditional_Nationality_Reference(array $values = array())
    {
        ...
        foreach ($values as $personal_Information_DataTypeAdditional_Nationality_ReferenceItem) {
            // validation for constraint: itemType
            if (!$personal_Information_DataTypeAdditional_Nationality_ReferenceItem instanceof \WorkdayWsdl\\StructType\CountryObjectType) {
     ...
     * @return \WorkdayWsdl\\StructType\Person_Military_Service_DataType[]|null
     */
    ...
    public static function validateMilitary_Service_DataForArrayConstraintsFromSetMilitary_Service_Data(array $values = array())
    {
        ...
        foreach ($values as $personal_Information_DataTypeMilitary_Service_DataItem) {
            // validation for constraint: itemType
            if (!$personal_Information_DataTypeMilitary_Service_DataItem instanceof \WorkdayWsdl\\StructType\Person_Military_Service_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Military_Service_Data property can only contain items of type \WorkdayWsdl\\StructType\Person_Military_Service_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Person_Military_Service_DataType $item
     * @return \WorkdayWsdl\\StructType\Personal_Information_DataType
     */
    public function addToMilitary_Service_Data(\WorkdayWsdl\\StructType\Person_Military_Service_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Person_Military_Service_DataType) {
            throw new \InvalidArgumentException(sprintf('The Military_Service_Data property can only contain items of type \WorkdayWsdl\\StructType\Person_Military_Service_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
     ...
     * @return \WorkdayWsdl\\StructType\Personal_Information_DataType
     */
    public function setIdentification_Data(\WorkdayWsdl\\StructType\Person_Identification_DataType $identification_Data = null)
    {
