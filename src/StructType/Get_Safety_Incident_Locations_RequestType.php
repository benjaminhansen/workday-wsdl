...
/**
 * This class stands for Get_Safety_Incident_Locations_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Get Safety Incident Locations Request
 * @subpackage Structs
 */
class Get_Safety_Incident_Locations_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Safety_Incident_Locations_RequestType
     * @uses Get_Safety_Incident_Locations_RequestType::setRequest_References()
     * @uses Get_Safety_Incident_Locations_RequestType::setRequest_Criteria()
     * @uses Get_Safety_Incident_Locations_RequestType::setResponse_Filter()
     * @uses Get_Safety_Incident_Locations_RequestType::setResponse_Group()
     * @uses Get_Safety_Incident_Locations_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Safety_Incident_Location_Request_ReferenceType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Safety_Incident_Locations_RequestType
     */
