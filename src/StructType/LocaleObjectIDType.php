...
/**
 * This class stands for LocaleObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class LocaleObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for LocaleObjectIDType
     * @uses LocaleObjectIDType::setType()
     * @uses LocaleObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
