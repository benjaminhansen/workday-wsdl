...
/**
 * This class stands for Global_Setup_Data_MappingObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Global_Setup_Data_MappingObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Global_Setup_Data_MappingObjectIDType
     * @uses Global_Setup_Data_MappingObjectIDType::setType()
     * @uses Global_Setup_Data_MappingObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
