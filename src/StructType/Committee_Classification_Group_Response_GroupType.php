...
/**
 * This class stands for Committee_Classification_Group_Response_GroupType
 * StructType
 * Meta information extracted from the WSDL
 * - documentation: Committee Classification Group Response Group
 * @subpackage Structs
 */
class Committee_Classification_Group_Response_GroupType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Committee_Classification_Group_Response_GroupType
     * @uses Committee_Classification_Group_Response_GroupType::setInclude_Reference()
