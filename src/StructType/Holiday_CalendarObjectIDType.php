...
/**
 * This class stands for Holiday_CalendarObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Holiday_CalendarObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Holiday_CalendarObjectIDType
     * @uses Holiday_CalendarObjectIDType::setType()
     * @uses Holiday_CalendarObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
