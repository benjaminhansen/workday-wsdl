...
/**
 * This class stands for Committee_Membership_Type_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Committee Membership Type Response Group
 * @subpackage Structs
 */
class Committee_Membership_Type_Response_GroupType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Committee_Membership_Type_Response_GroupType
     * @uses Committee_Membership_Type_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\Committee_Membership_Type_Response_GroupType
     */
