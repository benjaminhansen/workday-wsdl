...
/**
 * This class stands for External_Pay_GroupObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class External_Pay_GroupObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $parent_type;
    /**
     * Constructor method for External_Pay_GroupObjectIDType
     * @uses External_Pay_GroupObjectIDType::setType()
     * @uses External_Pay_GroupObjectIDType::set_()
     * @uses External_Pay_GroupObjectIDType::setParent_id()
     * @uses External_Pay_GroupObjectIDType::setParent_type()
     * @param string $type
     * @param string $_
