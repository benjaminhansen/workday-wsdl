...
/**
 * This class stands for Get_Organization_Reference_IDs_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request for Get Organization Reference IDs.
 * @subpackage Structs
 */
class Get_Organization_Reference_IDs_RequestType extends AbstractStructBase
{
    /**
     ...
     * Meta information extracted from the WSDL
     * - documentation: Organization Reference ID Request Criteria
     * - choice: Request_References | Request_Criteria
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * - minOccurs: 0
    ...
    public $version;
    /**
     * Constructor method for Get_Organization_Reference_IDs_RequestType
     * @uses Get_Organization_Reference_IDs_RequestType::setRequest_References()
     * @uses Get_Organization_Reference_IDs_RequestType::setRequest_Criteria()
     * @uses Get_Organization_Reference_IDs_RequestType::setResponse_Filter()
     * @uses Get_Organization_Reference_IDs_RequestType::setVersion()
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\Organization_Reference_ID_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Organization_Reference_ID_Request_CriteriaType $request_Criteria = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Organization_Reference_ID_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Organization_Reference_IDs_RequestType
     */
