...
/**
 * This class stands for Committee_Meeting_Agenda_Item_AttachmentObjectIDType
 * StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Committee_Meeting_Agenda_Item_AttachmentObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Committee_Meeting_Agenda_Item_AttachmentObjectIDType
     * @uses Committee_Meeting_Agenda_Item_AttachmentObjectIDType::setType()
     * @uses Committee_Meeting_Agenda_Item_AttachmentObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
