 ...
 * Compensatable_Summary_Amount_Annualized_In_Reporting_Currency_DataType
 * StructType
 * Meta information extracted from the WSDL
 * - documentation: Data element containing annualized summary compensation information for a worker in the default currency.
 * @subpackage Structs
 */
class Compensatable_Summary_Amount_Annualized_In_Reporting_Currency_DataType extends AbstractStructBase
{
    /**
     * The Total_Base_Pay
     * Meta information extracted from the WSDL
     ...
     * Compensatable_Summary_Amount_Annualized_In_Reporting_Currency_DataType
     * @uses Compensatable_Summary_Amount_Annualized_In_Reporting_Currency_DataType::setTotal_Base_Pay()
     * @uses Compensatable_Summary_Amount_Annualized_In_Reporting_Currency_DataType::setTotal_Salary_and_Allowances()
     * @uses Compensatable_Summary_Amount_Annualized_In_Reporting_Currency_DataType::setPrimary_Compensation_Basis()
     * @uses Compensatable_Summary_Amount_Annualized_In_Reporting_Currency_DataType::setCurrency_Reference()
     * @uses Compensatable_Summary_Amount_Annualized_In_Reporting_Currency_DataType::setFrequency_Reference()
     ...
     * @param float $total_Base_Pay
     * @return \WorkdayWsdl\\StructType\Compensatable_Summary_Amount_Annualized_In_Reporting_Currency_DataType
     */
