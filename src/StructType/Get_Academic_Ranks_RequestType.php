...
/**
 * This class stands for Get_Academic_Ranks_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request element for Get Academic Rank
 * @subpackage Structs
 */
class Get_Academic_Ranks_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Academic_Ranks_RequestType
     * @uses Get_Academic_Ranks_RequestType::setRequest_References()
     * @uses Get_Academic_Ranks_RequestType::setRequest_Criteria()
     * @uses Get_Academic_Ranks_RequestType::setResponse_Filter()
     * @uses Get_Academic_Ranks_RequestType::setVersion()
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\Academic_Rank_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Academic_Rank_Request_CriteriaType $request_Criteria = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Academic_Rank_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Academic_Ranks_RequestType
     */
