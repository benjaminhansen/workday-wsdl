...
class Work_Schedule_Calendar_Group_Request_ReferencesType extends AbstractStructBase
{
    ...
    public static function validateWork_Schedule_Calendar_Group_ReferenceForArrayConstraintsFromSetWork_Schedule_Calendar_Group_Reference(array $values = array())
    {
        ...
        foreach ($values as $work_Schedule_Calendar_Group_Request_ReferencesTypeWork_Schedule_Calendar_Group_ReferenceItem) {
            ...
            if (!$work_Schedule_Calendar_Group_Request_ReferencesTypeWork_Schedule_Calendar_Group_ReferenceItem instanceof \WorkdayWsdl\\StructType\Work_Schedule_Calendar_GroupObjectType) {
     ...
     * @param \WorkdayWsdl\\StructType\Work_Schedule_Calendar_GroupObjectType[] $work_Schedule_Calendar_Group_Reference
     * @return \WorkdayWsdl\\StructType\Work_Schedule_Calendar_Group_Request_ReferencesType
     */
