...
/**
 * This class stands for Assign_Establishment_Event_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Assign Establishment Event Response Group
 * @subpackage Structs
 */
class Assign_Establishment_Event_Response_GroupType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Assign_Establishment_Event_Response_GroupType
     * @uses Assign_Establishment_Event_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\Assign_Establishment_Event_Response_GroupType
     */
