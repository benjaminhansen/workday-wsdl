...
/**
 * This class stands for Student_Award_SourceObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Student_Award_SourceObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Student_Award_SourceObjectIDType
     * @uses Student_Award_SourceObjectIDType::setType()
     * @uses Student_Award_SourceObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
