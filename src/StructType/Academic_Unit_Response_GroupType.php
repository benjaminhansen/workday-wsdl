...
/**
 * This class stands for Academic_Unit_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Response Group
 * @subpackage Structs
 */
class Academic_Unit_Response_GroupType extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for Academic_Unit_Response_GroupType
     * @uses Academic_Unit_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\Academic_Unit_Response_GroupType
     */
