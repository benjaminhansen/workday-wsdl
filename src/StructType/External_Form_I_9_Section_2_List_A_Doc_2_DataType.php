...
/**
 * This class stands for External_Form_I-9_Section_2_List_A_Doc_2_DataType
 * StructType
 * Meta information extracted from the WSDL
 * - documentation: The request element containing all necessary information for Form I-9 Section 2 List A Doc 2 to assign to the worker.
 * @subpackage Structs
 */
class External_Form_I_9_Section_2_List_A_Doc_2_DataType extends AbstractStructBase
{
    /**
     ...
     * The Expiration_Date
     * Meta information extracted from the WSDL
     * - documentation: The Section 2 List A Doc 2 Expiration Date to assign to the Worker's Form I-9.
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var string
     */
    ...
    /**
     * Constructor method for External_Form_I-9_Section_2_List_A_Doc_2_DataType
