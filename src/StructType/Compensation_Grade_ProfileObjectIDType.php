...
/**
 * This class stands for Compensation_Grade_ProfileObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Compensation_Grade_ProfileObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Compensation_Grade_ProfileObjectIDType
     * @uses Compensation_Grade_ProfileObjectIDType::setType()
     * @uses Compensation_Grade_ProfileObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
