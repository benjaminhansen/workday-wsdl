 ...
 * Get_External_Disability_Self_Identification_Records_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request element for Get External Disability Self-Identification Record
 * @subpackage Structs
 */
class Get_External_Disability_Self_Identification_Records_RequestType extends AbstractStructBase
{
    /**
     ...
     * Get_External_Disability_Self_Identification_Records_RequestType
     * @uses Get_External_Disability_Self_Identification_Records_RequestType::setRequest_References()
     * @uses Get_External_Disability_Self_Identification_Records_RequestType::setRequest_Criteria()
     * @uses Get_External_Disability_Self_Identification_Records_RequestType::setResponse_Filter()
     * @uses Get_External_Disability_Self_Identification_Records_RequestType::setVersion()
     ...
     */
    public function __construct(\StructType\External_Disability_Self_Identification_Record_Request_ReferencesType $request_References = null, \StructType\External_Disability_Self_Identification_Record_Request_CriteriaType $request_Criteria = null, \StructType\Response_FilterType $response_Filter = null, $version = null)
    {
        $this
     ...
     * @param \StructType\External_Disability_Self_Identification_Record_Request_ReferencesType $request_References
     * @return \StructType\Get_External_Disability_Self_Identification_Records_RequestType
     */
