...
/**
 * This class stands for Get_Social_Benefits_Localities_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request element for Get Social Benefits Localities service task.
 * @subpackage Structs
 */
class Get_Social_Benefits_Localities_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Social_Benefits_Localities_RequestType
     * @uses Get_Social_Benefits_Localities_RequestType::setRequest_References()
     * @uses Get_Social_Benefits_Localities_RequestType::setResponse_Filter()
     * @uses Get_Social_Benefits_Localities_RequestType::setVersion()
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\Social_Benefits_Locality_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Social_Benefits_Locality_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Social_Benefits_Localities_RequestType
     */
