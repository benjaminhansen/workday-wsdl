...
/**
 * This class stands for Worker_Health_Care_Period_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains the health care period data for an employee based on the benefit plan year.
 * @subpackage Structs
 */
class Worker_Health_Care_Period_DataType extends AbstractStructBase
{
    /**
    ...
    public function __construct(\WorkdayWsdl\\StructType\Enrollment_Period_DataType $enrollment_Period_Data = null, array $health_Care_Coverage_Data = array())
    {
        $this
            ...
            ->setHealth_Care_Coverage_Data($health_Care_Coverage_Data);
    }
    /**
    ...
    {
        return $this->Health_Care_Coverage_Data;
    }
    /**
     * This method is responsible for validating the values passed to the setHealth_Care_Coverage_Data method
     * This method is willingly generated in order to preserve the one-line inline validation within the setHealth_Care_Coverage_Data method
     * @param array $values
     * @return string A non-empty message if the values does not match the validation rules
     */
    public static function validateHealth_Care_Coverage_DataForArrayConstraintsFromSetHealth_Care_Coverage_Data(array $values = array())
    {
        $message = '';
        $invalidValues = [];
    ...
    public function setHealth_Care_Coverage_Data(array $health_Care_Coverage_Data = array())
    {
        ...
        if ('' !== ($health_Care_Coverage_DataArrayErrorMessage = self::validateHealth_Care_Coverage_DataForArrayConstraintsFromSetHealth_Care_Coverage_Data($health_Care_Coverage_Data))) {
            throw new \InvalidArgumentException($health_Care_Coverage_DataArrayErrorMessage, __LINE__);
        }
        $this->Health_Care_Coverage_Data = $health_Care_Coverage_Data;
        return $this;
    }
    /**
