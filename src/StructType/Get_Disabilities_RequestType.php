...
/**
 * This class stands for Get_Disabilities_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request element for Get Disabilies service task.
 * @subpackage Structs
 */
class Get_Disabilities_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Disabilities_RequestType
     * @uses Get_Disabilities_RequestType::setRequest_References()
     * @uses Get_Disabilities_RequestType::setResponse_Filter()
     * @uses Get_Disabilities_RequestType::setVersion()
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\Disability_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Disability_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Disabilities_RequestType
     */
