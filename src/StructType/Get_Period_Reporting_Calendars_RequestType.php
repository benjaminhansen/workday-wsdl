...
/**
 * This class stands for Get_Period_Reporting_Calendars_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request element for Get Period Reporting Calendars
 * @subpackage Structs
 */
class Get_Period_Reporting_Calendars_RequestType extends AbstractStructBase
{
    /**
     ...
     * The Response_Group
     * Meta information extracted from the WSDL
     * - documentation: the specified response group of the request
     * - minOccurs: 0
    ...
    public $version;
    /**
     * Constructor method for Get_Period_Reporting_Calendars_RequestType
     * @uses Get_Period_Reporting_Calendars_RequestType::setRequest_References()
     * @uses Get_Period_Reporting_Calendars_RequestType::setRequest_Criteria()
     * @uses Get_Period_Reporting_Calendars_RequestType::setResponse_Filter()
     * @uses Get_Period_Reporting_Calendars_RequestType::setResponse_Group()
     * @uses Get_Period_Reporting_Calendars_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Period_Reporting_Calendar_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Period_Reporting_Calendars_RequestType
     */
