...
/**
 * This class stands for Committee_Meeting_Agenda_Item_VoteObjectType StructType
 * @subpackage Structs
 */
class Committee_Meeting_Agenda_Item_VoteObjectType extends AbstractStructBase
{
    /**
     * The ID
