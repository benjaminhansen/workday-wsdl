...
/**
 * This class stands for Marital_StatusObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Marital_StatusObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $parent_type;
    /**
     * Constructor method for Marital_StatusObjectIDType
     * @uses Marital_StatusObjectIDType::setType()
     * @uses Marital_StatusObjectIDType::set_()
     * @uses Marital_StatusObjectIDType::setParent_id()
     * @uses Marital_StatusObjectIDType::setParent_type()
     * @param string $type
     * @param string $_
