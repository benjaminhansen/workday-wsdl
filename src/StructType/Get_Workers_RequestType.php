...
/**
 * This class stands for Get_Workers_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request element used to find and get workers and their associated data.
 * @subpackage Structs
 */
class Get_Workers_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Workers_RequestType
     * @uses Get_Workers_RequestType::setRequest_References()
     * @uses Get_Workers_RequestType::setRequest_Criteria()
     * @uses Get_Workers_RequestType::setResponse_Filter()
     * @uses Get_Workers_RequestType::setResponse_Group()
     * @uses Get_Workers_RequestType::setVersion()
     ...
     */
    public function __construct(\StructType\Worker_Request_ReferencesType $request_References = null, \StructType\Worker_Request_CriteriaType $request_Criteria = null, \StructType\Response_FilterType $response_Filter = null, \StructType\Worker_Response_GroupType $response_Group = null, $version = null)
    {
        $this
     ...
     * @param \StructType\Worker_Request_ReferencesType $request_References
     * @return \StructType\Get_Workers_RequestType
     */
