...
/**
 * This class stands for Notification_CategorizableObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Notification_CategorizableObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Notification_CategorizableObjectIDType
     * @uses Notification_CategorizableObjectIDType::setType()
     * @uses Notification_CategorizableObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
