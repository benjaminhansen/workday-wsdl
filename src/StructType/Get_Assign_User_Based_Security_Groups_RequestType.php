...
/**
 * This class stands for Get_Assign_User-Based_Security_Groups_RequestType
 * StructType
 * Meta information extracted from the WSDL
 * - documentation: Get Request wrapper for retrieving Workday Accounts and assigned User-Based Security Groups.
 * @subpackage Structs
 */
class Get_Assign_User_Based_Security_Groups_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Assign_User-Based_Security_Groups_RequestType
     * @uses Get_Assign_User_Based_Security_Groups_RequestType::setRequest_References()
     * @uses Get_Assign_User_Based_Security_Groups_RequestType::setRequest_Criteria()
