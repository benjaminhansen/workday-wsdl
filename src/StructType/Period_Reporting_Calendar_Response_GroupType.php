...
/**
 * This class stands for Period_Reporting_Calendar_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Response Group of the Period Reporting Calendar Web Service
 * @subpackage Structs
 */
class Period_Reporting_Calendar_Response_GroupType extends AbstractStructBase
{
    /**
     * The Include_Reference
     * Meta information extracted from the WSDL
     * - documentation: Include Reference flag for the Get Period Reporting Calendars Web Service
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var bool
     */
    ...
    /**
     * Constructor method for Period_Reporting_Calendar_Response_GroupType
     * @uses Period_Reporting_Calendar_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\Period_Reporting_Calendar_Response_GroupType
     */
