...
class Get_Change_Home_Contact_Information_ResponseType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Change_Home_Contact_Information_Response_DataType[]
     */
     ...
     * @param \WorkdayWsdl\\StructType\Change_Home_Contact_Information_Response_DataType[] $response_Data
    ...
    public static function validateRequest_ReferencesForArrayConstraintsFromSetRequest_References(array $values = array())
    {
        ...
        foreach ($values as $get_Change_Home_Contact_Information_ResponseTypeRequest_ReferencesItem) {
            ...
            if (!$get_Change_Home_Contact_Information_ResponseTypeRequest_ReferencesItem instanceof \WorkdayWsdl\\StructType\Get_Change_Home_Contact_Information_Request_ReferencesType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Request_References property can only contain items of type \WorkdayWsdl\\StructType\Get_Change_Home_Contact_Information_Request_ReferencesType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @param \WorkdayWsdl\\StructType\Get_Change_Home_Contact_Information_Request_ReferencesType[] $request_References
     * @return \WorkdayWsdl\\StructType\Get_Change_Home_Contact_Information_ResponseType
     */
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Get_Change_Home_Contact_Information_Request_ReferencesType $item
     * @return \WorkdayWsdl\\StructType\Get_Change_Home_Contact_Information_ResponseType
     */
    public function addToRequest_References(\WorkdayWsdl\\StructType\Get_Change_Home_Contact_Information_Request_ReferencesType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Get_Change_Home_Contact_Information_Request_ReferencesType) {
            throw new \InvalidArgumentException(sprintf('The Request_References property can only contain items of type \WorkdayWsdl\\StructType\Get_Change_Home_Contact_Information_Request_ReferencesType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateResponse_FilterForArrayConstraintsFromSetResponse_Filter(array $values = array())
    {
        ...
        foreach ($values as $get_Change_Home_Contact_Information_ResponseTypeResponse_FilterItem) {
            // validation for constraint: itemType
            if (!$get_Change_Home_Contact_Information_ResponseTypeResponse_FilterItem instanceof \WorkdayWsdl\\StructType\Response_FilterType) {
    ...
    public static function validateResponse_ResultsForArrayConstraintsFromSetResponse_Results(array $values = array())
    {
        ...
        foreach ($values as $get_Change_Home_Contact_Information_ResponseTypeResponse_ResultsItem) {
            // validation for constraint: itemType
            if (!$get_Change_Home_Contact_Information_ResponseTypeResponse_ResultsItem instanceof \WorkdayWsdl\\StructType\Response_ResultsType) {
     ...
     * @return \WorkdayWsdl\\StructType\Change_Home_Contact_Information_Response_DataType[]|null
     */
    ...
    public static function validateResponse_DataForArrayConstraintsFromSetResponse_Data(array $values = array())
    {
        ...
        foreach ($values as $get_Change_Home_Contact_Information_ResponseTypeResponse_DataItem) {
            // validation for constraint: itemType
            if (!$get_Change_Home_Contact_Information_ResponseTypeResponse_DataItem instanceof \WorkdayWsdl\\StructType\Change_Home_Contact_Information_Response_DataType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Response_Data property can only contain items of type \WorkdayWsdl\\StructType\Change_Home_Contact_Information_Response_DataType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Change_Home_Contact_Information_Response_DataType $item
     * @return \WorkdayWsdl\\StructType\Get_Change_Home_Contact_Information_ResponseType
     */
    public function addToResponse_Data(\WorkdayWsdl\\StructType\Change_Home_Contact_Information_Response_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Change_Home_Contact_Information_Response_DataType) {
            throw new \InvalidArgumentException(sprintf('The Response_Data property can only contain items of type \WorkdayWsdl\\StructType\Change_Home_Contact_Information_Response_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
