...
/**
 * This class stands for GiftObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class GiftObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for GiftObjectIDType
     * @uses GiftObjectIDType::setType()
     * @uses GiftObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
