...
/**
 * This class stands for Role_AssignerObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Role_AssignerObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Role_AssignerObjectIDType
     * @uses Role_AssignerObjectIDType::setType()
     * @uses Role_AssignerObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
