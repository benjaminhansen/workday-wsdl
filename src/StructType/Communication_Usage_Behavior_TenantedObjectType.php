...
/**
 * This class stands for Communication_Usage_Behavior_TenantedObjectType StructType
 * @subpackage Structs
 */
class Communication_Usage_Behavior_TenantedObjectType extends AbstractStructBase
{
    /**
     * The ID
