...
class End extends AbstractSoapClientBase
{
     ...
     * @param \WorkdayWsdl\\StructType\End_Academic_Appointment_RequestType $body
     * @return \WorkdayWsdl\\StructType\Academic_Appointment_ResponseType|bool
     */
    public function End_Academic_Appointment(\WorkdayWsdl\\StructType\End_Academic_Appointment_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \WorkdayWsdl\\StructType\End_Collective_Agreement_Assignment_Event_RequestType $body
     * @return \WorkdayWsdl\\StructType\End_Collective_Agreement_Assignment_Event_ResponseType|bool
     */
    public function End_Collective_Agreement_Assignment(\WorkdayWsdl\\StructType\End_Collective_Agreement_Assignment_Event_RequestType $body)
    {
        try {
     ...
     * @return \WorkdayWsdl\\StructType\Academic_Appointment_ResponseType|\WorkdayWsdl\\StructType\End_Collective_Agreement_Assignment_Event_ResponseType
     */
