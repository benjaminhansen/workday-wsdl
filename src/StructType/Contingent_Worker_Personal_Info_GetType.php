...
/**
 * This class stands for Contingent_Worker_Personal_Info_GetType StructType
 * Meta information extracted from the WSDL
 * - documentation: Utilize the following Reference element (and other optional attributes) to retrieve an instance of Contingent Worker and his/her Personal Information.
 * @subpackage Structs
 */
class Contingent_Worker_Personal_Info_GetType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Contingent_Worker_Personal_Info_GetType
     * @uses Contingent_Worker_Personal_Info_GetType::setContingent_Worker_Reference()
     * @uses Contingent_Worker_Personal_Info_GetType::setAs_Of_Date()
     * @uses Contingent_Worker_Personal_Info_GetType::setAs_Of_Moment()
     * @uses Contingent_Worker_Personal_Info_GetType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Contingent_Worker_Reference_DataType $contingent_Worker_Reference
     * @return \WorkdayWsdl\\StructType\Contingent_Worker_Personal_Info_GetType
     */
