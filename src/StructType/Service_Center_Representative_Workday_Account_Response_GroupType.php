 ...
 * Service_Center_Representative_Workday_Account_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Response Group
 * @subpackage Structs
 */
class Service_Center_Representative_Workday_Account_Response_GroupType extends AbstractStructBase
{
    /**
     ...
     * Service_Center_Representative_Workday_Account_Response_GroupType
     * @uses Service_Center_Representative_Workday_Account_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\Service_Center_Representative_Workday_Account_Response_GroupType
     */
