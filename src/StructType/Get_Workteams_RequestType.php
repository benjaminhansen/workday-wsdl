...
/**
 * This class stands for Get_Workteams_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains request reference, criteria, filter for getting Workteam data.
 * @subpackage Structs
 */
class Get_Workteams_RequestType extends AbstractStructBase
{
    /**
     ...
     * - choiceMinOccurs: 1
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Workteam_Request_ReferencesType
     */
    public $Request_References;
    /**
     * The Request_Criteria
     * Meta information extracted from the WSDL
     * - documentation: Workteam Request Criteria
     * - choice: Request_References | Request_Criteria
     * - choiceMaxOccurs: 1
     * - choiceMinOccurs: 1
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Workteam_Request_CriteriaType
     */
     ...
     * The Response_Group
     * Meta information extracted from the WSDL
     * - documentation: Workteam Response Group
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Workteam_Response_GroupType
     */
    ...
    public $version;
    /**
     * Constructor method for Get_Workteams_RequestType
     * @uses Get_Workteams_RequestType::setRequest_References()
     * @uses Get_Workteams_RequestType::setRequest_Criteria()
     * @uses Get_Workteams_RequestType::setResponse_Filter()
     * @uses Get_Workteams_RequestType::setResponse_Group()
     * @uses Get_Workteams_RequestType::setVersion()
     * @param \WorkdayWsdl\\StructType\Workteam_Request_ReferencesType $request_References
     * @param \WorkdayWsdl\\StructType\Workteam_Request_CriteriaType $request_Criteria
     * @param \WorkdayWsdl\\StructType\Response_FilterType $response_Filter
     * @param \WorkdayWsdl\\StructType\Workteam_Response_GroupType $response_Group
     * @param string $version
     */
    public function __construct(\WorkdayWsdl\\StructType\Workteam_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Workteam_Request_CriteriaType $request_Criteria = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, \WorkdayWsdl\\StructType\Workteam_Response_GroupType $response_Group = null, $version = null)
    {
        $this
     ...
     * @return \WorkdayWsdl\\StructType\Workteam_Request_ReferencesType|null
     */
     ...
     * @param \WorkdayWsdl\\StructType\Workteam_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Workteams_RequestType
     */
    public function setRequest_References(\WorkdayWsdl\\StructType\Workteam_Request_ReferencesType $request_References = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Workteam_Request_CriteriaType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Get_Workteams_RequestType
     */
    public function setRequest_Criteria(\WorkdayWsdl\\StructType\Workteam_Request_CriteriaType $request_Criteria = null)
    {
        // validation for constraint: choice(Request_References, Request_Criteria)
     ...
     * @return \WorkdayWsdl\\StructType\Workteam_Response_GroupType|null
     */
     ...
     * @return \WorkdayWsdl\\StructType\Get_Workteams_RequestType
     */
    public function setResponse_Group(\WorkdayWsdl\\StructType\Workteam_Response_GroupType $response_Group = null)
    {
