...
/**
 * This class stands for Contingent_Worker_GetType StructType
 * Meta information extracted from the WSDL
 * - documentation: Utilize the following Reference element (and other optional attributes) to retrieve an instance of Contingent Worker and its associated data.
 * @subpackage Structs
 */
class Contingent_Worker_GetType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Contingent_Worker_GetType
     * @uses Contingent_Worker_GetType::setContingent_Worker_Reference()
