...
/**
 * This class stands for Disability_Certification_BasisObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Disability_Certification_BasisObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Disability_Certification_BasisObjectIDType
     * @uses Disability_Certification_BasisObjectIDType::setType()
     * @uses Disability_Certification_BasisObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
