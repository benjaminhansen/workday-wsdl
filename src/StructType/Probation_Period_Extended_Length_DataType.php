...
/**
 * This class stands for Probation_Period_Extended_Length_DataType StructType
 * Meta information extracted from the WSDL
 * - documentation: Probation Period Extended Length
 * @subpackage Structs
 */
class Probation_Period_Extended_Length_DataType extends AbstractStructBase
{
    /**
     * The Duration
     * Meta information extracted from the WSDL
    ...
    /**
     * Constructor method for Probation_Period_Extended_Length_DataType
     * @uses Probation_Period_Extended_Length_DataType::setDuration()
     * @uses Probation_Period_Extended_Length_DataType::setUnit_Reference()
     * @param float $duration
     * @param \StructType\Date_And_Time_UnitObjectType $unit_Reference
     */
    public function __construct($duration = null, \StructType\Date_And_Time_UnitObjectType $unit_Reference = null)
    {
        $this
     ...
     * Set Duration value
     * @param float $duration
     * @return \StructType\Probation_Period_Extended_Length_DataType
     */
