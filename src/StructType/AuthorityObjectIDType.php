...
/**
 * This class stands for AuthorityObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class AuthorityObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for AuthorityObjectIDType
     * @uses AuthorityObjectIDType::setType()
     * @uses AuthorityObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
