...
class Collective_Agreement_Factor_4_DataType extends AbstractStructBase
{
     ...
     * @param \WorkdayWsdl\\StructType\Collective_Agreement_FactorObjectType $collective_Agreement_Factor_4_Reference
     * @param \WorkdayWsdl\\StructType\Collective_Agreement_Factor_OptionObjectType $collective_Agreement_Factor_Option_4_Reference
     */
    public function __construct(\WorkdayWsdl\\StructType\Collective_Agreement_FactorObjectType $collective_Agreement_Factor_4_Reference = null, \WorkdayWsdl\\StructType\Collective_Agreement_Factor_OptionObjectType $collective_Agreement_Factor_Option_4_Reference = null)
    {
        $this
     ...
     * @return \WorkdayWsdl\\StructType\Collective_Agreement_Factor_4_DataType
     */
    public function setCollective_Agreement_Factor_4_Reference(\WorkdayWsdl\\StructType\Collective_Agreement_FactorObjectType $collective_Agreement_Factor_4_Reference = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Collective_Agreement_Factor_4_DataType
     */
    public function setCollective_Agreement_Factor_Option_4_Reference(\WorkdayWsdl\\StructType\Collective_Agreement_Factor_OptionObjectType $collective_Agreement_Factor_Option_4_Reference = null)
    {
