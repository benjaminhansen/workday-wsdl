...
/**
 * This class stands for LanguageObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class LanguageObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for LanguageObjectIDType
     * @uses LanguageObjectIDType::setType()
     * @uses LanguageObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
