...
/**
 * This class stands for Get_Service_Center_Representatives_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Get Service Center Representatives Request
 * @subpackage Structs
 */
class Get_Service_Center_Representatives_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Service_Center_Representatives_RequestType
     * @uses Get_Service_Center_Representatives_RequestType::setRequest_References()
     * @uses Get_Service_Center_Representatives_RequestType::setRequest_Criteria()
     * @uses Get_Service_Center_Representatives_RequestType::setResponse_Filter()
     * @uses Get_Service_Center_Representatives_RequestType::setResponse_Group()
     * @uses Get_Service_Center_Representatives_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Service_Center_Representative_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Service_Center_Representatives_RequestType
     */
