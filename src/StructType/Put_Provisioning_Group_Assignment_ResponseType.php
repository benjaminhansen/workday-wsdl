...
class Put_Provisioning_Group_Assignment_ResponseType extends AbstractStructBase
{
     ...
     */
    public function __construct(\StructType\Unique_IdentifierObjectType $provisioning_Group_Assignment_Reference = null, array $exceptions_Response_Data = array(), $version = null)
    {
        $this
     ...
     * @param \StructType\Unique_IdentifierObjectType $provisioning_Group_Assignment_Reference
     * @return \StructType\Put_Provisioning_Group_Assignment_ResponseType
     */
    ...
    public static function validateExceptions_Response_DataForArrayConstraintsFromSetExceptions_Response_Data(array $values = array())
    {
        ...
        foreach ($values as $put_Provisioning_Group_Assignment_ResponseTypeExceptions_Response_DataItem) {
            ...
            if (!$put_Provisioning_Group_Assignment_ResponseTypeExceptions_Response_DataItem instanceof \StructType\Application_Instance_Related_Exceptions_DataType) {
