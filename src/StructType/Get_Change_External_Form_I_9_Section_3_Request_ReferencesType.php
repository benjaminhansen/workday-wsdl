 ...
 * Get_Change_External_Form_I-9_Section_3_Request_ReferencesType StructType
 * Meta information extracted from the WSDL
 * - documentation: The Worker Reference to extract External Form I-9 Section 3 for Workers.
 * @subpackage Structs
 */
class Get_Change_External_Form_I_9_Section_3_Request_ReferencesType extends AbstractStructBase
{
    /**
     ...
     * Get_Change_External_Form_I-9_Section_3_Request_ReferencesType
     * @uses Get_Change_External_Form_I_9_Section_3_Request_ReferencesType::setWorker_Reference()
    ...
    public static function validateWorker_ReferenceForArrayConstraintsFromSetWorker_Reference(array $values = array())
    {
        $message = '';
        $invalidValues = [];
        foreach ($values as $get_Change_External_Form_I_9_Section_3_Request_ReferencesTypeWorker_ReferenceItem) {
            // validation for constraint: itemType
            if (!$get_Change_External_Form_I_9_Section_3_Request_ReferencesTypeWorker_ReferenceItem instanceof \WorkdayWsdl\\StructType\WorkerObjectType) {
                $invalidValues[] = is_object($get_Change_External_Form_I_9_Section_3_Request_ReferencesTypeWorker_ReferenceItem) ? get_class($get_Change_External_Form_I_9_Section_3_Request_ReferencesTypeWorker_ReferenceItem) : sprintf('%s(%s)', gettype($get_Change_External_Form_I_9_Section_3_Request_ReferencesTypeWorker_ReferenceItem), var_export($get_Change_External_Form_I_9_Section_3_Request_ReferencesTypeWorker_ReferenceItem, true));
            }
        }
     ...
     * @param \WorkdayWsdl\\StructType\WorkerObjectType[] $worker_Reference
     * @return \WorkdayWsdl\\StructType\Get_Change_External_Form_I_9_Section_3_Request_ReferencesType
     */
