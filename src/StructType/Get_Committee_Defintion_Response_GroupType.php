...
/**
 * This class stands for Get_Committee_Defintion_Response_GroupType StructType
 * Meta information extracted from the WSDL
 * - documentation: Committee Defintion Response Group
 * @subpackage Structs
 */
class Get_Committee_Defintion_Response_GroupType extends AbstractStructBase
{
    /**
     * The Include_Reference
     * Meta information extracted from the WSDL
     * - documentation: Include Request References
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var bool
     */
    ...
    /**
     * Constructor method for Get_Committee_Defintion_Response_GroupType
     * @uses Get_Committee_Defintion_Response_GroupType::setInclude_Reference()
     ...
     * @param bool $include_Reference
     * @return \WorkdayWsdl\\StructType\Get_Committee_Defintion_Response_GroupType
     */
