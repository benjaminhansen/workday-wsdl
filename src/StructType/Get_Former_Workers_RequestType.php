...
/**
 * This class stands for Get_Former_Workers_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: Request element used to retrieve Former Workers and their data.
 * @subpackage Structs
 */
class Get_Former_Workers_RequestType extends AbstractStructBase
{
    /**
    ...
    /**
     * The Former_Worker_Response_Group
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Former_Worker_Response_GroupType
     */
    public $Former_Worker_Response_Group;
    /**
     * The version
     * Meta information extracted from the WSDL
     * - ref: wd:version
    ...
    public $version;
    /**
     * Constructor method for Get_Former_Workers_RequestType
     * @uses Get_Former_Workers_RequestType::setRequest_References()
     * @uses Get_Former_Workers_RequestType::setRequest_Criteria()
     * @uses Get_Former_Workers_RequestType::setResponse_Filter()
     * @uses Get_Former_Workers_RequestType::setFormer_Worker_Response_Group()
     * @uses Get_Former_Workers_RequestType::setVersion()
     ...
     * @param \WorkdayWsdl\\StructType\Former_Worker_Response_GroupType $former_Worker_Response_Group
     * @param string $version
     */
    public function __construct(\WorkdayWsdl\\StructType\Former_Worker_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Former_Worker_Request_CriteriaType $request_Criteria = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, \WorkdayWsdl\\StructType\Former_Worker_Response_GroupType $former_Worker_Response_Group = null, $version = null)
    {
        $this
            ->setRequest_References($request_References)
            ->setRequest_Criteria($request_Criteria)
            ->setResponse_Filter($response_Filter)
            ->setFormer_Worker_Response_Group($former_Worker_Response_Group)
            ->setVersion($version);
    }
    /**
     ...
     * @param \WorkdayWsdl\\StructType\Former_Worker_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Former_Workers_RequestType
     */
    ...
    /**
     * Get Former_Worker_Response_Group value
     * @return \WorkdayWsdl\\StructType\Former_Worker_Response_GroupType|null
     */
    public function getFormer_Worker_Response_Group()
    {
        return $this->Former_Worker_Response_Group;
    }
    /**
     * Set Former_Worker_Response_Group value
     * @param \WorkdayWsdl\\StructType\Former_Worker_Response_GroupType $former_Worker_Response_Group
     * @return \WorkdayWsdl\\StructType\Get_Former_Workers_RequestType
     */
    public function setFormer_Worker_Response_Group(\WorkdayWsdl\\StructType\Former_Worker_Response_GroupType $former_Worker_Response_Group = null)
    {
        $this->Former_Worker_Response_Group = $former_Worker_Response_Group;
        return $this;
    }
    /**
     * Get version value
