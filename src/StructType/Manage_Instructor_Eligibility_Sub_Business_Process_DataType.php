...
class Manage_Instructor_Eligibility_Sub_Business_Process_DataType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \WorkdayWsdl\\StructType\Instructor_Eligibility_Line_DataType[]
     */
     ...
     * @param \WorkdayWsdl\\StructType\Instructor_Eligibility_Line_DataType[] $instructor_Eligibility_Line_Data
     */
    ...
    public static function validateBusiness_Sub_Process_ParametersForArrayConstraintsFromSetBusiness_Sub_Process_Parameters(array $values = array())
    {
        ...
        foreach ($values as $manage_Instructor_Eligibility_Sub_Business_Process_DataTypeBusiness_Sub_Process_ParametersItem) {
            ...
            if (!$manage_Instructor_Eligibility_Sub_Business_Process_DataTypeBusiness_Sub_Process_ParametersItem instanceof \WorkdayWsdl\\StructType\Business_Sub_Process_ParametersType) {
     ...
     * @param \WorkdayWsdl\\StructType\Business_Sub_Process_ParametersType[] $business_Sub_Process_Parameters
     * @return \WorkdayWsdl\\StructType\Manage_Instructor_Eligibility_Sub_Business_Process_DataType
     */
     ...
     * @return \WorkdayWsdl\\StructType\Instructor_Eligibility_Line_DataType[]|null
     */
     ...
     * @throws \InvalidArgumentException
     * @param \WorkdayWsdl\\StructType\Instructor_Eligibility_Line_DataType $item
     * @return \WorkdayWsdl\\StructType\Manage_Instructor_Eligibility_Sub_Business_Process_DataType
     */
    public function addToInstructor_Eligibility_Line_Data(\WorkdayWsdl\\StructType\Instructor_Eligibility_Line_DataType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \WorkdayWsdl\\StructType\Instructor_Eligibility_Line_DataType) {
            throw new \InvalidArgumentException(sprintf('The Instructor_Eligibility_Line_Data property can only contain items of type \WorkdayWsdl\\StructType\Instructor_Eligibility_Line_DataType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
