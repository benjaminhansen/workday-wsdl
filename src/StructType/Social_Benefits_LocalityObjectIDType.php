...
/**
 * This class stands for Social_Benefits_LocalityObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Social_Benefits_LocalityObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Social_Benefits_LocalityObjectIDType
     * @uses Social_Benefits_LocalityObjectIDType::setType()
     * @uses Social_Benefits_LocalityObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
