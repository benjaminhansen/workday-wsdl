...
class Collective_Agreement_Factor_1_DataType extends AbstractStructBase
{
     ...
     * @param \StructType\Collective_Agreement_FactorObjectType $collective_Agreement_Factor_1_Reference
     * @param \StructType\Collective_Agreement_Factor_OptionObjectType $collective_Agreement_Factor_Option_1_Reference
     */
    public function __construct(\StructType\Collective_Agreement_FactorObjectType $collective_Agreement_Factor_1_Reference = null, \StructType\Collective_Agreement_Factor_OptionObjectType $collective_Agreement_Factor_Option_1_Reference = null)
    {
        $this
     ...
     * @return \StructType\Collective_Agreement_Factor_1_DataType
     */
    public function setCollective_Agreement_Factor_1_Reference(\StructType\Collective_Agreement_FactorObjectType $collective_Agreement_Factor_1_Reference = null)
    {
     ...
     * @return \StructType\Collective_Agreement_Factor_1_DataType
     */
    public function setCollective_Agreement_Factor_Option_1_Reference(\StructType\Collective_Agreement_Factor_OptionObjectType $collective_Agreement_Factor_Option_1_Reference = null)
    {
