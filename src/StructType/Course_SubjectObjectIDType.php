...
/**
 * This class stands for Course_SubjectObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class Course_SubjectObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for Course_SubjectObjectIDType
     * @uses Course_SubjectObjectIDType::setType()
     * @uses Course_SubjectObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
