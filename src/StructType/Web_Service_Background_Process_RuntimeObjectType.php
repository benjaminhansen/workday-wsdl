...
/**
 * This class stands for Web_Service_Background_Process_RuntimeObjectType
 * StructType
 * @subpackage Structs
 */
class Web_Service_Background_Process_RuntimeObjectType extends AbstractStructBase
{
    /**
     * The ID
