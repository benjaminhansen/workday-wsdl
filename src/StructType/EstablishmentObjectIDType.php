...
/**
 * This class stands for EstablishmentObjectIDType StructType
 * Meta information extracted from the WSDL
 * - documentation: Contains a unique identifier for an instance of an object.
 * @subpackage Structs
 */
class EstablishmentObjectIDType extends AbstractStructBase
{
    /**
     * The type
     * Meta information extracted from the WSDL
    ...
    public $_;
    /**
     * Constructor method for EstablishmentObjectIDType
     * @uses EstablishmentObjectIDType::setType()
     * @uses EstablishmentObjectIDType::set_()
     * @param string $type
     * @param string $_
     */
