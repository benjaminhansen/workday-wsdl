 ...
 * External_Institution_Grading_Scheme_Grade_Point_ValueObjectType StructType
 * @subpackage Structs
 */
class External_Institution_Grading_Scheme_Grade_Point_ValueObjectType extends AbstractStructBase
{
    /**
     * The ID
