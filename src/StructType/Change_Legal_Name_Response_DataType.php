...
class Change_Legal_Name_Response_DataType extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \StructType\Change_Legal_Name_Response_WrapperType[]
     */
     ...
     * @param \StructType\Change_Legal_Name_Response_WrapperType[] $change_Legal_Name
     */
     ...
     * @return \StructType\Change_Legal_Name_Response_WrapperType[]|null
     */
    ...
    public static function validateChange_Legal_NameForArrayConstraintsFromSetChange_Legal_Name(array $values = array())
    {
        ...
        foreach ($values as $change_Legal_Name_Response_DataTypeChange_Legal_NameItem) {
            ...
            if (!$change_Legal_Name_Response_DataTypeChange_Legal_NameItem instanceof \StructType\Change_Legal_Name_Response_WrapperType) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The Change_Legal_Name property can only contain items of type \StructType\Change_Legal_Name_Response_WrapperType, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
        return $message;
    }
     ...
     * @param \StructType\Change_Legal_Name_Response_WrapperType[] $change_Legal_Name
     * @return \StructType\Change_Legal_Name_Response_DataType
     */
     ...
     * @throws \InvalidArgumentException
     * @param \StructType\Change_Legal_Name_Response_WrapperType $item
     * @return \StructType\Change_Legal_Name_Response_DataType
     */
    public function addToChange_Legal_Name(\StructType\Change_Legal_Name_Response_WrapperType $item)
    {
        // validation for constraint: itemType
        if (!$item instanceof \StructType\Change_Legal_Name_Response_WrapperType) {
            throw new \InvalidArgumentException(sprintf('The Change_Legal_Name property can only contain items of type \StructType\Change_Legal_Name_Response_WrapperType, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
