...
/**
 * This class stands for Get_Workday_Account_RequestType StructType
 * Meta information extracted from the WSDL
 * - documentation: A Generic Workday Account request for workers and non-workers.
 * @subpackage Structs
 */
class Get_Workday_Account_RequestType extends AbstractStructBase
{
    /**
    ...
    public $version;
    /**
     * Constructor method for Get_Workday_Account_RequestType
     * @uses Get_Workday_Account_RequestType::setRequest_References()
     * @uses Get_Workday_Account_RequestType::setRequest_Criteria()
     * @uses Get_Workday_Account_RequestType::setResponse_Filter()
     * @uses Get_Workday_Account_RequestType::setResponse_Group()
     * @uses Get_Workday_Account_RequestType::setVersion()
     ...
     */
    public function __construct(\WorkdayWsdl\\StructType\Get_Workday_Account_Request_ReferencesType $request_References = null, \WorkdayWsdl\\StructType\Get_Workday_Account_Request_CriteriaType $request_Criteria = null, \WorkdayWsdl\\StructType\Response_FilterType $response_Filter = null, \WorkdayWsdl\\StructType\Workday_Account_Response_GroupType $response_Group = null, $version = null)
    {
        $this
     ...
     * @param \WorkdayWsdl\\StructType\Get_Workday_Account_Request_ReferencesType $request_References
     * @return \WorkdayWsdl\\StructType\Get_Workday_Account_RequestType
     */
    public function setRequest_References(\WorkdayWsdl\\StructType\Get_Workday_Account_Request_ReferencesType $request_References = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Get_Workday_Account_RequestType
     */
    public function setRequest_Criteria(\WorkdayWsdl\\StructType\Get_Workday_Account_Request_CriteriaType $request_Criteria = null)
    {
     ...
     * @return \WorkdayWsdl\\StructType\Get_Workday_Account_RequestType
     */
    public function setResponse_Group(\WorkdayWsdl\\StructType\Workday_Account_Response_GroupType $response_Group = null)
    {
