...
class Create extends AbstractSoapClientBase
{
     ...
     * @param \StructType\Create_Named_Professorship_RequestType $body
     * @return \StructType\Create_Named_Professorship_ResponseType|bool
     */
    public function Create_Named_Professorship(\StructType\Create_Named_Professorship_RequestType $body)
    {
        try {
     ...
     * @uses AbstractSoapClientBase::getResult()
     * @uses AbstractSoapClientBase::saveLastError()
     * @param \StructType\Create_Reference_Letter_for_Worker_RequestType $body
     * @return \StructType\Create_Reference_Letter_for_Worker_ResponseType|bool
     */
    public function Create_Reference_Letter_for_Worker(\StructType\Create_Reference_Letter_for_Worker_RequestType $body)
    {
        try {
     ...
     * @return \StructType\Create_Named_Professorship_ResponseType|\StructType\Create_Reference_Letter_for_Worker_ResponseType
     */
